...
void main()
{
    ...
    u_xlat2.xy = u_xlat3.yy * hlslcc_mtx4unity_WorldToLight[1].xy;
    u_xlat2.xy = hlslcc_mtx4unity_WorldToLight[0].xy * u_xlat3.xx + u_xlat2.xy;
    u_xlat2.xy = hlslcc_mtx4unity_WorldToLight[2].xy * u_xlat3.zz + u_xlat2.xy;
    ...
    u_xlat6.xy = u_xlat2.xy + hlslcc_mtx4unity_WorldToLight[3].xy;

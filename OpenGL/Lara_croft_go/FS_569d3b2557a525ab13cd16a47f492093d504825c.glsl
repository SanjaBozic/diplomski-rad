...
void main()
{
    ...
    u_xlat2.x = vs_TEXCOORD1.x * _VertexAnimRepeat.x;
    u_xlat2.x = _Time.y * _VertexAnimSpeed.x + u_xlat2.x;
    u_xlat2.x = _VertexAnimRepeat.y * vs_TEXCOORD1.z + u_xlat2.x;
    u_xlat2.x = u_xlat2.x * 5.0;
    u_xlat2.x = sin((-u_xlat2.x));
    u_xlat2.x = u_xlat2.x + 1.0;
    u_xlat6 = _VertexAnimScale.x * 0.699999988;
    u_xlat2.x = u_xlat6 * u_xlat2.x + vs_TEXCOORD1.y;
    u_xlat2.x = u_xlat2.x + (-_DepthBounds.y);
    u_xlat6 = (-_DepthBounds.y) + _DepthBounds.x;

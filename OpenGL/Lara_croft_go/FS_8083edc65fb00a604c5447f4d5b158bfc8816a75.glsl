...
void main()
{
    ...
    u_xlat3.x = vs_TEXCOORD5.z + (-_ShadowCameraSettings.xxyx.z);
    u_xlat3.x = u_xlat3.x / _ShadowCameraSettings.xxyx.y;
    u_xlatb0.z = u_xlat3.x>=u_xlat10_1.x;
    u_xlatb0.x = u_xlat3.x>=u_xlat10_0.x;
    ...
    u_xlatb6 = u_xlat3.x>=u_xlat10_1.x;
    u_xlatb3 = u_xlat3.x>=u_xlat10_2.x;
    u_xlat3.x = u_xlatb3 ? 1.0 : float(0.0);
    u_xlat0.x = u_xlat3.x + u_xlat0.x;
    u_xlat3.x = u_xlatb6 ? 1.0 : float(0.0);
    u_xlat0.x = u_xlat3.x + u_xlat0.x;
    u_xlat0.x = (-u_xlat0.x) * 0.25 + 1.0;
    u_xlat3.xyz = max(u_xlat0.xxx, _ShadowColor.xyz);
    ...
    u_xlat2.xyz = vec3(u_xlat10) * _DirectionalLightColor.xyz;
    u_xlat3.xyz = u_xlat3.xyz * u_xlat2.xyz;
    u_xlat3.xyz = clamp(u_xlat3.xyz, 0.0, 1.0);
    u_xlat2.xyz = vs_COLOR0.xyz * _AmbientLightColor.xyz;
    u_xlat3.xyz = vs_COLOR0.xyz * u_xlat3.xyz + u_xlat2.xyz;
    ...
    u_xlat3.xyz = _RimColor.xyz * u_xlat1.xxx + u_xlat3.xyz;

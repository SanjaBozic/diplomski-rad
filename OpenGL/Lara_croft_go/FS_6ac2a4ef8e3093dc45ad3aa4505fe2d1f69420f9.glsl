...
void main()
{
    u_xlat0 = vec4(_ShadowBlur) * vec4(1.0, 0.0, -1.0, 0.0) + vs_TEXCOORD4.xyxy;
    u_xlat10_1 = texture(_ShadowMapTexture, u_xlat0.xy);
    u_xlat10_0 = texture(_ShadowMapTexture, u_xlat0.zw);
    u_xlat3 = vs_TEXCOORD4.z + (-_ShadowCameraSettings.xxyx.z);
    ...
    u_xlat1 = vec4(_ShadowBlur) * vec4(0.0, 1.0, 0.0, -1.0) + vs_TEXCOORD4.xyxy;

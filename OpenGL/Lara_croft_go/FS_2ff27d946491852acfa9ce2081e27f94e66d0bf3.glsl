...
void main()
{
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat7.xy = u_xlat2.yy * hlslcc_mtx4unity_WorldToLight[1].xy;
    u_xlat7.xy = hlslcc_mtx4unity_WorldToLight[0].xy * u_xlat2.xx + u_xlat7.xy;
    u_xlat7.xy = hlslcc_mtx4unity_WorldToLight[2].xy * u_xlat2.ww + u_xlat7.xy;
    u_xlat2.xyz = u_xlat2.xyw + (-_WorldSpaceCameraPos.xyz);
    u_xlat7.xy = u_xlat7.xy + hlslcc_mtx4unity_WorldToLight[3].xy;

...
void main()
{
    ...
    u_xlat2.xyz = abs(u_xlat1.xyz) / vec3(u_xlat12);
    vs_TEXCOORD0.xyz = u_xlat1.xyz;
    u_xlat1.xyz = u_xlat2.yyy * _ColorY.xyz;
    u_xlat1.xyz = _ColorX.xyz * u_xlat2.xxx + u_xlat1.xyz;
    vs_COLOR0.xyz = _ColorZ.xyz * u_xlat2.zzz + u_xlat1.xyz;
    vs_COLOR0.w = 1.0;

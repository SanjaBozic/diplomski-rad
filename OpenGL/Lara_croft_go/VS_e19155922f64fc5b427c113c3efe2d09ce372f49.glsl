...
void main()
{
    ...
    vs_TEXCOORD2.xyz = hlslcc_mtx4_PointLightMatrixC0[3].xyz * u_xlat0.www + u_xlat1.xyz;
    ...
    vs_TEXCOORD3.xyz = hlslcc_mtx4_PointLightMatrixC1[3].xyz * u_xlat0.www + u_xlat1.xyz;

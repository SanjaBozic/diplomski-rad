...
void main()
{
    ...
    vec3 txVec3 = vec3(u_xlat4.xy,u_xlat1.z);
    u_xlat10_8 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec3, 0.0);
    vec3 txVec4 = vec3(u_xlat4.zw,u_xlat1.z);
    ...
    u_xlat0.x = u_xlat4.y * u_xlat10_1.x + u_xlat0.x;
    u_xlat0.x = u_xlat3.x * u_xlat10_16 + u_xlat0.x;
    vec3 txVec9 = vec3(u_xlat5.xy,u_xlat1.z);

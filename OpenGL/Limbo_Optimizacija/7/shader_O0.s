...
; %bb.0:                                ; %main_body
	...
	s_mov_b32 s1, 0
	s_cmp_lg_u32 s0, s1
	buffer_store_dword v5, off, s[16:19], s5 offset:4 ; 4-byte Folded Spill
	buffer_store_dword v0, off, s[16:19], s5 offset:8 ; 4-byte Folded Spill
	v_writelane_b32 v6, s12, 0
	v_writelane_b32 v6, s11, 1
...
BB0_3:                                  ; %if6001
	...
	v_mov_b32_e32 v1, s0
                                        ; implicit-def: $sgpr0
	v_mov_b32_e32 v2, s0
	buffer_load_dword v3, off, s[16:19], s5 offset:8 ; 4-byte Folded Reload
	s_waitcnt vmcnt(0)
...
BB0_4:                                  ; %endif6001
	...
	s_movk_i32 s1, 0xff
	v_readlane_b32 s2, v6, 3
	s_and_b32 s1, s2, s1
	buffer_load_dword v0, off, s[16:19], s5 offset:12 ; 4-byte Folded Reload
	s_waitcnt vmcnt(0)
	v_cmp_gt_u32_e64 s1, s1, v0
	s_mov_b32 s3, exec_lo
	s_and_b32 s1, s3, s1
	v_writelane_b32 v6, s3, 6
	s_mov_b32 exec_lo, s1
	; mask branch BB0_6
	s_cbranch_execz BB0_6
BB0_5:                                  ; %if11500
	s_mov_b32 s0, 2
	buffer_load_dword v0, off, s[16:19], s5 offset:4 ; 4-byte Folded Reload
	s_waitcnt vmcnt(0)
	v_cmp_gt_u32_e64 s0, s0, v0
	s_mov_b32 s1, 1
	v_cmp_eq_u32_e64 s1, s1, v0
	v_readlane_b32 s2, v6, 2
	v_mov_b32_e32 v1, s2
	v_readlane_b32 s3, v6, 1

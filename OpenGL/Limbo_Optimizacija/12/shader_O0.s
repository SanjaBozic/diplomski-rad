...
; %bb.0:                                ; %main_body
	...
	s_waitcnt lgkmcnt(0)
	image_sample v[9:12], v[4:5], s[16:23], s[24:27] dmask:0xf dim:SQ_RSRC_IMG_2D
	s_waitcnt vmcnt(0)
	...
	buffer_store_dword v1, off, s[28:31], s6 offset:8 ; 4-byte Folded Spill
	s_waitcnt vmcnt(0)
	v_mov_b32_e32 v1, v2
	v_mov_b32_e32 v2, v3
	buffer_load_dword v3, off, s[28:31], s6 offset:8 ; 4-byte Folded Reload
                                        ; implicit-def: $sgpr5
	v_mov_b32_e32 v4, s5
                                        ; implicit-def: $sgpr5
	v_mov_b32_e32 v5, s5

		...
		{
			{
				vec4 posNoJitter;
				{
					...
					{
						posNoJitter.x = dot4( localPosition, _va_freqHigh[6 ] );
						posNoJitter.y = dot4( localPosition, _va_freqHigh[7 ] );
						posNoJitter.z = dot4( localPosition, _va_freqHigh[8 ] );
						posNoJitter.w = dot4( localPosition, _va_freqHigh[9 ] );
					};
				};
				...
				vec4 posLast;
				{
					...
					{
						posLast.x = dot4( localPosition, _va_freqHigh[10 ] );
						posLast.y = dot4( localPosition, _va_freqHigh[11 ] );
						posLast.z = dot4( localPosition, _va_freqHigh[12 ] );
						posLast.w = dot4( localPosition, _va_freqHigh[13 ] );
					};
				};

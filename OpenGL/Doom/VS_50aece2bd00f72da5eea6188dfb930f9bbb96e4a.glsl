...
void main() {
	{
		...
		{
			vofi_TexCoord2.x = dot4( localPosition, _va_freqHigh[4 ] );
			vofi_TexCoord2.y = dot4( localPosition, _va_freqHigh[5 ] );
			vofi_TexCoord2.z = dot4( localPosition, _va_freqHigh[6 ] );

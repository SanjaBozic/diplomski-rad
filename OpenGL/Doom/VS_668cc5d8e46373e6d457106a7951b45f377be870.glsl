...
void main() {
	{
		...
		vec4 viewOriginToVertex;
		{
			...
			};
			{
				...
				localToGlobalX.x = dot3( localTangent, _va_freqHigh[5 ] );
				localToGlobalX.y = dot3( localBitangent, _va_freqHigh[5 ] );
				localToGlobalX.z = dot3( localNormal, _va_freqHigh[5 ] );
				localToGlobalX.w = morphScale;
				localToGlobalY.x = dot3( localTangent, _va_freqHigh[6 ] );
				localToGlobalY.y = dot3( localBitangent, _va_freqHigh[6 ] );
				localToGlobalY.z = dot3( localNormal, _va_freqHigh[6 ] );
				localToGlobalY.w = 0.0;
				localToGlobalZ.x = dot3( localTangent, _va_freqHigh[7 ] );
				localToGlobalZ.y = dot3( localBitangent, _va_freqHigh[7 ] );
				localToGlobalZ.z = dot3( localNormal, _va_freqHigh[7 ] );
		...
		vofi_TexCoord6 = viewOriginToVertex;
		{

...
void main() {
	{
		...
		vofi_TexCoord5 = in_Normal * 2.0 - 1.0;
		vofi_TexCoord6 = in_Tangent * 2.0 - 1.0;
		vofi_TexCoord7.xy = ( vofi_TexCoord0.xy * _va_freqHigh[9 ].xy + vec2( _va_freqLow[4 ].x * _va_freqHigh[9 ].zw ) );
	}
}
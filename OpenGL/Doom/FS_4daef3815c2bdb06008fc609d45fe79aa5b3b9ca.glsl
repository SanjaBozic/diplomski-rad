	...
	{
		{
			...
			} ;
			{
				...
				inputs.output_lighting.xyz = mix( inputs.albedo * mix( refraction.xyz, _fa_freqHigh[2 ].xyz + inputs.diffuse_lighting, _fa_freqHigh[2 ].w * finalFalloff ), inputs.diffuse_lighting, inputs.alpha ) + inputs.specular_lighting;
				fogScale = 0.666;
				vec3 fogColor;
				float fogAmount;
				{

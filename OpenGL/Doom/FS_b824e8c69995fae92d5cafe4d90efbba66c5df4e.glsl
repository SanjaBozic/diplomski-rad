	...
	{
		{
			...
			{
				vec2 screenTC = screenPosToTexcoord( gl_FragCoord.xy, _fa_freqHigh[15 ] );
				vec4 distort = tex2D( samp_flowvariation, screenTC + vec2( _fa_freqLow[11 ].x * 0.5 ) ) * 2.0 - 1.0;
				distort *= 0.05;
				...
				final.w = 1.0;
				inputs.diffuse_lighting.xyz.xyz = final.xyz;
			};
			{

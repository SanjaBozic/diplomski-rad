...
void main() {
	{
		...
		{
			vofi_TexCoord7.x = dot4( in_Position, _va_freqHigh[4 ] );
			vofi_TexCoord7.y = dot4( in_Position, _va_freqHigh[5 ] );
			vofi_TexCoord7.z = dot4( in_Position, _va_freqHigh[6 ] );
			vofi_TexCoord7.w = 1.0;
		};
	}
}
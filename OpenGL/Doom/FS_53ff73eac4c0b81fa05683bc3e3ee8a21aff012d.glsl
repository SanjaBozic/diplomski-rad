				...
				{
					{
						...
						clusterCoordinate.xy = screenPosToTexcoord( inputs.fragCoord.xy, _fa_freqHigh[1 ] ) * _fa_freqLow[1 ].zw;
				...
				{
					{
						...
						inputs.normal = GetWorldSpaceNormal( inputs.normal, inputs.invTS, isFrontFacing );
						{
							...
							decalsMin = ( skipStaticModel == 0 && _fa_freqHigh[0 ].y == 0.0 ) ? decalsMax : decalsMin;

...
void main() {
	{
		vec4 mainBeam = tex2DDeGamma( samp_transmap, vofi_TexCoord0.xy + vec2( _fa_freqLow[0 ].x * _fa_freqHigh[0 ].z, _fa_freqLow[0 ].x * _fa_freqHigh[0 ].w ) );

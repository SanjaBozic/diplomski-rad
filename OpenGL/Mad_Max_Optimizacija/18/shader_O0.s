...
BB0_5:                                  ; %if11500
	...
	v_fmac_f32_e32 v9, s1, v5
	v_fmac_f32_e32 v10, s2, v5
	...
	v_fmac_f32_e32 v10, s2, v4
	v_fmac_f32_e32 v6, s4, v4
	s_buffer_load_dword s0, s[16:19], 0x40
	s_buffer_load_dword s1, s[16:19], 0x44
	s_buffer_load_dword s2, s[16:19], 0x48
	s_buffer_load_dword s4, s[16:19], 0x4c
	s_waitcnt lgkmcnt(0)
	v_mov_b32_e32 v4, s2
	v_fmac_f32_e32 v4, s0, v8
	v_mov_b32_e32 v5, s4
	v_fmac_f32_e32 v5, s1, v3
	exp pos0 v2, v9, v10, v6 done vm
                                        ; implicit-def: $sgpr0
	s_waitcnt expcnt(0)
	v_mov_b32_e32 v2, s0
                                        ; implicit-def: $sgpr0
	v_mov_b32_e32 v3, s0
	exp param0 v4, v5, v2, v3
BB0_6:                                  ; %endif6002

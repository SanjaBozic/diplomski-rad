...
main_body:
  ...
  %23 = insertelement <4 x i32> <i32 undef, i32 32768, i32 16, i32 822177708>, i32 %22, i32 0
  %24 = call nsz arcp contract float @llvm.amdgcn.s.buffer.load.f32(<4 x i32> %23, i32 0, i32 0) #1
  %25 = call nsz arcp contract float @llvm.amdgcn.s.buffer.load.f32(<4 x i32> %23, i32 4, i32 0) #1
  %26 = call nsz arcp contract float @llvm.amdgcn.s.buffer.load.f32(<4 x i32> %23, i32 8, i32 0) #1
  %27 = call nsz arcp contract float @llvm.amdgcn.s.buffer.load.f32(<4 x i32> %23, i32 12, i32 0) #1

...
main_body:
  ...
  %35 = ptrtoint float addrspace(6)* %2 to i32
  %36 = insertelement <4 x i32> <i32 undef, i32 32768, i32 16, i32 822177708>, i32 %35, i32 0
  %37 = call nsz arcp contract float @llvm.amdgcn.s.buffer.load.f32(<4 x i32> %36, i32 0, i32 0) #3
  %38 = extractelement <4 x float> %34, i32 0
  %39 = fmul nsz arcp contract float %38, %37
  %40 = extractelement <4 x float> %34, i32 1
  %41 = fmul nsz arcp contract float %40, %37
  %42 = extractelement <4 x float> %34, i32 2
  %43 = fmul nsz arcp contract float %42, %37
  %44 = extractelement <4 x float> %34, i32 3
  %45 = fmul nsz arcp contract float %44, %37
  %46 = insertvalue <{ i32, i32, i32, i32, i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float }> undef, i32 %4, 4
  %47 = insertvalue <{ i32, i32, i32, i32, i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float }> %46, float %39, 5
  %48 = insertvalue <{ i32, i32, i32, i32, i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float }> %47, float %41, 6
  %49 = insertvalue <{ i32, i32, i32, i32, i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float }> %48, float %43, 7
  %50 = insertvalue <{ i32, i32, i32, i32, i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float }> %49, float %45, 8
  %51 = insertvalue <{ i32, i32, i32, i32, i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float }> %50, float %20, 19
  ret <{ i32, i32, i32, i32, i32, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float }> %51
}

...
; %bb.0:                                ; %main_body
	...
	s_waitcnt lgkmcnt(0)
	image_sample v[6:9], v[4:5], s[12:19], s[20:23] dmask:0xf dim:SQ_RSRC_IMG_2D
	s_waitcnt vmcnt(0)
	v_mov_b32_e32 v0, v9
	v_mov_b32_e32 v1, v8
	v_mov_b32_e32 v2, v7
                                        ; kill: def $vgpr6 killed $vgpr6 killed $vgpr6_vgpr7_vgpr8_vgpr9 killed $exec
	...
	v_mul_f32_e32 v0, s0, v0
                                        ...
                                        ; implicit-def: $sgpr2
                                        ; implicit-def: $sgpr3
	buffer_store_dword v0, off, s[24:27], s6 offset:4 ; 4-byte Folded Spill
	v_mov_b32_e32 v0, v3
	buffer_store_dword v1, off, s[24:27], s6 offset:8 ; 4-byte Folded Spill
	v_mov_b32_e32 v1, v2
	buffer_load_dword v2, off, s[24:27], s6 offset:8 ; 4-byte Folded Reload

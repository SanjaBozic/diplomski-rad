...
; %bb.0:                                ; %main_body
	...
	v_writelane_b32 v16, s10, 0
	v_writelane_b32 v16, s3, 1
	v_writelane_b32 v16, s2, 2
	v_writelane_b32 v16, s12, 3
	v_writelane_b32 v16, s13, 4
	v_writelane_b32 v16, s14, 5
	v_writelane_b32 v16, s15, 6
	v_writelane_b32 v16, s16, 7
	v_writelane_b32 v16, s17, 8
	v_writelane_b32 v16, s18, 9
	v_writelane_b32 v16, s19, 10
	v_writelane_b32 v16, s32, 11
	v_writelane_b32 v16, s33, 12
	v_writelane_b32 v16, s34, 13
	v_writelane_b32 v16, s35, 14
...
BB0_5:                                  ; %if11500
	...
	v_readlane_b32 s8, v16, 11
	v_readlane_b32 s9, v16, 12
	v_readlane_b32 s10, v16, 13
	v_readlane_b32 s11, v16, 14
	s_waitcnt vmcnt(0)
	s_nop 0
	s_nop 0
	s_nop 0
	...
	v_readlane_b32 s12, v16, 7
	v_readlane_b32 s13, v16, 8
	v_readlane_b32 s14, v16, 9
	v_readlane_b32 s15, v16, 10
	s_waitcnt vmcnt(0)
	s_nop 0
	s_nop 0
	s_nop 0
	...
	v_readlane_b32 s16, v16, 3
	v_readlane_b32 s17, v16, 4
	v_readlane_b32 s18, v16, 5
	v_readlane_b32 s19, v16, 6
	s_waitcnt vmcnt(0)
	s_nop 0
	s_nop 0
	s_nop 0

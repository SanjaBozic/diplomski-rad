...
endif5020:                                        ; preds = %if5020, %main_body
  ...
  br i1 %42, label %if6001, label %endif6001

if6001:                                           ; preds = %endif5020
  %43 = bitcast i32 %20 to float
  call void @llvm.amdgcn.exp.f32(i32 20, i32 1, float %43, float undef, float undef, float undef, i1 true, i1 false) #2
  br label %endif6001

endif6001:                                        ; preds = %if6001, %endif5020
  %44 = and i32 %3, 255
  %45 = icmp ult i32 %41, %44
  br i1 %45, label %if11500, label %endif6002

if11500:                                          ; preds = %endif6001
  %46 = icmp ult i32 %25, 2
  %47 = icmp ne i32 %25, 1
  %.v.v = select i1 %46, i32 %10, i32 %11
  %.v = shl i32 %.v.v, 16
  %48 = ashr exact i32 %.v, 16
  %.v2 = select i1 %47, i32 %10, i32 %11
  %49 = ashr i32 %.v2, 16
  %50 = sitofp i32 %48 to float
  %51 = sitofp i32 %49 to float
  %52 = select nsz arcp contract i1 %46, float %13, float %15
  %53 = select nsz arcp contract i1 %47, float %14, float %16
  call void @llvm.amdgcn.exp.f32(i32 12, i32 15, float %50, float %51, float %12, float 1.000000e+00, i1 true, i1 true) #2
  call void @llvm.amdgcn.exp.f32(i32 32, i32 15, float %52, float %53, float %17, float %18, i1 false, i1 false) #2
  br label %endif6002

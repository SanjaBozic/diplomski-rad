...
void Blur9TapHVS(void) {
	...
	// output texcoords
	v_uv[0] = uv0 - offset*POSLIN9TAP2;
	v_uv[1] = uv0 - offset*POSLIN9TAP1;
	v_uv[2] = uv0;
	v_uv[3] = uv0 + offset*POSLIN9TAP1;
	v_uv[4] = uv0 + offset*POSLIN9TAP2;
}
#endif
...
void Blur9TapPS(void) {
	...
	color += texture2D(texture0, v_uv[0]) * WEILIN9TAP2;
	color += texture2D(texture0, v_uv[1]) * WEILIN9TAP1;
	color += texture2D(texture0, v_uv[2]) * WEILIN9TAP0;
	color += texture2D(texture0, v_uv[3]) * WEILIN9TAP1;
	color += texture2D(texture0, v_uv[4]) * WEILIN9TAP2;
...
void BlurBoxVS(void) {
	...
	// output texcoords
	v_uv[0] = uv0 + offset*vec2(-1.0, -1.0);
	v_uv[1] = uv0 + offset*vec2(-1.0, 1.0);
	v_uv[2] = uv0 + offset*vec2(1.0, -1.0);
	v_uv[3] = uv0 + offset*vec2(1.0, 1.0);
}
#endif
...
void BlurBoxPS(void) {
	...
	color += texture2D(texture0, v_uv[0]) * 0.25;
	color += texture2D(texture0, v_uv[1]) * 0.25;
	color += texture2D(texture0, v_uv[2]) * 0.25;
	color += texture2D(texture0, v_uv[3]) * 0.25;

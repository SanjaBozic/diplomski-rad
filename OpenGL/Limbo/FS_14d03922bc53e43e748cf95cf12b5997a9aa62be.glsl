...
#define FixedFunction3DAnaglyphPS main
...
lowp vec4 gl_LastFragData[1]; // redeclaration to specify correct precision
#elif ORIGO_GL_NV_shader_framebuffer_fetch
// TODO:ANDROID above gives error. Check if necessary.
#endif

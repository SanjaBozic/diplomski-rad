...
main_body:
  %20 = call <2 x i16> @llvm.amdgcn.cvt.pknorm.u16(float %5, float %6) #3
  %21 = call <2 x i16> @llvm.amdgcn.cvt.pknorm.u16(float %7, float %8) #3
  call void @llvm.amdgcn.exp.compr.v2i16(i32 0, i32 15, <2 x i16> %20, <2 x i16> %21, i1 true, i1 true) #4
  ret void
}

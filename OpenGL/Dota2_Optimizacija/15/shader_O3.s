...
BB0_5:                                  ; %if11500
	buffer_load_format_xy v[14:15], v9, s[20:23], 0 idxen
	buffer_load_format_xyzw v[0:3], v10, s[24:27], 0 idxen
	buffer_load_format_xy v[6:7], v11, s[28:31], 0 idxen
	v_mov_b32_e32 v8, 1.0
	v_mov_b32_e32 v9, 0
	s_waitcnt vmcnt(2)
	exp pos0 v14, v15, v8, v8 vm
	s_waitcnt vmcnt(1)
	exp pos1 v9, v0, v0, v0 done
	exp param0 v0, v1, v2, v3
	s_waitcnt vmcnt(0)
	exp param1 v6, v7, v0, v0
BB0_6:                                  ; %endif6002
	s_endpgm
.Lfunc_end0:

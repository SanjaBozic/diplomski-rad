...
main_body:
  %20 = bitcast float %5 to i32
  %21 = bitcast float %6 to i32
  %22 = call <2 x i16> @llvm.amdgcn.cvt.pk.u16(i32 %20, i32 %21) #3
  %23 = bitcast float %7 to i32
  %24 = bitcast float %8 to i32
  %25 = call <2 x i16> @llvm.amdgcn.cvt.pk.u16(i32 %23, i32 %24) #3
  call void @llvm.amdgcn.exp.compr.v2i16(i32 0, i32 15, <2 x i16> %22, <2 x i16> %25, i1 true, i1 true) #4
  ret void
}

#version 460 core
// ps_5_0
// Checksum: 663b92ae_24d6bf0e_a243d254_6c0e5786
// Name: particleeffectsofterosionns
...
void main()
{
	...
	r1.x = r2.w;
	r1.w = ((texture(resourceSamplerPair_2_ps, r1.xy)).xzwy).w;
	r1.xyz = r2.xyz;
	...
	r0.y = ((textureLod(resourceSamplerPair_3_ps, r3.xy, r0.y)).xwyz).y;
	...
	r3.yzw = fma(r1.www, v4.v.xyz, r3.yzw);

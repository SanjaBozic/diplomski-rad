#version 460 core
// ps_5_0
// Checksum: c8b08546_91b8189d_3a31d1ca_04c16749
// Name: particleeffectnsprjfarcullingvolume
...
void main()
{
	...
	r0.y = ((textureLod(resourceSamplerPair_3_ps, r2.xy, r0.y)).xwyz).y;
	...
	r1.w = r1.w * r3.y;
	r1.w = r0.y * r1.w;
	r5.xyz = ((textureLod(resourceSamplerPair_5_ps, r2.xzw, idx_uniforms1_ps.cb1[10].x))).xyz;
	r2.xyz = ((textureLod(resourceSamplerPair_6_ps, r2.xzw, idx_uniforms1_ps.cb1[10].x))).xyz;

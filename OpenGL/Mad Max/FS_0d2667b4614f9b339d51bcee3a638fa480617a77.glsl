#version 460 core
// ps_5_0
// Checksum: 0e3f3d4e_cacd0ae1_b0b6bef3_ca022257
// Name: characterskingenerallod2_refl_1bita_fade
...
void main()
{
	...
	r3.xy = uintBitsToFloat(movc(floatBitsToUint(r0.ww), floatBitsToUint(v1.v.xy), floatBitsToUint(v1.v.zw)));
	...
	r0.xyz = fma(r0.xyz, r3.xxx, r2.xyz);
	...
	r0.xyz = fma(r2.xyz, r0.www, r0.xyz);
	...
	r2.x = v3.v.w;
	r2.y = v4.v.w;
	r2.xy = r2.xy * idx_uniforms2_ps.cb2[1].zw;
	r2 = (texture(resourceSamplerPair_2_ps, r2.xy));
	r0.z = saturate(fma(r0.z, r2.w, -r0.w));
	r0.y = r0.z * r0.y;
	r0.y = min(r0.y, r2.w);
	r0.y = max(r0.y, float(0.00000000f));
	r0.zw = v6.v.xy * idx_uniforms2_ps.cb2[1].xy;
	r3 = (texture(resourceSamplerPair_3_ps, r0.zw));
	r1.xyz = r1.xyz * r3.xyz;
	r0.z = r3.w + r3.w;
	r3.xyz = r1.xyz * vec3(4.69999981f, 4.69999981f, 4.69999981f);
	r1.xyz = fma(-r1.xyz, vec3(4.69999981f, 4.69999981f, 4.69999981f), r2.xyz);
	...
	r0.x = ((texture(resourceSamplerPair_4_ps, v1.v.xy))).x;
	r0.w = intBitsToFloat(r0.x == float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
	r1.w = intBitsToFloat(float(0.500000000f) < r0.x ? int(0xffffffff) : int(0x00000000));
	o2.x = r0.x;
	r0.x = uintBitsToFloat(floatBitsToUint(r0.w) | floatBitsToUint(r1.w));
	o0.xyz = uintBitsToFloat(movc(floatBitsToUint(r0.xxx), floatBitsToUint(r2.xyz), floatBitsToUint(r1.xyz)));
	o0.w = uintBitsToFloat(uint(0x3f800000));
	o1.w = uintBitsToFloat(uint(0x3f800000));
	r1.xyz = ((texture(resourceSamplerPair_5_ps, v1.v.xy))).xyz;
	r0.x = fma(-r1.y, r0.z, r2.w);
	r0.z = r0.z * r1.y;
	o2.zw = r1.zx;

#version 460 core
// vs_5_0
// Checksum: 73e62771_6725c5db_c1b1d460_7ad0e1bb
// Name: characteroutline2uvs
...
{
	Initialise();
	r0 = fma(v4, vec4(6.28318548f, 6.28318548f, 6.28318548f, 6.28318548f), vec4(-3.14159274f, -3.14159274f, -3.14159274f, -3.14159274f));
	...
	r3.z = r2.x;
	r0.y = dot(vec4(1.00000000f, 1.00000000f, 1.00000000f, 1.00000000f), v1);
	r0.y = float(1.00000000f) / r0.y;
	r1 = r0.yyyy * v1;
	r4 = intBitsToFloat(ivec4(v2) * ivec4(3, 3, 3, 3));
	r5 = r1.yyyy * idx_uniforms4_vs.cb4[floatBitsToInt(r4.y)];
	r5 = fma(r1.xxxx, idx_uniforms4_vs.cb4[floatBitsToInt(r4.x)], r5);
	r5 = fma(r1.zzzz, idx_uniforms4_vs.cb4[floatBitsToInt(r4.z)], r5);
	r5 = fma(r1.wwww, idx_uniforms4_vs.cb4[floatBitsToInt(r4.w)], r5);
	r6.y = dot(r5.xyz, r3.xzw);
	r7 = r1.yyyy * idx_uniforms4_vs.cb4[1 + floatBitsToInt(r4.y)];
	r7 = fma(r1.xxxx, idx_uniforms4_vs.cb4[1 + floatBitsToInt(r4.x)], r7);
	r7 = fma(r1.zzzz, idx_uniforms4_vs.cb4[1 + floatBitsToInt(r4.z)], r7);
	r7 = fma(r1.wwww, idx_uniforms4_vs.cb4[1 + floatBitsToInt(r4.w)], r7);
	r6.z = dot(r7.xyz, r3.xzw);
	r8 = r1.yyyy * idx_uniforms4_vs.cb4[2 + floatBitsToInt(r4.y)];
	r8 = fma(r1.xxxx, idx_uniforms4_vs.cb4[2 + floatBitsToInt(r4.x)], r8);
	r8 = fma(r1.zzzz, idx_uniforms4_vs.cb4[2 + floatBitsToInt(r4.z)], r8);
	r1 = fma(r1.wwww, idx_uniforms4_vs.cb4[2 + floatBitsToInt(r4.w)], r8);
	r6.x = dot(r1.xyz, r3.xzw);
	r2.z = r3.y;
	r3.z = dot(r5.yxz, r2.yzw);
	r3.x = dot(r7.yxz, r2.yzw);
	r3.y = dot(r1.yxz, r2.yzw);
	r0.yzw = r3.xyz * r6.xyz;
	r0.yzw = fma(r6.zxy, r3.yzx, -r0.yzw);
	...
	r4.y = dot(r7, r3);
	r6 = r4.yyyy * idx_uniforms3_vs.cb3[1];
	r4.x = dot(r5, r3);
	r4.z = dot(r1, r3);
	r1 = fma(r4.xxxx, idx_uniforms3_vs.cb3[0], r6);

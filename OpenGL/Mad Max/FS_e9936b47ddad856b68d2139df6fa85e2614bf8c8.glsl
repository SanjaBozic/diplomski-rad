#version 460 core
// ps_5_0
// Checksum: 3eea1e25_9b5ef8dc_d0831f3f_8386aec3
// Name: radialblur
...
void main()
{
	...
	r0.xy = r0.zz * r0.xy;
	r1.xy = fma(v1.v.xy, vec2(2.00000000f, 2.00000000f), idx_uniforms1_ps.cb1[6].xy);
	r1.xy = r1.xy + vec2(-1.00000000f, -1.00000000f);
	r2.x = idx_uniforms1_ps.cb1[5].z;
	r2.y = uintBitsToFloat(uint(0x3f800000));
	r1.xy = r1.xy / r2.xy;
	r0.z = dot(r1.xy, r1.xy);
	r1.z = inversesqrt(r0.z);
	r0.z = sqrt(r0.z);
	r0.z = saturate(r0.z + -idx_uniforms1_ps.cb1[5].x);
	r0.z = r0.z * r0.z;
	r0.z = r0.z * idx_uniforms1_ps.cb1[5].y;
	r0.z = saturate(r0.z * float(100.000000f));
	r1.xy = r1.zz * r1.xy;
	r1.xy = fma(-r1.xy, r2.xy, -r0.xy);
	r0.xy = fma(r0.zz, r1.xy, r0.xy);
	r0.xy = r0.xy + vec2(1.00000000f, 1.00000000f);
	o0.xy = r0.xy * vec2(0.500000000f, 0.500000000f);
	o0.w = r0.z;
	r0.x = intBitsToFloat(float(0.200000003f) < r0.z ? int(0xffffffff) : int(0x00000000));
	o0.z = uintBitsToFloat(movc(floatBitsToUint(r0.x), uint(0x00000000), floatBitsToUint(r0.w)));
	return;
}

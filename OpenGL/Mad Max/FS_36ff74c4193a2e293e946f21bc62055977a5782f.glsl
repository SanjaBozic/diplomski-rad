#version 460 core
// ps_5_0
// Checksum: 03cfa8de_6243d7a2_dde4e203_98b930a8
// Name: deferred_pointlightnd
...
void main()
{
	...
	r2.xyz = ((texture(resourceSamplerPair_2_ps, r0.xy)).xzwy).xyz;
	r3.xyz = ((texture(resourceSamplerPair_3_ps, r0.xy))).xyz;
	r0.x = saturate(r2.z + idx_uniforms2_ps.cb2[3].z);
	...
	r0.x = r0.x * r0.z;
	r4.xyz = r0.xxx * idx_uniforms1_ps.cb1[14].xyz;
	r4.xyz = r3.xyz * r4.xyz;
	r0.xyw = r0.www * r1.xyz;
	r0.xyz = r0.xyw * r0.zzz;
	r0.w = intBitsToFloat(r2.x < float(0.411764711f) ? int(0xffffffff) : int(0x00000000));
	r1.xy = r2.xy + vec2(-0.501960814f, -0.500000000f);

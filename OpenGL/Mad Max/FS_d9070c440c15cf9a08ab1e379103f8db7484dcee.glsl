#version 460 core
// ps_5_0
// Checksum: 83dd67ef_46ba4b9d_305bd806_edfa3330
// Name: particleeffecterosionnsprjfar
...
uniform samplerCube resourceSamplerPair_7_ps; // res4, s4
...
void main()
{
	...
	r1.x = r2.w;
	r1.w = ((texture(resourceSamplerPair_3_ps, r1.xy)).xzwy).w;
	r1.xyz = r2.xyz;
	r0.y = fma(r2.w, float(-0.200000003f), float(1.00000000f));
	r2 = r1 * v2.v;
	...
	r0.xzw = v4.v.xyz + -idx_uniforms0_ps.cb0[5].xyz;
	...
	r0.y = ((textureLod(resourceSamplerPair_4_ps, r3.xy, r0.y)).xwyz).y;
	...
	r4 = r4 * v9.v.wwww;
	r5 = (texture(resourceSamplerPair_5_ps, v1.v.xy));
	...
	r1.w = inversesqrt(r1.w);
	r3 = r1.wwww * r3;
	r1.w = dot(r0.xwz, r3.xzw);
	r1.w = r1.w + r1.w;
	r4.xyz = fma(r3.xwz, -r1.www, r0.xzw);
	r0.xzw = fma(r3.xyz, vec3(-0.400000006f, -0.400000006f, -0.400000006f), r0.xzw);
	...
	r1.w = r1.w * r3.y;
	r1.w = r0.y * r1.w;
	r3.yzw = ((textureLod(resourceSamplerPair_6_ps, r4.xyz, idx_uniforms1_ps.cb1[10].x)).wxyz).yzw;
	r4.xyz = ((textureLod(resourceSamplerPair_7_ps, r4.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;
	...
	r2.xyz = -idx_uniforms1_ps.cb1[3].xyz + idx_uniforms1_ps.cb1[4].xyz;
	r2.xyz = fma(r3.xxx, r2.xyz, idx_uniforms1_ps.cb1[3].xyz);
	r2.xyz = fma(r2.xyz, idx_uniforms1_ps.cb1[4].www, v6.v.xyz);
	r2.xyz = fma(r5.xyz, r0.yyy, r2.xyz);
	r2.xyz = fma(r1.xyz, r2.xyz, r3.yzw);
	r1.xyz = r1.xyz + vec3(0.00999999978f, 0.00999999978f, 0.00999999978f);
	r1.w = dot(r0.xzw, r0.xzw);
	r1.w = inversesqrt(r1.w);
	r0.xzw = r0.xzw * r1.www;
	r0.x = saturate(dot(r0.xzw, v8.v.xyz));
	r0.x = log2(r0.x);

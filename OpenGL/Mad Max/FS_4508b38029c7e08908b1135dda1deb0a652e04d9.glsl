#version 460 core
// ps_5_0
// Checksum: c8274576_2bfb355a_f2375f7c_03216f02
// Name: fastter_noplxlod2cidx2cgc
...
void main()
{
	...
	r3.zw = r5.xy / r2.ww;
	r2.w = r3.w * idx_uniforms1_ps.cb1[7].w;
	r2.w = fma(idx_uniforms1_ps.cb1[6].w, r3.z, r2.w);

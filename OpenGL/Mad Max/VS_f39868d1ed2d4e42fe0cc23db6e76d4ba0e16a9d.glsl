#version 460 core
// vs_5_0
// Checksum: 5efef9ad_b25fa9e8_76812249_b3342d43
// Name: particleeffectblendpixelshadowsofterosionns
...
void main()
{
	...
	r0.z = sqrt(r0.z);
	r4.xy = -r0.zz + vec2(1.00000000f, 2.00000000f);
	...
	r0.xyz = fma(idx_uniforms0_vs.cb0[5].xyz, r0.xxx, -r5.xyz);
	...
	r1.z = r1.x * abs(r1.y);
	r0.xyz = fma(r1.zzz, r0.xyz, r5.xyz);
	...
	r0.x = max(r4.x, r0.x);
	r0.y = float(1.00000000f) / r4.y;
	r0.x = saturate(r0.y * r0.x);
	r1.xyz = r0.xxx * idx_uniforms2_vs.cb2[2].xyz;
	r0.x = v3.x * float(8.00000000f);
	r4.yzw = r0.xxx * r1.xyz;
	r0.z = dot(r4.yzw, vec3(0.212500006f, 0.715399981f, 0.0720999986f));
	...
	r1.xyz = -v0.xyz + idx_uniforms1_vs.cb1[7].xyz;
	...
	r0.z = fma(-r3.y, r0.w, float(0.100000001f));
	r0.z = r0.z + r0.z;
	r0.w = dot(r3.xzw, r3.xzw);
	r0.w = inversesqrt(r0.w);
	r3.xyz = r0.www * r3.xzw;
	r0.w = dot(r1.xyz, r3.xyz);
	r1.x = dot(-r1.xyz, idx_uniforms1_vs.cb1[9].xyz);
	...
	r0.x = r0.w * r0.x;
	r0.x = r1.x * r0.x;
	r1.xyz = r0.xxx * idx_uniforms1_vs.cb1[8].xyz;
	r0.x = idx_uniforms1_vs.cb1[4].w + -idx_uniforms1_vs.cb1[5].w;
	r0.x = max(r0.x, float(9.99999997e-07f));
	r4.yzw = -v0.xyz + idx_uniforms1_vs.cb1[4].xyz;
	...
	r1.w = dot(-r4.yzw, idx_uniforms1_vs.cb1[6].xyz);
	...
	r0.x = r0.w * r0.x;
	r0.x = r1.w * r0.x;
	r1.xyz = fma(r0.xxx, idx_uniforms1_vs.cb1[5].xyz, r1.xyz);
	r4.yzw = -v0.xyz + idx_uniforms1_vs.cb1[10].xyz;
	...
	r4.yzw = r0.www * r4.yzw;
	r0.w = dot(r4.yzw, r3.xyz);
	r1.w = dot(-r4.yzw, idx_uniforms1_vs.cb1[12].xyz);
	...
	r0.x = r0.w * r0.x;
	r0.x = r1.w * r0.x;
	r1.xyz = fma(r0.xxx, idx_uniforms1_vs.cb1[11].xyz, r1.xyz);
	r4.yzw = -v0.xyz + idx_uniforms1_vs.cb1[13].xyz;
	r0.x = dot(r4.yzw, r4.yzw);
	r0.w = inversesqrt(r0.x);
	r0.x = sqrt(r0.x);
	...
	r4.yzw = r0.www * r4.yzw;
	r0.w = dot(r4.yzw, r3.xyz);
	r1.w = dot(-r4.yzw, idx_uniforms1_vs.cb1[15].xyz);
	r1.w = saturate(r1.w + idx_uniforms1_vs.cb1[15].w);
	r1.w = r1.w * r1.w;
	r0.w = max(r4.x, r0.w);
	...
	r0.x = r0.y * r0.x;
	r0.x = r1.w * r0.x;
	r0.xyw = fma(r0.xxx, idx_uniforms1_vs.cb1[14].xyz, r1.xyz);
	...
	r0.xyz = fma(idx_uniforms0_vs.cb0[24].xyz, r2.xxx, idx_uniforms0_vs.cb0[27].xyz);
	r0.xyz = fma(idx_uniforms0_vs.cb0[25].xyz, r2.yyy, r0.xyz);
	o7.v.xyz = fma(idx_uniforms0_vs.cb0[26].xyz, r2.zzz, r0.xyz);
	r0.xyz = fma(idx_uniforms0_vs.cb0[28].xyz, r2.xxx, idx_uniforms0_vs.cb0[31].xyz);
	r0.xyz = fma(idx_uniforms0_vs.cb0[29].xyz, r2.yyy, r0.xyz);
	o8.v.xyz = fma(idx_uniforms0_vs.cb0[30].xyz, r2.zzz, r0.xyz);
	VertexEpilog();
	return;
}

#version 460 core
// ps_5_0
// Checksum: f4f8992f_550f2ec9_c1fcccb3_e562507d
// Name: generalmmlod0fade_ddetail_osn_terraincolor_sand
...
void main()
{
	...
	r5.x = ((texture(resourceSamplerPair_5_ps, r5.xy)).wxyz).x;
	if (floatBitsToUint(r4.y) != uint(0))
	{
		...
		r6.xyz = ((texture(resourceSamplerPair_6_ps, v7.v.xy))).xyz;
		...
		r4.y = inversesqrt(r4.y);
		r6 = (texture(resourceSamplerPair_7_ps, v1.v.zw));

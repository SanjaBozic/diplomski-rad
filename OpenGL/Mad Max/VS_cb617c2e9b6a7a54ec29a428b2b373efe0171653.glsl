#version 460 core
// vs_5_0
// Checksum: 47879885_07ca4bf8_191566d8_e1064a32
// Name: character23uvs_em
...
void main()
{
	...
	r3 = fma(v4, vec4(6.28318548f, 6.28318548f, 6.28318548f, 6.28318548f), vec4(-3.14159274f, -3.14159274f, -3.14159274f, -3.14159274f));
	...
	r2.zw = uintBitsToFloat(movc(floatBitsToUint(r0.xx), floatBitsToUint(r2.xy), floatBitsToUint(r0.yz)));
	o3.v.w = r2.z;
	o4.v.w = r2.w;
	r3.xyz = r1.xyz * r4.xyz;
	r1.xyz = fma(r4.zxy, r1.yzx, -r3.xyz);
	...
	r0.x = uintBitsToFloat(floatBitsToUint(r1.y) & floatBitsToUint(r1.x));
	r0.x = uintBitsToFloat(floatBitsToUint(r1.z) & floatBitsToUint(r0.x));
	r1.xyz = uintBitsToFloat(movc(floatBitsToUint(r0.xxx), uvec3(0x00000000, 0x3f800000, 0x00000000), floatBitsToUint(r3.xyz)));

#version 460 core
// ps_5_0
// Checksum: c25c5f73_d84d012b_3fcaa507_c42795b5
// Name: generalmmlod0_matte_osn_sand
...
void main()
{
	...
	if (floatBitsToUint(r1.w) != uint(0))
	{
		...
		r4.xyz = ((texture(resourceSamplerPair_3_ps, v7.v.xy))).xyz;
		...
		r4 = (texture(resourceSamplerPair_2_ps, v7.v.xy));
		r5.x = uintBitsToFloat(uint(0x3f800000));
		r3.xyz = r3.xyz * r4.xyz;
		r4.x = ((texture(resourceSamplerPair_2_ps, v7.v.zw)).wxyz).x;

#version 460 core
// ps_5_0
// Checksum: 0ddf190a_ee20d7a4_c98365eb_9b352bac
...
{
	Initialise();
	r0.x = ((texture(resourceSamplerPair_0_ps, v3.v.xy)).wxyz).x;
	...
	r0.xyz = v2.v.xyz / v2.v.www;
	r1.xyz = v1.v.xyz / v1.v.www;
	...
	o0.z = v1.v.w * float(0.00999999978f);

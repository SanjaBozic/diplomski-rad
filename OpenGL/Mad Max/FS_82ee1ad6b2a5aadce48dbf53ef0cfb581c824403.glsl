#version 460 core
// ps_5_0
// Checksum: f96cf68d_d9a15e75_44dbc3e5_91de0a8a
// Name: deferred_sunlight_cs_clt_clp_clfot
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r8.w = r6.w + float(0.250000000f);
		r8.w = r8.w * float(0.800000012f);
		r4.y = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r8.w), floatBitsToUint(r6.w))));
		r8.xyz = fma(-v2.v.xyz, r0.yyy, r8.xyz);

#version 460 core
// ps_5_0
// Checksum: 68a63eb6_59237c4e_30642ffb_ed524659
// Name: dofbokeh_rh_ef_fg_cf
...
uniform sampler3D resourceSamplerPair_9_ps; // res11, s11

uniform sampler2D resourceSamplerPair_10_ps; // res8, s8
...
void main()
{
	...
	r5 = (texture(resourceSamplerPair_5_ps, r0.xy));
	...
	r1.xyz = ((texture(resourceSamplerPair_8_ps, r0.xyz))).xyz;
	r0.xyz = ((texture(resourceSamplerPair_9_ps, r0.xyz))).xyz;
	r0.w = -idx_uniforms1_ps.cb1[1].w + float(1.00000000f);
	r0.xyz = -r1.xyz + r0.xyz;
	r0.xyz = fma(r0.www, r0.xyz, r1.xyz);
	r1.xy = fma(v1.v.xy, vec2(16.0000000f, 8.00000000f), idx_uniforms1_ps.cb1[3].zw);
	r0.w = ((texture(resourceSamplerPair_10_ps, r1.xy)).yzwx).w;

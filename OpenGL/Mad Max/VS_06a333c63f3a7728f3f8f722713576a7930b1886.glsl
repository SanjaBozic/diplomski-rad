#version 460 core
// vs_5_0
// Checksum: cd5adf34_621664ca_657497de_a155da15
...
void main()
{
	...
	r0.xy = fma(r0.xy, vec2(0.500000000f, -0.500000000f), vec2(0.500000000f, 0.500000000f));
	o1.v.zw = r0.xy * idx_uniforms1_vs.cb1[0].zw;
	o1.v.xy = r0.xy;
	VertexEpilog();
	return;
}

#version 460 core
// ps_5_0
// Checksum: b569be1d_3a1643b1_941cee54_47ca087c
// Name: generalmmlod0_dndetail_osn_terraincolor_sand_inst
...
void main()
{
	...
	r1.yzw = fma(v7.v.xyz, r1.yyy, r6.xyz);
	...
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r7.xyz = ((texture(resourceSamplerPair_7_ps, v10.v.xy))).xyz;
		...
		r6.x = ((texture(resourceSamplerPair_6_ps, v10.v.zw)).wxyz).x;

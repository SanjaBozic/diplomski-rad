#version 460 core
// ps_5_0
// Checksum: 1972df18_c6aa4618_13c69e68_35ac8c9e
// Name: generalmmlod0fade_osn_terraincolor_sand
...
void main()
{
	...
	r4.x = ((texture(resourceSamplerPair_4_ps, r4.xy)).wxyz).x;
	if (floatBitsToUint(r3.y) != uint(0))
	{
		...
		r5.xyz = ((texture(resourceSamplerPair_5_ps, v7.v.xy))).xyz;

#version 460 core
// ps_5_0
// Checksum: bf132747_30358b26_8bfae112_196905a1
// Name: particleeffecterosionns
...
void main()
{
	...
	r0.x = r1.w;
	r0.w = ((texture(resourceSamplerPair_1_ps, r0.xy)).xzwy).w;
	r0.xyz = r1.xyz;
	r1.x = fma(r1.w, float(-0.200000003f), float(1.00000000f));
	r2 = r0 * v2.v;
	...
	r1.yzw = v3.v.xyz + -idx_uniforms0_ps.cb0[5].xyz;
	r3.xyz = r1.xxx * r1.yzw;
	r4.xyz = fma(r1.yzw, r1.xxx, idx_uniforms0_ps.cb0[5].xyz);
	...
	r0.w = ((textureLod(resourceSamplerPair_2_ps, r3.xy, r0.w))).w;
	r0.w = saturate(r0.w + idx_uniforms1_ps.cb1[1].x);
	r1.x = saturate(v9.v.x);
	r0.w = r0.w * r1.x;
	...
	r1.w = saturate(dot(r4.xyz, v7.v.xyz));
	r1.w = log2(r1.w);
	...
	r1.w = r1.w * r3.z;
	r1.w = r0.w * r1.w;
	r3.xzw = ((textureLod(resourceSamplerPair_4_ps, r4.xyz, idx_uniforms1_ps.cb1[10].x)).xwyz).xzw;
	r4.xyz = ((textureLod(resourceSamplerPair_5_ps, r4.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;
	...
	r3.xzw = fma(r1.www, v4.v.xyz, r3.xzw);
	r1.w = v1.v.z * idx_uniforms1_ps.cb1[0].y;
	r0.xyz = fma(r0.xyz, r1.www, r2.xyz);
	o0.w = r2.w;
	r2.xyz = -idx_uniforms1_ps.cb1[3].xyz + idx_uniforms1_ps.cb1[4].xyz;
	r2.xyz = fma(r3.yyy, r2.xyz, idx_uniforms1_ps.cb1[3].xyz);
	r2.xyz = fma(r2.xyz, idx_uniforms1_ps.cb1[4].www, v5.v.xyz);
	r2.xyz = fma(r5.xyz, r0.www, r2.xyz);
	r2.xyz = fma(r0.xyz, r2.xyz, r3.xzw);

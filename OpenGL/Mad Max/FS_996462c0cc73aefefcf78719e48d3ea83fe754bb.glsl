#version 460 core
// ps_5_0
// Checksum: 545b9bd6_d6aa6298_deece208_2c11badb
// Name: particleeffecterosionnsprjfarcullingvolume
...
void main()
{
	...
	r2.x = r0.y * r1.w;
	r2.y = v1.v.w;
	r1.w = ((texture(resourceSamplerPair_3_ps, r2.xy)).xzwy).w;
	...
	r0.y = ((textureLod(resourceSamplerPair_4_ps, r2.xy, r0.y)).xwyz).y;

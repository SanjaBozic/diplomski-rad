#version 460 core
// ps_5_0
// Checksum: 68207198_5a26cab4_a6d89184_e131da41
// Name: particleeffectadditivepixelshadowsofterosionprjfarcullingvolume
...
void main()
{
	...
	r1.z = r1.w * r1.z;
	r2.xyz = fma(v6.v.xyz, r1.zzz, v7.v.xyz);
	...
	r1.x = ((texture(resourceSamplerPair_4_ps, r1.xy))).x;
	r1.x = v0.z / r1.x;

#version 460 core
// ps_5_0
// Checksum: b6188831_3ddec39d_07242e44_57cc5638
// Name: deferred_sunlight_clt_clfo
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r3.w = r2.z + float(0.250000000f);
		r3.w = r3.w * float(0.800000012f);
		r2.z = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r3.w), floatBitsToUint(r2.z))));
		r4.xyw = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[18].xyz);
		r3.w = dot(r4.xyw, r4.xyw);
		r3.w = inversesqrt(r3.w);
		r4.xyw = r3.www * r4.xyw;
		r3.w = r2.z * idx_uniforms1_ps.cb1[17].x;
		r2.z = r1.x * r2.z;
		...
		r9.xyz = r2.www * idx_uniforms1_ps.cb1[26].xyz;
		r2.xzw = fma(idx_uniforms1_ps.cb1[16].xyz, r2.xxx, r9.xyz);

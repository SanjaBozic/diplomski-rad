#version 460 core
// vs_5_0
// Checksum: dbd5c5c3_6c4da047_2dfa98ac_bb2d8822
// Name: particleeffectsofterosion
...
void main()
{
	...
	r1.xyz = fma(idx_uniforms0_vs.cb0[5].xyz, r0.xxx, -r3.xyz);
	...
	r1.w = r0.x * abs(r0.y);
	r1.xyz = fma(r1.www, r1.xyz, r3.xyz);
	...
	o4.v.xyz = fma(idx_uniforms1_vs.cb1[16].zzz, r1.xyz, r1.www);

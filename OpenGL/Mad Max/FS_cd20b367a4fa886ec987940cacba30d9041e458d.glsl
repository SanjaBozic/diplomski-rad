#version 460 core
// ps_5_0
// Checksum: 1d266834_f77299d9_37057695_0cf7f7f7
// Name: fastter_noplxlod0cidx3cgc
...
void main()
{
	...
	r2.w = fma(idx_uniforms1_ps.cb1[7].w, r2.y, r3.x);
	r2.w = fma(idx_uniforms1_ps.cb1[8].w, r2.z, r2.w);
	...
	r3.xyz = r3.yzw * vec3(8.00000000f, 8.00000000f, 8.00000000f);
	...
	r3.yw = r3.yy * r5.zw;
	r3.xy = fma(r3.xx, r5.xy, r3.yw);
	r1.w = ((texture(resourceSamplerPair_4_ps, r1.xyw))).w;
	r1.w = r1.w * r2.y;
	r0.w = fma(r2.x, r0.w, r1.w);
	...
	r1.y = saturate(fma(r2.z, r1.x, r0.w));

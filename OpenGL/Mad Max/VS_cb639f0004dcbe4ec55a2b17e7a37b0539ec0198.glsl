#version 460 core
// vs_5_0
// Checksum: 924ac3c6_c02f8938_e859118d_5be54ce6
// Name: character82uvs_em
...
void main()
{
	...
	r0.zw = v5.zw * idx_uniforms1_vs.cb1[1].xy;
	o1.v = r0;
	...
	r1.x = intBitsToFloat(idx_uniforms1_vs.cb1[0].w == float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
	r1.xy = uintBitsToFloat(movc(floatBitsToUint(r1.xx), floatBitsToUint(r0.xy), floatBitsToUint(r0.zw)));
	o3.v.w = r1.x;
	o4.v.w = r1.y;
	...
	r1.x = intBitsToFloat(idx_uniforms1_vs.cb1[2].z == float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
	r0.xy = uintBitsToFloat(movc(floatBitsToUint(r1.xx), floatBitsToUint(r0.xy), floatBitsToUint(r0.zw)));

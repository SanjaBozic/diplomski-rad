#version 460 core
// ps_5_0
// Checksum: 650b09f7_f60600f2_77033698_fe1691a6
// Name: dirtroadmaskcf
...
{
	Initialise();
	r0 = v2.v.xyxz * idx_uniforms1_ps.cb1[0].xzxz;
	...
	r2 = (texture(resourceSamplerPair_3_ps, r0.xy));
	r0 = (texture(resourceSamplerPair_3_ps, r0.zw));
	r2 = -r0 + r2;

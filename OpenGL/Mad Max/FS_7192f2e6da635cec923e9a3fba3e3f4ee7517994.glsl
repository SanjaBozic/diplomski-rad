#version 460 core
// ps_5_0
// Checksum: 78f0d90d_a2d4fa88_3b81c93d_af611bd2
// Name: generalmmlod0_ddetail_sand
...
void main()
{
	...
	r4 = (texture(resourceSamplerPair_3_ps, r2.yw));
	...
	r2.y = ((texture(resourceSamplerPair_4_ps, r7.xy)).xwyz).y;

#version 460 core
// ps_5_0
// Checksum: 5aac730e_bace6750_2b9711f9_27f86133
// Name: deferred_sunlight_ind_clt_clft
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r7.w = r6.x * r7.w;
		r7.w = r4.x * r7.w;
		r8.w = dot(idx_uniforms1_ps.cb1[18].xyz, r0.yzw);
		r9.w = intBitsToFloat(float(0.00000000f) < r4.y ? int(0xffffffff) : int(0x00000000));
		r10.z = r8.w + float(0.250000000f);
		r10.z = r10.z * float(0.800000012f);
		r8.w = saturate(uintBitsToFloat(movc(floatBitsToUint(r9.w), floatBitsToUint(r10.z), floatBitsToUint(r8.w))));
		r11.xyz = fma(-v2.v.xyz, r2.xxx, idx_uniforms1_ps.cb1[18].xyz);
		r2.x = dot(r11.xyz, r11.xyz);
		r2.x = inversesqrt(r2.x);
		r11.xyz = r2.xxx * r11.xyz;
		r2.x = r8.w * idx_uniforms1_ps.cb1[17].x;
		r6.w = r6.w * r8.w;
		r8.w = dot(r11.xyz, r0.yzw);
		r3.w = fma(r3.w, r8.w, -r3.w);
		r3.w = exp2(r3.w);

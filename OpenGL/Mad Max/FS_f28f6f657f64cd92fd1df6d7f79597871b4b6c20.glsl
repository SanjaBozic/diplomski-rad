#version 460 core
// ps_5_0
// Checksum: 64962caa_117cbf55_4b63dcd9_7cd39b73
// Name: fastter_noplxlod2cidx4cgc
...
uniform sampler2D resourceSamplerPair_6_ps; // res5, s5
...
void main()
{
	...
	r2.w = dot(r4, vec4(1.00000000f, 1.00000000f, 1.00000000f, 1.00000000f));
	r4 = r4 / r2.wwww;
	r2.w = r4.y * idx_uniforms1_ps.cb1[7].w;
	r2.w = fma(idx_uniforms1_ps.cb1[6].w, r4.x, r2.w);
	r2.w = fma(idx_uniforms1_ps.cb1[8].w, r4.z, r2.w);
	r2.w = fma(idx_uniforms1_ps.cb1[9].w, r4.w, r2.w);
	r2.w = r2.w * float(1.50000000f);
	r3.zw = ((texture(resourceSamplerPair_6_ps, v1.v.xy)).yzxw).zw;

#version 460 core
// ps_5_0
// Checksum: 7e6d9357_0409f6da_b3f33a3d_856b6d85
// Name: generalmmlod0fade_sdndetail_osn_terraincolor_sand_inst
...
void main()
{
	...
	r1.z = ((texture(resourceSamplerPair_8_ps, r6.xy)).xywz).z;
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r6 = (texture(resourceSamplerPair_8_ps, v10.v.xy));
		r4.w = uintBitsToFloat(uint(0x3f800000));
		r5.xyz = r5.xyz * r6.xyz;
		r5.w = ((texture(resourceSamplerPair_8_ps, v10.v.zw))).w;

#version 460 core
// ps_5_0
// Checksum: 61cbf97d_28734e62_e1f545bc_109cf9be
// Name: fastter_noplxlod1cidx4cgc
...
void main()
{
	...
	r2 = r2 / r1.yyyy;
	r1.y = r2.y * idx_uniforms1_ps.cb1[7].w;
	r1.y = fma(idx_uniforms1_ps.cb1[6].w, r2.x, r1.y);
	r1.y = fma(idx_uniforms1_ps.cb1[8].w, r2.z, r1.y);
	r1.y = fma(idx_uniforms1_ps.cb1[9].w, r2.w, r1.y);
	...
	r1.y = r1.y * float(1.50000000f);
	r0.xy = fma(r1.yy, r0.xy, r0.zw);
	...
	r0.zw = ((texture(resourceSamplerPair_4_ps, r4.xyz)).xzyw).zw;
	r0.zw = fma(r0.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r1.y = ((texture(resourceSamplerPair_5_ps, r4.xyz)).xwyz).y;
	r4.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r4.z = idx_uniforms1_ps.cb1[7].y;
	r1.zw = ((texture(resourceSamplerPair_4_ps, r4.xyz)).xzyw).zw;
	r1.zw = fma(r1.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r1.zw = r1.zw * r3.yy;
	r0.zw = fma(r3.xx, r0.zw, r1.zw);
	r1.z = ((texture(resourceSamplerPair_5_ps, r4.xyz)).xywz).z;
	r1.z = r1.z * r2.y;
	r1.y = fma(r2.x, r1.y, r1.z);
	r4.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r4.z = idx_uniforms1_ps.cb1[8].y;
	r1.zw = ((texture(resourceSamplerPair_4_ps, r4.xyz)).xzyw).zw;
	r1.zw = fma(r1.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r0.zw = fma(r3.zz, r1.zw, r0.zw);
	r1.z = ((texture(resourceSamplerPair_5_ps, r4.xyz)).xywz).z;
	r1.y = fma(r2.z, r1.z, r1.y);
	r2.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r2.z = idx_uniforms1_ps.cb1[9].y;
	r1.zw = ((texture(resourceSamplerPair_4_ps, r2.xyz)).xzyw).zw;
	r1.zw = fma(r1.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r0.zw = fma(r3.ww, r1.zw, r0.zw);
	r1.z = ((texture(resourceSamplerPair_5_ps, r2.xyz)).xywz).z;
	r1.y = saturate(fma(r2.w, r1.z, r1.y));

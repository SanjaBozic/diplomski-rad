#version 460 core
// ps_5_0
// Checksum: cabaf491_2e8f265f_72731c9a_4289c1c6
// Name: deferred_sunlight_cs_clt_clp
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r2.x = dot(r8.xyz, r15.xyz);
		r2.z = r2.x + float(0.250000000f);
		r2.z = r2.z * float(0.800000012f);
		r2.x = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r2.z), floatBitsToUint(r2.x))));
		r8.xyz = fma(-v2.v.xyz, r0.yyy, r8.xyz);
		r2.z = dot(r8.xyz, r8.xyz);
		r2.z = inversesqrt(r2.z);
		r8.xyz = r2.zzz * r8.xyz;
		r2.z = r2.x * idx_uniforms1_ps.cb1[17].x;
		r2.x = r0.w * r2.x;
		r4.y = dot(r8.xyz, r15.xyz);
		r4.y = fma(r4.x, r4.y, -r4.x);
		r4.y = exp2(r4.y);
		r4.y = min(r4.y, float(1.00000000f));
		r2.x = r2.x * r4.y;
		r2.x = r2.x * idx_uniforms1_ps.cb1[17].y;
		r8.xyz = r3.www * idx_uniforms1_ps.cb1[25].xyz;
		r8.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r2.zzz, r8.xyz);

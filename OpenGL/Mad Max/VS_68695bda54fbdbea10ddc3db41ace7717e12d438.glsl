#version 460 core
// vs_5_0
// Checksum: 88af98b8_b8bd5491_305ae21d_7735de6e
// Name: particleeffecttrailerosionpixelshadow
...
void main()
{
	...
	r2.xyz = fma(v2.xyz, vec3(2.00787401f, 2.00787401f, 2.00787401f), vec3(-1.00000000f, -1.00000000f, -1.00000000f));
	r2.w = dot(r2.xyz, r2.xyz);
	r3.x = inversesqrt(r2.w);
	r2.w = sqrt(r2.w);
	r2.w = r2.w + float(-0.500000000f);
	r2.w = saturate(fma(-r2.w, float(2.00000000f), float(1.00000000f)));
	r3.yzw = r2.xyz * r3.xxx;
	...
	o2.v.w = r0.x * r0.w;
	r0.xyz = fma(idx_uniforms0_vs.cb0[24].xyz, r1.yyy, idx_uniforms0_vs.cb0[27].xyz);
	r0.xyz = fma(idx_uniforms0_vs.cb0[25].xyz, r1.zzz, r0.xyz);
	o3.v.xyz = fma(idx_uniforms0_vs.cb0[26].xyz, r1.www, r0.xyz);
	r0.xyz = fma(idx_uniforms0_vs.cb0[28].xyz, r1.yyy, idx_uniforms0_vs.cb0[31].xyz);
	r0.xyz = fma(idx_uniforms0_vs.cb0[29].xyz, r1.zzz, r0.xyz);
	o4.v.xyz = fma(idx_uniforms0_vs.cb0[30].xyz, r1.www, r0.xyz);
	...
	r0.xyz = fma(idx_uniforms0_vs.cb0[5].xyz, r0.xxx, -r3.yzw);
	...
	r1.y = r0.w * abs(r1.x);
	r0.xyz = fma(r1.yyy, r0.xyz, r3.yzw);
	...
	r0.x = sqrt(r0.x);
	r0.x = -r0.x + float(1.00000000f);
	r4.xyz = fma(r2.xyz, r3.xxx, idx_uniforms0_vs.cb0[5].xyz);
	r0.z = fma(-r2.y, r3.x, float(0.100000001f));
	r0.z = r0.z + r0.z;

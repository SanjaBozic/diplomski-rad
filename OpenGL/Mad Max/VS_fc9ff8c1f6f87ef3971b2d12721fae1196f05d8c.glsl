#version 460 core
// vs_5_0
// Checksum: d5b2a582_ec63db25_3db78440_4d204f6c
// Name: charactersphdecal22uvs_fw
...
void main()
{
	...
	r3.zw = v2.zw * idx_uniforms1_vs.cb1[1].xy;
	o1.v = r3;
	...
	r6 = fma(v3, vec4(6.28318548f, 6.28318548f, 6.28318548f, 6.28318548f), vec4(-3.14159274f, -3.14159274f, -3.14159274f, -3.14159274f));
	...
	r0.xy = uintBitsToFloat(movc(floatBitsToUint(r0.xx), floatBitsToUint(r3.xy), floatBitsToUint(r3.zw)));

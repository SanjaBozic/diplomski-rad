#version 460 core
// ps_5_0
// Checksum: bc9ed70c_ed70ff86_1e757504_d85486f1
// Name: generalmmlod0fade_ddetail_osn_terraincolor_sand_inst
...
void main()
{
	...
	if (floatBitsToUint(r4.y) != uint(0))
	{
		...
		r6.xyz = ((texture(resourceSamplerPair_6_ps, v10.v.xy))).xyz;
		...
		r7 = (texture(resourceSamplerPair_5_ps, v10.v.xy));
		r5.z = uintBitsToFloat(uint(0x3f800000));
		r6.xyz = r6.xyz * r7.xyz;
		r5.w = ((texture(resourceSamplerPair_5_ps, v10.v.zw))).w;

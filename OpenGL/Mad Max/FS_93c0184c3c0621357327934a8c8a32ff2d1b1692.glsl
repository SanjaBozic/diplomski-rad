#version 460 core
// ps_5_0
// Checksum: 54910317_785538f9_2d8a1ff5_6f99f02b
// Name: generalmmlod0_ndetail_osn_terraincolor_sand_inst
...
void main()
{
	...
	r2.w = ((texture(resourceSamplerPair_5_ps, r5.xy))).w;
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r3.xyz = fma(r3.xzw, r6.xxx, r4.xyz);
		r3.xyz = fma(r5.xyz, r6.zzz, r3.xyz);
		...
		r5.x = ((texture(resourceSamplerPair_5_ps, v10.v.zw)).wxyz).x;
		...
		r2.w = uintBitsToFloat(movc(floatBitsToUint(r3.w), floatBitsToUint(r2.w), floatBitsToUint(r4.w)));
		...
		r5.x = fma(-r2.w, r3.w, float(1.00000000f));
		r4.w = r4.w / r5.x;

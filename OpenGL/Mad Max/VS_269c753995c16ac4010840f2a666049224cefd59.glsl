#version 460 core
// vs_5_0
// Checksum: fea3eb4d_8c1fa9ea_49082326_912e5537
// Name: generalmm_d1_ed0_vertexanim_inst
...
void main()
{
	...
	r3 = r0.yyyy * idx_uniforms3_vs.cb3[1].xyxy;
	r0 = fma(r0.xxxx, idx_uniforms3_vs.cb3[0].xyxy, r3);
	o2.v = r0 + idx_uniforms3_vs.cb3[2].xyxy;

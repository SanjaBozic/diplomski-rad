#version 460 core
// ps_5_0
// Checksum: 2677e60b_3413b762_5c5e14a4_30475631
// Name: deferred_sunlight_clo
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r6.xyz = fma(r18.yyy, r6.xyz, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		...
		r2.w = r2.w * r16.w;
		r2.w = r0.w * r2.w;
		r3.w = dot(idx_uniforms1_ps.cb1[18].xyz, r15.xyz);
		r4.x = r3.w + float(0.250000000f);
		r4.x = r4.x * float(0.800000012f);
		r3.w = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r4.x), floatBitsToUint(r3.w))));
		r4.xyw = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[18].xyz);
		r5.y = dot(r4.xyw, r4.xyw);
		r5.y = inversesqrt(r5.y);
		r4.xyw = r4.xyw * r5.yyy;
		r5.y = r3.w * idx_uniforms1_ps.cb1[17].x;
		r3.w = r2.w * r3.w;
		r4.x = dot(r4.xyw, r15.xyz);
		r4.x = fma(r2.z, r4.x, -r2.z);
		r4.x = exp2(r4.x);
		r4.x = min(r4.x, float(1.00000000f));
		r3.w = r3.w * r4.x;
		r3.w = r3.w * idx_uniforms1_ps.cb1[17].y;
		r4.xyw = r5.yyy * idx_uniforms1_ps.cb1[16].xyz;
		r8.xyz = r3.www * idx_uniforms1_ps.cb1[16].xyz;
		...
		r8.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[33].xz, r2.zw);
		r2.zw = r3.zz * idx_uniforms1_ps.cb1[38].yw;
		r9.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[38].xz, r2.zw);
		r8.y = r3.y;
		r3.xyz = ((textureLod(resourceSamplerPair_7_ps, r8.xyz, r4.z))).xyz;
		r9.y = r8.y;
		r4.xyz = ((textureLod(resourceSamplerPair_8_ps, r9.xyz, r4.z))).xyz;
		r4.xyz = -r3.xyz + r4.xyz;
		r3.xyz = fma(idx_uniforms1_ps.cb1[0].www, r4.xyz, r3.xyz);
		...
		r0.yzw = fma(r7.xyz, r0.www, r5.xyz);

#version 460 core
// ps_5_0
// Checksum: 99dbb48d_2e8d7132_b25deabd_070e3b0e
// Name: fastter_noplxlod12cidx4
...
void main()
{
	...
	r2 = r2 / r0.wwww;
	r0.w = r2.y * idx_uniforms1_ps.cb1[7].w;
	r0.w = fma(idx_uniforms1_ps.cb1[6].w, r2.x, r0.w);
	r0.w = fma(idx_uniforms1_ps.cb1[8].w, r2.z, r0.w);
	r0.w = fma(idx_uniforms1_ps.cb1[9].w, r2.w, r0.w);
	...
	r1.xy = ((texture(resourceSamplerPair_5_ps, r5.xyz)).ywxz).xy;

#version 460 core
// ps_5_0
// Checksum: 8846a0d6_c4494f34_a53e9d63_f2e7c61f
// Name: fastter_noplxlod0cidx1cgc
...
void main()
{
	...
	r1.w = saturate(dot(r2.xyz, vec3(1.00000000f, 1.00000000f, 1.00000000f)));
	...
	r1.w = dot(r3, vec4(1.00000000f, 1.00000000f, 1.00000000f, 1.00000000f));
	r1.w = r3.x / r1.w;
	r2.xy = r1.ww * idx_uniforms1_ps.cb1[6].wz;
	...
	r3.x = inversesqrt(r0.z);
	r0.xz = r0.xy * r3.xx;
	r1.z = idx_uniforms1_ps.cb1[6].y;
	r2.xz = ((texture(resourceSamplerPair_3_ps, r1.xyz)).yxwz).xz;
	r2.xz = fma(r2.zx, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r2.xy = r2.xz * r2.yy;
	r0.w = ((texture(resourceSamplerPair_4_ps, r1.xyz))).w;
	r1.y = saturate(r0.w * r1.w);
	...
	r0.y = r3.x;
	r2.xzw = fma(r2.xxx, r3.xyz, r0.xyz);
	r2.xzw = fma(r0.www, r0.xyz, r2.xzw);
	r4.xz = r3.zx * vec2(1.00000000f, -1.00000000f);
	r4.y = r0.z;
	...
	if (floatBitsToUint(r1.w) != uint(0))
	{
		...
		r3.xyz = fma(r5.wwy, r3.xyz, r0.xyz);
		r0.xyz = fma(r5.xxx, r0.xyz, r3.xyz);
		r3.xyz = r5.zzz * vec3(1.00000000f, 2.00000000f, 2.00000000f);
		r0.xyz = fma(r3.xyz, r4.xyz, r0.xyz);

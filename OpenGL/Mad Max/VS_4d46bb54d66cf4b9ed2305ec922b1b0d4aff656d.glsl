#version 460 core
// vs_5_0
// Checksum: 0d5facda_10136f87_c0aaa239_9072084a
// Name: character83uvs_fw
...
void main()
{
	...
	r2.z = fma(r0.y, idx_uniforms0_vs.cb0[13].z, -idx_uniforms0_vs.cb0[13].x);
	r2.z = min(r2.z, idx_uniforms0_vs.cb0[13].y);
	r2.z = -r2.z + float(1.00000000f);
	r1.w = fma(r1.w, r2.z, -idx_uniforms0_vs.cb0[12].x);

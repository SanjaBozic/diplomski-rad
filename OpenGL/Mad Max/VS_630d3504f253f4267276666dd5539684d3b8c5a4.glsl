#version 460 core
// vs_5_0
// Checksum: b7b1ed4d_7d2c3cec_834c1ed2_32a1eaaa
// Name: charactersphdecal23uvs_fw
...
void main()
{
	...
	gl_Position = r3;
	r0.w = -r3.z + r3.w;
	o1.v.zw = v2.zw * idx_uniforms1_vs.cb1[1].xy;
	r3.xy = v2.xy * idx_uniforms1_vs.cb1[0].yz;
	o1.v.xy = r3.xy;
	r6.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[0].xyz);
	r1.w = dot(r6.xyz, r6.xyz);
	r1.w = saturate(fma(-r1.w, idx_uniforms2_vs.cb2[0].w, float(1.00000000f)));
	r6.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[1].xyz);
	r2.w = dot(r6.xyz, r6.xyz);
	r2.w = saturate(fma(-r2.w, idx_uniforms2_vs.cb2[1].w, float(1.00000000f)));
	r1.w = r1.w + r2.w;
	r6.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[2].xyz);
	r2.w = dot(r6.xyz, r6.xyz);
	r2.w = saturate(fma(-r2.w, idx_uniforms2_vs.cb2[2].w, float(1.00000000f)));
	r1.w = r1.w + r2.w;
	r6.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[3].xyz);
	r2.w = dot(r6.xyz, r6.xyz);
	r2.w = saturate(fma(-r2.w, idx_uniforms2_vs.cb2[3].w, float(1.00000000f)));
	r1.w = r1.w + r2.w;
	r6.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[4].xyz);
	r2.w = dot(r6.xyz, r6.xyz);
	r2.w = saturate(fma(-r2.w, idx_uniforms2_vs.cb2[4].w, float(1.00000000f)));
	r1.w = r1.w + r2.w;
	r6.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[5].xyz);
	r2.w = dot(r6.xyz, r6.xyz);
	r2.w = saturate(fma(-r2.w, idx_uniforms2_vs.cb2[5].w, float(1.00000000f)));
	r1.w = r1.w + r2.w;
	o2.v.w = min(r1.w, float(1.00000000f));
	r6 = fma(v4, vec4(6.28318548f, 6.28318548f, 6.28318548f, 6.28318548f), vec4(-3.14159274f, -3.14159274f, -3.14159274f, -3.14159274f));
	{ vec4 src = r6; r7 = sin(src); r8 = cos(src); }
	r1.w = intBitsToFloat(float(0.00000000f) < r6.w ? int(0xffffffff) : int(0x00000000));
	r1.w = uintBitsToFloat(movc(floatBitsToUint(r1.w), uint(0x3f800000), uint(0xbf800000)));
	r6.w = r8.y;
	r6.xy = abs(r7.yw) * r8.xz;
	r8.xy = abs(r7.yw) * r7.xz;
	r6.z = r8.x;
	r7.z = dot(r1.xyz, r6.xzw);
	r9.xyz = r7.zzz * idx_uniforms3_vs.cb3[5].xyz;
	r7.y = dot(r5.xyz, r6.xzw);
	r7.x = dot(r0.xyz, r6.xzw);
	r8.z = r6.y;
	r6.xyz = fma(r7.yyy, idx_uniforms3_vs.cb3[4].xyz, r9.xyz);
	o2.v.xyz = fma(r7.xxx, idx_uniforms3_vs.cb3[6].xyz, r6.xyz);
	r1.x = dot(r1.yxz, r8.yzw);
	r6.xyz = r1.xxx * idx_uniforms3_vs.cb3[5].xyz;
	r1.z = dot(r5.yxz, r8.yzw);
	r1.y = dot(r0.yxz, r8.yzw);
	r0.xyz = fma(r1.zzz, idx_uniforms3_vs.cb3[4].xyz, r6.xyz);
	...
	r0.xyz = fma(r7.zxy, r1.yzx, -r0.xyz);
	...
	r0.yz = v3.xy * idx_uniforms1_vs.cb1[1].zw;
	r0.xy = uintBitsToFloat(movc(floatBitsToUint(r0.xx), floatBitsToUint(r3.xy), floatBitsToUint(r0.yz)));

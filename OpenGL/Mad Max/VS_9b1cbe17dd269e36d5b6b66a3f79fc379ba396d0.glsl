#version 460 core
// vs_5_0
// Checksum: 3ea57cef_30d4cad3_e085590e_64ec7932
...
void main()
{
	...
	r0.x = max(r0.y, abs(r0.x));
	r0.xy = r0.xx + -idx_uniforms1_vs.cb1[4].xz;
	o3.v.xy = saturate(fma(-r0.xy, idx_uniforms1_vs.cb1[4].yw, vec2(1.00000000f, 1.00000000f)));
	o1.v.zw = fma(r1.xz, vec2(3.05175781e-05f, 3.05175781e-05f), vec2(0.500000000f, 0.500000000f));
	o2.v.xyz = r1.xyz;

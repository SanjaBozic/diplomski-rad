#version 460 core
// ps_5_0
// Checksum: e7f9e9b8_346623a3_6059fca0_30d6cc0a
// Name: fastter_noplxlod12cidx3cgc
...
void main()
{
	...
	r3.xy = r2.xx * idx_uniforms1_ps.cb1[6].wz;
	r1.z = fma(idx_uniforms1_ps.cb1[7].w, r2.y, r3.x);
	...
	r3.z = r2.y * idx_uniforms1_ps.cb1[7].z;
	r3.w = r2.z * idx_uniforms1_ps.cb1[8].z;
	r1.xyz = r3.yzw * vec3(8.00000000f, 8.00000000f, 8.00000000f);
	...
	r1.w = ((texture(resourceSamplerPair_5_ps, r3.xyz))).w;
	r3.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r3.z = idx_uniforms1_ps.cb1[7].y;
	r4.zw = ((texture(resourceSamplerPair_4_ps, r3.xyz)).xzyw).zw;
	r4.zw = fma(r4.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r4.zw = r1.yy * r4.zw;
	r1.xy = fma(r1.xx, r4.xy, r4.zw);
	r2.w = ((texture(resourceSamplerPair_5_ps, r3.xyz))).w;
	r2.y = r2.w * r2.y;
	r1.w = fma(r2.x, r1.w, r2.y);
	r3.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);

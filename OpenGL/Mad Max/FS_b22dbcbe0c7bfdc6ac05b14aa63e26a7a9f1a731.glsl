#version 460 core
// ps_5_0
// Checksum: a613c5e5_30b4b4c1_0c9f0211_f6df16e7
// Name: deferred_pointlightpt
...
void main()
{
	...
	r1.z = sqrt(r1.z);
	r1.z = saturate(fma(r1.z, idx_uniforms1_ps.cb1[1].w, idx_uniforms1_ps.cb1[0].w));
	...
	r2.z = intBitsToFloat(r2.y < float(0.411764711f) ? int(0xffffffff) : int(0x00000000));
	r1.y = r2.y + r2.y;
	r1.xy = saturate(uintBitsToFloat(movc(floatBitsToUint(r2.zz), floatBitsToUint(r1.xy), floatBitsToUint(r4.xz))));
	r2.z = -r4.y + float(1.00000000f);
	r2.w = saturate(fma(r1.y, float(0.500000000f), -r1.w));
	r1.w = r1.w + float(1.00000000f);
	r1.w = saturate(r1.w * float(0.500000000f));
	r1.w = r1.w * r1.w;
	r0.x = fma(r2.w, r1.y, r0.x);
	...
	r1.y = r1.z * r2.x;
	r2.xyw = r1.yyy * idx_uniforms1_ps.cb1[14].xyz;
	r2.xyw = r3.xyz * r2.xyw;
	r2.xyw = r2.zzz * r2.xyw;
	r4.xyz = r1.www * r4.xyz;
	r1.yzw = r1.zzz * r4.xyz;
	r1.xyz = uintBitsToFloat(movc(floatBitsToUint(r1.xxx), floatBitsToUint(r1.yzw), floatBitsToUint(r0.xxx)));
	r1.xyz = r1.xyz * idx_uniforms1_ps.cb1[4].zzz;
	r1.xyz = r3.xyz * r1.xyz;
	r1.xyz = r2.zzz * r1.xyz;
	r3.xyz = r0.zzz * idx_uniforms1_ps.cb1[6].xyz;
	r0.xyz = fma(idx_uniforms1_ps.cb1[5].xyz, r0.yyy, r3.xyz);
	r0.xyz = fma(idx_uniforms1_ps.cb1[7].xyz, r0.www, r0.xyz);
	r0.xyz = ((textureLod(resourceSamplerPair_4_ps, r0.xyz, float(0.00000000f)))).xyz;
	r0.xyz = r0.xyz * idx_uniforms1_ps.cb1[1].xyz;
	o0.xyz = fma(r0.xyz, r1.xyz, r2.xyw);

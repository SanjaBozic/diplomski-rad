#version 460 core
// vs_5_0
// Checksum: f7ef3ff6_d6e45308_9067ad57_a0c87e4f
// Name: character2_fw
...
void main()
{
	...
	{ vec4 src = r2; r4 = sin(src); r6 = cos(src); }
	...
	r2.w = r6.y;
	r2.xy = abs(r4.yw) * r6.xz;
	r6.xy = abs(r4.yw) * r4.xz;
	r2.z = r6.x;
	r4.z = dot(r1.xyz, r2.xzw);
	r7.xyz = r4.zzz * idx_uniforms3_vs.cb3[5].xyz;
	r4.y = dot(r5.xyz, r2.xzw);
	r4.x = dot(r0.xyz, r2.xzw);
	r6.z = r2.y;
	...
	r2 = fma(idx_uniforms0_vs.cb0[24], r1.xxxx, idx_uniforms0_vs.cb0[27]);
	r2 = fma(idx_uniforms0_vs.cb0[25], r1.yyyy, r2);
	o6.v = fma(idx_uniforms0_vs.cb0[26], r1.zzzz, r2);
	r2 = fma(idx_uniforms0_vs.cb0[28], r1.xxxx, idx_uniforms0_vs.cb0[31]);
	r2 = fma(idx_uniforms0_vs.cb0[29], r1.yyyy, r2);
	o7.v = fma(idx_uniforms0_vs.cb0[30], r1.zzzz, r2);

#version 460 core
// ps_5_0
// Checksum: 829d1ae5_6c5ff52e_f2250a9b_361cb80d
// Name: particleeffectnscullingvolume
...
void main()
{
	...
	r1.w = r0.x * r1.w;
	r0 = r1 * v2.v;
	r1.w = fma(r1.w, float(-0.200000003f), float(1.00000000f));
	r1.xyz = fma(-r1.xyz, v2.v.xyz, idx_uniforms0_ps.cb0[13].xyz);
	r2.x = fma(idx_uniforms4_ps.cb4[4].x, r0.w, idx_uniforms4_ps.cb4[4].y);
	...
	r1.w = ((textureLod(resourceSamplerPair_1_ps, r3.xy, r1.w))).w;
	r1.w = saturate(r1.w + idx_uniforms1_ps.cb1[1].x);
	r2.w = saturate(v9.v.x);
	r1.w = r1.w * r2.w;
	r1.w = fma(r1.w, float(0.949999988f), float(0.0500000007f));
	...
	r0.xyz = fma(r1.xyz, r2.www, r0.xyz);
	o0.w = r0.w;
	r1.xyz = -idx_uniforms1_ps.cb1[3].xyz + idx_uniforms1_ps.cb1[4].xyz;
	r1.xyz = fma(r3.yyy, r1.xyz, idx_uniforms1_ps.cb1[3].xyz);
	r1.xyz = fma(r1.xyz, idx_uniforms1_ps.cb1[4].www, v5.v.xyz);
	r1.xyz = fma(r5.xyz, r1.www, r1.xyz);
	r1.xyz = fma(r0.xyz, r1.xyz, r3.xzw);
	r0.xyz = r0.xyz + vec3(0.00999999978f, 0.00999999978f, 0.00999999978f);
	r0.w = dot(r2.xyz, r2.xyz);
	r0.w = inversesqrt(r0.w);
	r2.xyz = r0.www * r2.xyz;
	r0.w = saturate(dot(r2.xyz, v7.v.xyz));
	r0.w = log2(r0.w);
	r0.w = r0.w * float(16.0000000f);
	r0.w = exp2(r0.w);
	r0.w = r1.w * r0.w;
	r0.xyz = r0.xyz * r0.www;

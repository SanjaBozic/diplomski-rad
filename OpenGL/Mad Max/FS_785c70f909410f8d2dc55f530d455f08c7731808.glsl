#version 460 core
// ps_5_0
// Checksum: 1fc9fd40_6c0fd165_96cd73a8_d266aa53
// Name: generalmmlod0fade_matte_osn_sand_inst
...
void main()
{
	...
	if (floatBitsToUint(r2.y) != uint(0))
	{
		...
		r5 = (texture(resourceSamplerPair_2_ps, v10.v.xy));
		r3.w = uintBitsToFloat(uint(0x3f800000));
		r4.xyz = r4.xyz * r5.xyz;
		r4.w = ((texture(resourceSamplerPair_2_ps, v10.v.zw))).w;

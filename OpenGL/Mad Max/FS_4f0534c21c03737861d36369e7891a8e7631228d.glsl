#version 460 core
// ps_5_0
// Checksum: 3cd4ee0f_72a63b5c_4f5c21f9_20d9d83d
// Name: fastter_noplxlod1cidx1
...
void main()
{
	...
	r1.x = r4.x / r1.x;
	r1.zw = r1.xx * idx_uniforms1_ps.cb1[6].wz;
	...
	r0.zw = ((texture(resourceSamplerPair_5_ps, r2.xyz)).xzyw).zw;

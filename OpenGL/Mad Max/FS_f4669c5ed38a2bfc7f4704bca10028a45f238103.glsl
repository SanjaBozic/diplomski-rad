#version 460 core
// ps_5_0
// Checksum: 0f45356d_6d78c6ae_f2823bcf_c52296f6
// Name: generalmmlod0fade_dndetail_terraincolor_sand_inst
...
void main()
{
	...
	r4.z = fma(idx_uniforms2_ps.cb2[3].x, r5.w, idx_uniforms2_ps.cb2[3].y);
	...
	r2.z = ((texture(resourceSamplerPair_6_ps, r2.zw)).xywz).z;
	if (floatBitsToUint(r2.y) != uint(0))
	{
		r8.xyz = ((texture(resourceSamplerPair_7_ps, v10.v.xy))).xyz;
		r8.xyz = fma(r8.xyz, vec3(2.00000000f, 2.00000000f, 2.00000000f), vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r6.xyz = r6.xyz * r8.yyy;
		r4.xyz = fma(r4.xyz, r8.xxx, r6.xyz);
		r1.xyz = fma(r1.xyz, r8.zzz, r4.xyz);
		...
		r6 = (texture(resourceSamplerPair_6_ps, v10.v.xy));
		r3.x = uintBitsToFloat(uint(0x3f800000));
		r4.xyz = r4.xyz * r6.xyz;
		r4.w = ((texture(resourceSamplerPair_6_ps, v10.v.zw))).w;
		r3.x = fma(r6.w, r3.x, float(0.750000000f));
		r6.x = r3.x * r4.w;
		r6.y = r2.w * float(0.699999988f);
		r3.x = fma(-r4.w, r3.x, float(0.100000001f));
		r3.x = fma(r6.y, r3.x, r6.x);
		...
		r3.yzw = fma(r2.xxx, r4.xyz, r5.xyw);
	...
	r5.x = r3.y * idx_uniforms2_ps.cb2[1].y;
	r5.w = saturate(r3.y + idx_uniforms2_ps.cb2[1].w);

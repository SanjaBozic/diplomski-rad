#version 460 core
// vs_5_0
// Checksum: 472ddf17_ff769fd8_5035b847_b1df026a
// Name: character
...
void main()
{
	...
	{ vec4 src = r0; r2 = sin(src); r4 = cos(src); }
	...
	r5.w = r4.y;
	r5.xy = abs(r2.yw) * r4.xz;
	r4.xy = abs(r2.yw) * r2.xz;
	r5.z = r4.x;
	r2.z = dot(r3.xyz, r5.xzw);
	r0.yzw = r2.zzz * idx_uniforms3_vs.cb3[5].xyz;
	r2.y = dot(r6.xyz, r5.xzw);
	...
	r3.x = dot(r3.yxz, r4.yzw);
	r0.yzw = r3.xxx * idx_uniforms3_vs.cb3[5].xyz;
	r3.z = dot(r6.yxz, r4.yzw);
	r3.y = dot(r1.yxz, r4.yzw);
	r0.yzw = fma(r3.zzz, idx_uniforms3_vs.cb3[4].xyz, r0.yzw);
	o3.v.xyz = fma(r3.yyy, idx_uniforms3_vs.cb3[6].xyz, r0.yzw);
	o3.v.w = uintBitsToFloat(uint(0x00000000));
	r0.yzw = r2.xyz * r3.xyz;
	r0.yzw = fma(r2.zxy, r3.yzx, -r0.yzw);

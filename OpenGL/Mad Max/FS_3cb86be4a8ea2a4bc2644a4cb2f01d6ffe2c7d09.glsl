#version 460 core
// ps_5_0
// Checksum: d4c52f04_36b1caa9_031b6545_a0ca501c
// Name: particleeffectsofterosionnsprjfarcullingvolume
...
void main()
{
	...
	r0.z = ((textureLod(resourceSamplerPair_5_ps, r2.xy, r0.z)).xywz).z;
	...
	r1.w = r1.w * r3.y;
	r1.w = r0.z * r1.w;
	r5.xyz = ((textureLod(resourceSamplerPair_7_ps, r2.xzw, idx_uniforms1_ps.cb1[10].x))).xyz;
	r2.xyz = ((textureLod(resourceSamplerPair_8_ps, r2.xzw, idx_uniforms1_ps.cb1[10].x))).xyz;

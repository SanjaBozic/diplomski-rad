#version 460 core
// vs_5_0
// Checksum: ca79b02e_e8cb647a_b9081093_a69b6f33
// Name: generalmm_d0_ed1_vertexanim
...
void main()
{
	...
	r1.xy = r0.yy * idx_uniforms3_vs.cb3[1].xy;
	r0.xy = fma(r0.xx, idx_uniforms3_vs.cb3[0].xy, r1.xy);

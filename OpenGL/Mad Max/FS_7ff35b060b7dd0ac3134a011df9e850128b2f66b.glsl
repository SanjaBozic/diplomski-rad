#version 460 core
// ps_5_0
// Checksum: fb5b0594_c63cf74f_d646756e_f0a97f68
// Name: deferred_sunlight_cs_clp
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r3.z = r0.w * r3.z;
		r4.xyw = r14.xyz + vec3(0.00999999978f, 0.00999999978f, 0.00999999978f);
		r3.w = dot(r4.xyw, r4.xyw);
		r3.w = inversesqrt(r3.w);
		r4.xyw = fma(r4.xyw, r3.www, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r4.xyw = fma(r19.yyy, r4.xyw, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		r6.xyz = r4.xyw * idx_uniforms0_ps.cb0[1].xyz;
		r6.xyz = r3.xxx * r6.xyz;
		r6.xyz = r16.www * r6.xyz;
		...
		if (floatBitsToUint(r3.z) != uint(0))
		{
			r0.w = r0.w * r16.w;
			r0.w = r0.z * r0.w;
			r8.xy = r17.zz + vec2(0.300000012f, 1.29999995f);
			...
			r8.z = -1.f * r8.x;
			r5.xy = r5.xx + r8.xz;
			r8.w = -r8.x + float(-1.00000000f);
			r5.xy = r5.xy / r8.yw;
			r3.zw = r3.zw * r3.zw;
			r3.zw = saturate(r5.xy * r3.zw);
			r3.zw = r3.zw * idx_uniforms1_ps.cb1[31].xy;
			r3.z = r3.w + r3.z;
			r7.xyz = r3.zzz * r13.xyz;
			r8.xyz = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[28].xyz);
			r0.y = dot(r8.xyz, r8.xyz);
			r0.y = inversesqrt(r0.y);
			r8.xyz = r0.yyy * r8.xyz;
			r9.xyz = r7.xyz * idx_uniforms0_ps.cb0[2].xyz;
			r7.xyz = r7.xyz * idx_uniforms0_ps.cb0[1].xyz;
			r7.xyz = r0.www * r7.xyz;
			r0.y = dot(r8.xyz, r15.xyz);
			r0.y = fma(r3.y, r0.y, -r3.y);
			r0.y = exp2(r0.y);
			r0.y = min(r0.y, float(1.00000000f));
			r3.yzw = r0.yyy * r7.xyz;
		}
		else
		{
		...
		r1.xyw = fma(r9.xyz, r0.yyy, r1.xyw);
		...
		r7.xz = fma(-r2.xx, idx_uniforms1_ps.cb1[38].xz, r0.yw);
		r5.y = r2.z;
		r2.xzw = ((textureLod(resourceSamplerPair_8_ps, r5.xyz, r5.w)).xwyz).xzw;
		r7.y = r5.y;
		r5.xyz = ((textureLod(resourceSamplerPair_9_ps, r7.xyz, r5.w))).xyz;
		r5.xyz = -r2.xzw + r5.xyz;
		r2.xzw = fma(idx_uniforms1_ps.cb1[0].www, r5.xyz, r2.xzw);
		...
		r0.yzw = fma(r6.xyz, r0.zzz, r3.yzw);

#version 460 core
// ps_5_0
// Checksum: ae7ebfc6_0f9962b8_d7d7b1fe_77b49685
// Name: fastter_noplxlod12cidx4cgc
...
void main()
{
	...
	r1.z = dot(r2, vec4(1.00000000f, 1.00000000f, 1.00000000f, 1.00000000f));
	r2 = r2 / r1.zzzz;
	r1.z = r2.y * idx_uniforms1_ps.cb1[7].w;
	r1.z = fma(idx_uniforms1_ps.cb1[6].w, r2.x, r1.z);
	r1.z = fma(idx_uniforms1_ps.cb1[8].w, r2.z, r1.z);
	r1.z = fma(idx_uniforms1_ps.cb1[9].w, r2.w, r1.z);
	...
	r0.xy = fma(r1.zz, r0.xy, r1.xy);
	r1.x = r2.x * idx_uniforms1_ps.cb1[6].z;
	r1.y = r2.y * idx_uniforms1_ps.cb1[7].z;
	r1.z = r2.z * idx_uniforms1_ps.cb1[8].z;
	r1.w = r2.w * idx_uniforms1_ps.cb1[9].z;
	...
	r4.xy = ((texture(resourceSamplerPair_4_ps, r3.xyz)).ywxz).xy;
	r4.xy = fma(r4.yx, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r3.x = ((texture(resourceSamplerPair_5_ps, r3.xyz)).wxyz).x;
	r5.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r5.z = idx_uniforms1_ps.cb1[7].y;
	r3.yz = ((texture(resourceSamplerPair_4_ps, r5.xyz)).xywz).yz;
	r3.yz = fma(r3.zy, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r3.yz = r1.yy * r3.yz;
	r1.xy = fma(r1.xx, r4.xy, r3.yz);
	r3.y = ((texture(resourceSamplerPair_5_ps, r5.xyz)).xwyz).y;
	r2.y = r2.y * r3.y;
	r2.x = fma(r2.x, r3.x, r2.y);
	r3.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r3.z = idx_uniforms1_ps.cb1[8].y;
	r4.xy = ((texture(resourceSamplerPair_4_ps, r3.xyz)).ywxz).xy;
	r4.xy = fma(r4.yx, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r1.xy = fma(r1.zz, r4.xy, r1.xy);
	r1.z = ((texture(resourceSamplerPair_5_ps, r3.xyz)).xywz).z;
	r1.z = fma(r2.z, r1.z, r2.x);
	r2.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r2.z = idx_uniforms1_ps.cb1[9].y;

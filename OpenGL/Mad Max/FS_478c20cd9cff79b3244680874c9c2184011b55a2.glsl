#version 460 core
// ps_5_0
// Checksum: 25ce6d48_0de137e6_4742fa3b_60f3f272
// Name: generalmmlod0fade_ddetail_osn_terraincolor_inst
...
void main()
{
	...
	r1.xyz = fma(v7.v.xyz, r0.xxx, r1.xyz);
	r0.xyz = fma(v9.v.xyz, r0.zzz, r1.xyz);

#version 460 core
// ps_5_0
// Checksum: 07a9cfad_6a3ed54b_15311b66_c6e3ebb9
// Name: deferred_sunlight_cs_clo_clfo
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r6.xyz = fma(r6.xyz, r4.www, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		...
		r4.x = r2.z + float(0.250000000f);
		r4.x = r4.x * float(0.800000012f);
		r2.z = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r4.x), floatBitsToUint(r2.z))));
		r4.xyw = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[18].xyz);
		r5.y = dot(r4.xyw, r4.xyw);
		r5.y = inversesqrt(r5.y);
		r4.xyw = r4.xyw * r5.yyy;
		r5.y = r2.z * idx_uniforms1_ps.cb1[17].x;
		r2.z = r0.w * r2.z;
		...
		r4.x = r2.x * r5.y;
		r2.x = r2.x * r2.z;
		r4.xyw = r4.xxx * idx_uniforms1_ps.cb1[16].xyz;
		r8.xyz = r2.xxx * idx_uniforms1_ps.cb1[16].xyz;
		...
		if (floatBitsToUint(r2.x) != uint(0))
		{
			...
			r2.xz = r2.yy + -r5.xy;
			r5.xy = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(lessThan(r2.xz, vec2(0.00000000f, 0.00000000f)))));
			...
			r5.xy = r5.xy / r9.yw;
			r2.xz = r2.xz * r2.xz;
			r2.xz = saturate(r5.xy * r2.xz);
			r2.xz = r2.xz * idx_uniforms1_ps.cb1[31].xy;
			r2.x = r2.z + r2.x;
			r9.xyz = r2.xxx * r13.xyz;
		...
		r4.xyw = fma(r4.xyw, r5.zzz, r10.xyz);
		r9.xyz = r0.yyy * r9.xyz;
		r5.xyz = fma(r8.xyz, r5.zzz, r9.xyz);
		r5.xyz = r6.xyz * r5.xyz;
		r1.xyw = fma(idx_uniforms0_ps.cb0[2].xyz, r1.xyw, r3.xyz);
		r1.xyw = r4.xyw + r1.xyw;
		r1.xyw = r14.xyz * r1.xyw;
		r0.y = r7.w + r7.w;
		r3.xyz = fma(r0.yyy, r15.xyz, -r19.xzw);
		r0.yw = r3.zz * idx_uniforms1_ps.cb1[33].yw;
		r8.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[33].xz, r0.yw);
		r0.yw = r3.zz * idx_uniforms1_ps.cb1[38].yw;
		r9.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[38].xz, r0.yw);
		r8.y = r3.y;
		r3.xyz = ((textureLod(resourceSamplerPair_8_ps, r8.xyz, r5.w))).xyz;
		r9.y = r8.y;
		r4.xyw = ((textureLod(resourceSamplerPair_9_ps, r9.xyz, r5.w)).xywz).xyw;
		...
		r0.yzw = fma(r7.xyz, r0.zzz, r5.xyz);

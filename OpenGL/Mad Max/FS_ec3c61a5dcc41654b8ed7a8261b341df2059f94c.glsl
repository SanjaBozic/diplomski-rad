#version 460 core
// ps_5_0
// Checksum: 34f353d6_4c6caf1b_e191c8b3_1f01a92b
// Name: generalmmlod0fade_ndetail_terraincolor_inst
...
void main()
{
	...
	r3.xyz = ((texture(resourceSamplerPair_2_ps, r3.xy)).xywz).xyz;
	r4.yw = uintBitsToFloat(uvec2(0xbf800000, 0xbf800000));
	r5.xyz = ((texture(resourceSamplerPair_3_ps, v2.v.xy)).xywz).xyz;

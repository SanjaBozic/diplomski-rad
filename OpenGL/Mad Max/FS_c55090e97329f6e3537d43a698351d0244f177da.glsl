#version 460 core
// ps_5_0
// Checksum: cdc1852f_54af1d17_c143447e_8ded2312
// Name: generalmmlod0_matte_osn_sand_inst
...
void main()
{
	...
	r2.y = ((texture(resourceSamplerPair_2_ps, r3.xy)).xwyz).y;
	if (floatBitsToUint(r1.w) != uint(0))
	{
		...
		r4.xyz = ((texture(resourceSamplerPair_3_ps, v10.v.xy))).xyz;

#version 460 core
// ps_5_0
// Checksum: bb1229af_22004655_6a0ecb06_fb823411
// Name: fogvolumeapplycaustics
...
void main()
{
	...
	r3.y = intBitsToFloat(min(floatBitsToInt(r3.y), int(25)));
	...
	while (true)
	{
		r5.w = intBitsToFloat(floatBitsToInt(r4.w) >= int(25) ? int(0xffffffff) : int(0x00000000));

#version 460 core
// ps_5_0
// Checksum: 876aaf4d_e4002533_15739f4c_35154ba0
// Name: comp_rh_ca_ef_fg_cf
...
uniform sampler3D resourceSamplerPair_5_ps; // res11, s11

uniform sampler3D resourceSamplerPair_6_ps; // res10, s10
...
void main()
{
	...
	r1.xyz = ((texture(resourceSamplerPair_5_ps, r0.xyz))).xyz;
	r0.xyz = ((texture(resourceSamplerPair_6_ps, r0.xyz))).xyz;
	...
	r0.w = ((texture(resourceSamplerPair_7_ps, r1.xy)).yzwx).w;

#version 460 core
// ps_5_0
// Checksum: 200be53e_5ebc338a_74a3f4f2_27d1fd40
// Name: generalmmlod0_ndetail_osn_sand_inst
...
void main()
{
	...
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r5 = (texture(resourceSamplerPair_4_ps, v10.v.xy));
		r4.w = uintBitsToFloat(uint(0x3f800000));
		r4.xyz = r4.xyz * r5.xyz;
		r5.x = ((texture(resourceSamplerPair_4_ps, v10.v.zw)).wxyz).x;

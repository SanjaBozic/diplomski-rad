#version 460 core
// ps_5_0
// Checksum: 5f3b1b95_42a49cd9_e0babcd8_1b21e550
// Name: generalmmlod0_osn_terraincolor_sand_inst
...
void main()
{
	...
	r2.w = ((texture(resourceSamplerPair_4_ps, r4.xy))).w;
	if (floatBitsToUint(r1.w) != uint(0))
	{
		...
		r5.xyz = ((texture(resourceSamplerPair_5_ps, v10.v.xy))).xyz;

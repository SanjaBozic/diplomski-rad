#version 460 core
// vs_5_0
// Checksum: a89ed0e4_f4ec7056_c2c4fee1_b209c289
// Name: particleeffectblendsofterosionns
...
void main()
{
	...
	r0.x = max(r0.x, float(9.99999997e-07f));
	r3.yzw = -v0.xyz + idx_uniforms1_vs.cb1[4].xyz;
	...
	r1.w = dot(-r3.yzw, idx_uniforms1_vs.cb1[6].xyz);
	...
	r3.yzw = -v0.xyz + idx_uniforms1_vs.cb1[10].xyz;
	...
	r3.yzw = r0.www * r3.yzw;
	r0.w = dot(r3.yzw, r2.xyz);
	r1.w = dot(-r3.yzw, idx_uniforms1_vs.cb1[12].xyz);
	...
	r3.yzw = -v0.xyz + idx_uniforms1_vs.cb1[13].xyz;
	r0.x = dot(r3.yzw, r3.yzw);
	r0.w = inversesqrt(r0.x);
	r0.x = sqrt(r0.x);
	...
	r3.yzw = r0.www * r3.yzw;
	r0.w = dot(r3.yzw, r2.xyz);
	r1.w = dot(-r3.yzw, idx_uniforms1_vs.cb1[15].xyz);
	r1.w = saturate(r1.w + idx_uniforms1_vs.cb1[15].w);
	r1.w = r1.w * r1.w;
	r0.w = max(r3.x, r0.w);
	r2.x = -r3.x + float(1.00000000f);

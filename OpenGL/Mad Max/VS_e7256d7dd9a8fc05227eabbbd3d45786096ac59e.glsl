#version 460 core
// vs_5_0
// Checksum: 3a907223_f952d005_88ed071e_1ebb5a91
// Name: charactersphdecal3uvs_fw
...
void main()
{
	...
	r2.z = saturate(fma(-r2.z, idx_uniforms2_vs.cb2[1].w, float(1.00000000f)));
	r1.w = r1.w + r2.z;
	r5.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[2].xyz);
	r2.z = dot(r5.xyz, r5.xyz);
	r2.z = saturate(fma(-r2.z, idx_uniforms2_vs.cb2[2].w, float(1.00000000f)));
	r1.w = r1.w + r2.z;
	r5.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[3].xyz);
	r2.z = dot(r5.xyz, r5.xyz);
	r2.z = saturate(fma(-r2.z, idx_uniforms2_vs.cb2[3].w, float(1.00000000f)));
	r1.w = r1.w + r2.z;
	r5.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[4].xyz);
	r2.z = dot(r5.xyz, r5.xyz);
	r2.z = saturate(fma(-r2.z, idx_uniforms2_vs.cb2[4].w, float(1.00000000f)));
	r1.w = r1.w + r2.z;
	r5.xyz = fma(-v0.xyz, idx_uniforms1_vs.cb1[0].xxx, idx_uniforms2_vs.cb2[5].xyz);
	r2.z = dot(r5.xyz, r5.xyz);
	r2.z = saturate(fma(-r2.z, idx_uniforms2_vs.cb2[5].w, float(1.00000000f)));
	r1.w = r1.w + r2.z;
	o2.v.w = min(r1.w, float(1.00000000f));
	r5 = fma(v5, vec4(6.28318548f, 6.28318548f, 6.28318548f, 6.28318548f), vec4(-3.14159274f, -3.14159274f, -3.14159274f, -3.14159274f));
	{ vec4 src = r5; r7 = sin(src); r8 = cos(src); }
	...
	r5.w = r8.y;
	r5.xy = abs(r7.yw) * r8.xz;
	r8.xy = abs(r7.yw) * r7.xz;
	r5.z = r8.x;
	r7.z = dot(r3.xyz, r5.xzw);
	r9.xyz = r7.zzz * idx_uniforms3_vs.cb3[5].xyz;
	r7.y = dot(r6.xyz, r5.xzw);
	r7.x = dot(r1.xyz, r5.xzw);
	r8.z = r5.y;
	r5.xyz = fma(r7.yyy, idx_uniforms3_vs.cb3[4].xyz, r9.xyz);
	o2.v.xyz = fma(r7.xxx, idx_uniforms3_vs.cb3[6].xyz, r5.xyz);
	r3.x = dot(r3.yxz, r8.yzw);
	r5.xyz = r3.xxx * idx_uniforms3_vs.cb3[5].xyz;
	r3.z = dot(r6.yxz, r8.yzw);
	r3.y = dot(r1.yxz, r8.yzw);
	r1.xyz = fma(r3.zzz, idx_uniforms3_vs.cb3[4].xyz, r5.xyz);
	...
	r0.xyz = fma(r7.zxy, r3.yzx, -r0.xyz);

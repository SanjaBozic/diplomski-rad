#version 460 core
// ps_5_0
// Checksum: 7606de28_063ffcd0_d1c6aa67_e6d1f304
// Name: particleeffectadditivesoftns
...
void main()
{
	...
	r1.w = r1.w * r3.y;
	r1.w = r0.x * r1.w;
	r3.yzw = ((textureLod(resourceSamplerPair_4_ps, r4.xyz, idx_uniforms1_ps.cb1[10].x)).wxyz).yzw;

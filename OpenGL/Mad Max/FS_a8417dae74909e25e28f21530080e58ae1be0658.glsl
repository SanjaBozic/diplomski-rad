#version 460 core
// ps_5_0
// Checksum: a83ddac6_116b2ac1_02245f74_6263b468
// Name: deferred_sunlight_mapexport

vec4 v0 = vec4(gl_FragCoord.xyz, 1.0 / gl_FragCoord.w);
layout(location = 1) in idx_Varying1 { vec4 v; } v1;
layout(location = 2) in idx_Varying2 { vec4 v; } v2;
layout(location = 0) out vec4 o0;
vec4 r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19;
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r17.xy = saturate(r4.zw + r4.zw);
		r2.z = uintBitsToFloat(uint(0x00000000));
		r17.z = uintBitsToFloat(uint(0x00000000));
		r17.xzw = saturate(uintBitsToFloat(movc(floatBitsToUint(r0.yyy), floatBitsToUint(r2.xzz), floatBitsToUint(r17.zxx))));
		r0.y = dot(-v2.v.xyz, -v2.v.xyz);
		r0.y = inversesqrt(r0.y);
		r18.xyz = r0.yyy * -v2.v.xyz;
		r2.xz = -r16.yz + vec2(1.00000000f, 0.500000000f);
		r0.y = r2.x * float(5.00000000f);
		r4.z = intBitsToFloat(r17.w == float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
		r2.z = saturate(r2.z + r2.z);
		r2.z = r2.z * r2.z;
		r2.z = r2.z * r2.z;
		r19.x = r2.z * float(0.800000012f);
		r19.y = min(r19.x, float(0.400000006f));
		r4.zw = uintBitsToFloat(floatBitsToUint(r4.zz) & floatBitsToUint(r19.xy));
		r2.z = fma(r17.y, float(4.00000000f), float(9.99999975e-05f));
		r5.w = dot(r18.xyz, r15.xyz);
		r6.w = saturate(r5.w);
		r4.xy = fma(r4.xy, vec2(10.0000000f, 10.0000000f), vec2(-5.00000000f, -5.00000000f));
		r4.x = max(abs(r4.y), abs(r4.x));
		r3.x = saturate(r3.x);
		r4.y = intBitsToFloat(float(0.00000000f) < r17.w ? int(0xffffffff) : int(0x00000000));
		if (floatBitsToUint(r4.y) != uint(0))
		{
			r7.w = fma(r17.w, float(0.300000012f), float(0.0500000007f));
		...
		r1.z = r4.w + r0.w;
		r1.w = r4.w + float(1.00000000f);
		r1.z = saturate(r1.z / r1.w);
		r1.w = r1.z + float(-1.00000000f);
		r1.w = fma(r4.z, r1.w, float(1.00000000f));
		r1.z = r1.w * r1.z;
		...
		r2.z = r17.z * float(2.50000000f);
		r2.w = saturate(fma(r17.x, float(0.500000000f), -r0.w));
		r1.w = fma(r2.w, r17.x, r1.w);
		r1.w = min(r1.w, float(1.00000000f));
		r5.xyz = fma(r16.www, idx_uniforms1_ps.cb1[35].xyz, idx_uniforms1_ps.cb1[36].xyz);
		r2.w = saturate(r5.y + idx_uniforms1_ps.cb1[35].w);
		r2.w = r2.w + -idx_uniforms1_ps.cb1[35].w;
		r3.w = -idx_uniforms1_ps.cb1[35].w + float(1.00000000f);
		r2.w = r2.w / r3.w;
		...
		r1.y = r0.z * r1.y;
		r3.w = r1.y * float(5.00000000f);
		r3.w = min(r3.w, float(1.00000000f));
		r6.xyz = fma(r3.www, vec3(0.100000001f, 0.790000021f, 0.939999998f), vec3(0.899999976f, 0.209999993f, 0.0599999987f));
		...
		r0.w = min(r2.z, float(1.00000000f));
		r7.xyz = r0.www * r7.xyz;
		r7.xyz = r1.xxx * r7.xyz;
		r6.xyz = fma(r6.xyz, r1.yyy, r7.xyz);
		r0.w = r0.z * r1.w;
		r0.w = r2.w * r0.w;
		r1.xyw = uintBitsToFloat(movc(floatBitsToUint(r4.yyy), floatBitsToUint(r6.xyz), floatBitsToUint(r0.www)));
		...
		r2.z = -r0.w + float(1.00000000f);
		r2.w = saturate(fma(r5.w, float(0.899999976f), float(0.100000001f)));
		...
		r4.xyz = r14.xyz + vec3(0.00999999978f, 0.00999999978f, 0.00999999978f);
		r2.z = dot(r4.xyz, r4.xyz);
		r2.z = inversesqrt(r2.z);
		r4.xyz = fma(r4.xyz, r2.zzz, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r4.xyz = fma(r17.yyy, r4.xyz, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		r3.xyz = r5.xxx * r3.xyz;
		r2.z = dot(idx_uniforms1_ps.cb1[31].xy, idx_uniforms1_ps.cb1[31].xy);
		r2.z = intBitsToFloat(r2.z != float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
		if (floatBitsToUint(r2.z) != uint(0))
		{
			r6.xy = r4.ww + vec2(0.300000012f, 1.29999995f);
			r5.y = r13.w * float(128.000000f);
			r5.x = fma(r13.w, float(128.000000f), idx_uniforms1_ps.cb1[28].w);
			r2.zw = r2.yy + -r5.xy;
			r5.xy = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(lessThan(r2.zw, vec2(0.00000000f, 0.00000000f)))));
			...
			r2.zw = -r2.zw + vec2(1.00000000f, 1.00000000f);
			...
			r2.zw = r2.zw * idx_uniforms1_ps.cb1[31].xy;
			r2.z = r2.w + r2.z;
			r6.xyz = r2.zzz * r13.xyz;
			r6.xyz = r6.xyz * idx_uniforms0_ps.cb0[2].xyz;
		}
		else
		{
			r6.xyz = uintBitsToFloat(uvec3(0x00000000, 0x00000000, 0x00000000));
		}
		r2.z = -r5.z + float(1.00000000f);
		r2.z = fma(r4.w, r2.z, r5.z);
		r1.xyw = fma(idx_uniforms0_ps.cb0[2].xyz, r1.xyw, r3.xyz);
		r1.xyw = fma(r6.xyz, r2.zzz, r1.xyw);
		r1.xyw = r14.xyz * r1.xyw;
		r2.z = r5.w + r5.w;
		r3.xyz = fma(r2.zzz, r15.xyz, -r18.xyz);
		r2.zw = r3.zz * idx_uniforms1_ps.cb1[33].yw;
		r5.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[33].xz, r2.zw);
		r2.zw = r3.zz * idx_uniforms1_ps.cb1[38].yw;
		r6.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[38].xz, r2.zw);
		r5.y = r3.y;
		r3.xyz = ((textureLod(resourceSamplerPair_7_ps, r5.xyz, r0.y))).xyz;
		r6.y = r5.y;
		r5.xyz = ((textureLod(resourceSamplerPair_8_ps, r6.xyz, r0.y))).xyz;
		...
		r0.y = r0.y + r0.y;
		r0.y = max(r17.w, r0.y);
		r2.z = r16.y * float(3.00000000f);
		r2.w = fma(-r17.w, float(8.00000000f), float(1.00000000f));
		r2.z = saturate(fma(r2.z, r2.w, float(-1.00000000f)));
		r4.xy = r0.yy + vec2(2.00000000f, 1.00000000f);
		r0.y = fma(r16.w, r4.x, -r4.y);
		r4.xy = fma(r16.wz, vec2(1.60000002f, 4.59999990f), vec2(0.200000003f, -1.29999995f));
		r2.z = max(r2.z, r17.y);
		r2.w = -r0.y + r4.x;
		r0.y = saturate(fma(r2.z, r2.w, r0.y));
		...
		r2.x = fma(r17.y, r2.x, r16.y);
		r0.z = r0.z * r1.z;
		r0.z = fma(r0.z, float(6.00000000f), r2.z);
		r0.zw = min(r0.zw, vec2(1.00000000f, 1.00000000f));
		r0.z = fma(idx_uniforms1_ps.cb1[31].z, r0.z, float(-1.00000000f));
		r0.z = r0.z * idx_uniforms1_ps.cb1[31].z;
		r0.z = fma(r2.x, r0.z, float(1.00000000f));
		r0.y = r0.y * r0.z;
		r0.y = r2.x * r0.y;
		r0.z = max(r4.y, float(0.0799999982f));
		r0.z = min(r0.z, float(1.00000000f));
		r0.z = min(r0.z, r0.w);
		r0.y = saturate(r0.y * r0.z);
		r0.z = -r0.y + float(1.00000000f);
		r0.w = -r17.y + float(1.00000000f);
		r0.z = r0.w * r0.z;
		r2.xzw = r0.yyy * r3.xyz;
		r0.yzw = fma(r1.xyw, r0.zzz, r2.xzw);
		...
		r1.x = dot(idx_uniforms1_ps.cb1[37].xyz, r18.xyz);

#version 460 core
// ps_5_0
// Checksum: eebe562d_5fee3732_c70840b4_8d6b2db5
// Name: deferred_sunlight_ind_clt_clp
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r2.x = r7.x * idx_uniforms1_ps.cb1[17].x;
		r6.w = r6.w * r7.x;
		r7.x = dot(r11.xyz, r0.yzw);
		r3.w = fma(r3.w, r7.x, -r3.w);
		r3.w = exp2(r3.w);

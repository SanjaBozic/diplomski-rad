#version 460 core
// cs_5_0
// Checksum: 4ae8c6b0_e33ed9ad_25b037b9_308fab47
// Name: fxaapass2vcs
...
void main()
{
	...
	r2.xy = uintBitsToFloat(floatBitsToUint(r0.xx) >> uvec2(0x00000008, 0x00000014));
	r2.xy = uintBitsToFloat(floatBitsToUint(r2.xy) & uvec2(0x00000fff, 0x00000fff));

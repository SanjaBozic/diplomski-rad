#version 460 core
// ps_5_0
// Checksum: 54baed0e_9cc8b4d9_38e07782_6c40f0dd
// Name: particleeffectadditivepixelshadowsofterosionnsprjfar
...
void main()
{
	...
	r5 = r5 * v10.v.wwww;
	r4 = r3.yyyy * r4;
	r4 = fma(r3.xxxx, r5, r4);
	r4 = fma(r3.zzzz, v8.v.xyzy, r4);
	r1.w = dot(r4.xzw, r4.xzw);
	r1.w = inversesqrt(r1.w);
	r4 = r1.wwww * r4;
	r1.w = dot(r1.xzy, r4.xzw);
	r1.w = r1.w + r1.w;
	r3.xyz = fma(r4.xwz, -r1.www, r1.xyz);
	r1.w = dot(r4.xwz, v9.v.xyz);
	r5.x = saturate(r1.w + v9.v.w);
	r5.y = saturate(dot(r3.xyz, v9.v.xyz));
	r5.zw = r3.ww * idx_uniforms1_ps.cb1[2].yx;
	r5.z = r2.w * r5.z;
	r5.y = log2(r5.y);
	r5.y = r5.y * r5.w;
	r5.y = exp2(r5.y);
	...
	r1.x = exp2(r1.x);
	r4.xyz = r5.xxx * v6.v.xyz;
	r1.xy = r0.ww * r1.xw;
	r0.xyz = fma(r0.xyz, v2.v.xyz, vec3(0.00999999978f, 0.00999999978f, 0.00999999978f));
	...
	r4.xyz = fma(r4.xyz, r0.www, r5.xyz);
	r5.xyz = ((textureLod(resourceSamplerPair_5_ps, r3.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;
	r3.xyz = ((textureLod(resourceSamplerPair_6_ps, r3.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;
	r3.xyz = -r5.xyz + r3.xyz;
	r3.xyz = fma(idx_uniforms1_ps.cb1[10].yyy, r3.xyz, r5.xyz);
	r3.xyz = r3.xyz * idx_uniforms1_ps.cb1[2].yyy;
	r3.xyz = r3.www * r3.xyz;
	r3.xyz = r3.xyz * idx_uniforms1_ps.cb1[3].www;
	r1.yzw = fma(r1.yyy, v6.v.xyz, r3.xyz);
	r1.yzw = fma(r2.xyz, r4.xyz, r1.yzw);
	r0.xyz = r0.xyz * r1.xxx;
	o0.xyz = fma(r0.xyz, v6.v.xyz, r1.yzw);
	r0.xy = v0.xy * idx_uniforms1_ps.cb1[2].zw;
	r0.x = ((texture(resourceSamplerPair_7_ps, r0.xy))).x;
	r0.x = v0.z / r0.x;

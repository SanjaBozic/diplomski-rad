#version 460 core
// ps_5_0
// Checksum: 2bd73a7a_f631311d_987eda83_78bec6b3
// Name: particleeffectadditiveerosionnsprjfarcullingvolume
...
void main()
{
	...
	r1.w = r1.w * r4.y;
	r1.w = r0.y * r1.w;
	r4.yzw = ((textureLod(resourceSamplerPair_6_ps, r3.xyz, idx_uniforms1_ps.cb1[10].x)).wxyz).yzw;
	r3.xyz = ((textureLod(resourceSamplerPair_7_ps, r3.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;

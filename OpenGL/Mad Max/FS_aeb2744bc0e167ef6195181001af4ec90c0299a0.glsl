#version 460 core
// ps_5_0
// Checksum: 0076f7fb_48faeef4_95c2baca_e9a86d90
// Name: generalmmlod0_sdndetail_terraincolor_sand_inst
...
void main()
{
	...
	r6 = (texture(resourceSamplerPair_5_ps, r4.xy));
	...
	r5.xyz = ((texture(resourceSamplerPair_6_ps, r4.xy)).xywz).xyz;
	r4.xyz = ((texture(resourceSamplerPair_7_ps, r4.xy)).xywz).xyz;
	...
	r2.y = ((texture(resourceSamplerPair_8_ps, r6.xy)).xwyz).y;

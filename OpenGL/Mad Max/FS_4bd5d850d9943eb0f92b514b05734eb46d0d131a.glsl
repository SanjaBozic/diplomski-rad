#version 460 core
// ps_5_0
// Checksum: 71c90fc2_93eb216b_46169e17_c72e6ebb
// Name: generalmmlod0_matte_osn_terraincolor_sand
...
void main()
{
	...
	r3.xy = fma(v7.v.zw, vec2(1.10000002f, 0.300000012f), r3.xy);
	...
	if (floatBitsToUint(r1.w) != uint(0))
	{
		...
		r4.xyz = ((texture(resourceSamplerPair_4_ps, v7.v.xy))).xyz;
		...
		r4 = (texture(resourceSamplerPair_3_ps, v7.v.xy));
		r5.x = uintBitsToFloat(uint(0x3f800000));
		r3.xyz = r3.xyz * r4.xyz;
		r4.x = ((texture(resourceSamplerPair_3_ps, v7.v.zw)).wxyz).x;

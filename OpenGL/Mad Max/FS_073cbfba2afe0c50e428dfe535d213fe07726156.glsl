#version 460 core
// ps_5_0
// Checksum: c9832925_d16cad3a_bfe7292e_60c9ac65
// Name: ssdecalextramasksandcolor
...
void main()
{
	...
	r2.xy = fma(r0.xy, idx_uniforms1_ps.cb1[14].zw, idx_uniforms1_ps.cb1[14].xy);
	...
	r0.w = r0.w * r2.y;
	r0.w = fma(r2.w, idx_uniforms1_ps.cb1[6].w, r0.w);
	r3 = (texture(resourceSamplerPair_3_ps, r0.xy)).wxyz;
	...
	o0.w = r3.x;
	r2.xyz = fma(r1.xyz, r2.xyz, -r1.xyz);
	o0.xyz = fma(idx_uniforms1_ps.cb1[6].www, r2.xyz, r1.xyz);
	r1.xyz = ((texture(resourceSamplerPair_4_ps, r0.xy))).xyz;
	r0.xy = ((texture(resourceSamplerPair_5_ps, r0.xy)).yzxw).xy;
	o2.yz = r0.xy;

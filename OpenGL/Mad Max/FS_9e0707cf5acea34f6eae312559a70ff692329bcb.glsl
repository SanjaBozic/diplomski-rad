#version 460 core
// ps_5_0
// Checksum: 9b52ebbe_7389aafa_0e959784_15b087e2
// Name: generalmmlod0_sdndetail_osn_terraincolor_sand_inst
...
uniform sampler2D resourceSamplerPair_7_ps; // res7, s7

uniform sampler2D resourceSamplerPair_8_ps; // res8, s8

uniform sampler2D resourceSamplerPair_9_ps; // res9, s9

uniform sampler2D resourceSamplerPair_10_ps; // res10, s10
...
void main()
{
	...
	r5 = (texture(resourceSamplerPair_5_ps, r3.xy));
	...
	r2.y = r2.y * r4.w;
	r4.xyz = ((texture(resourceSamplerPair_6_ps, r3.xy)).xywz).xyz;
	r3.xyz = ((texture(resourceSamplerPair_7_ps, r3.xy)).xywz).xyz;
	...
	r1.yzw = fma(v7.v.xyz, r1.yyy, r5.xyz);
	r1.xyz = fma(v9.v.xyz, r1.xxx, r1.yzw);
	...
	r3.y = ((texture(resourceSamplerPair_8_ps, r5.xy)).xwyz).y;
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r6.xyz = ((texture(resourceSamplerPair_9_ps, v10.v.xy))).xyz;
		...
		r5 = (texture(resourceSamplerPair_8_ps, v10.v.xy));
		r6.x = uintBitsToFloat(uint(0x3f800000));
		r4.xyz = r4.xyz * r5.xyz;
		r5.x = ((texture(resourceSamplerPair_8_ps, v10.v.zw)).wxyz).x;

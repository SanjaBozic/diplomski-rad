#version 460 core
// ps_5_0
// Checksum: 8969fc72_23e69d54_6ac73d4e_0bdc51f3
...
{
	Initialise();
	r0.xyz = ((texture(resourceSamplerPair_0_ps, v2.v.zw))).xyz;
	r1.xyz = ((texture(resourceSamplerPair_1_ps, v1.v.xy))).xyz;
	r1.xyz = r1.xyz * r1.xyz;
	r0.xyz = fma(r0.xyz, r0.xyz, -r1.xyz);
	r0.xyz = fma(idx_uniforms1_ps.cb1[0].xxx, r0.xyz, r1.xyz);
	...
	r1.xyz = ((texture(resourceSamplerPair_2_ps, r1.xz))).xyz;

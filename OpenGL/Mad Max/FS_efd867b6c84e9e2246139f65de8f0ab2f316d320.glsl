#version 460 core
// ps_5_0
// Checksum: 23817d7f_0c27dbdd_02e17f05_bccbabf2
// Name: particleeffectadditivesoftprjfarcullingvolume
...
void main()
{
	...
	r0.y = ((texture(resourceSamplerPair_3_ps, r1.xyz))).y;
	r0.z = ((texture(resourceSamplerPair_4_ps, r1.xyz)).xzyw).z;
	r0.y = -r0.z + r0.y;

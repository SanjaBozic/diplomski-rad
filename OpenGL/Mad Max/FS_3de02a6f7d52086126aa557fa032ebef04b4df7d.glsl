#version 460 core
// ps_5_0
// Checksum: 6bbf5cd0_ad653705_5aa3fd47_bd1f0281
// Name: generalmmlod0fade_ndetail_sand
...
void main()
{
	...
	r4.xyz = ((texture(resourceSamplerPair_3_ps, r4.xy)).xywz).xyz;
	...
	r2.z = ((texture(resourceSamplerPair_4_ps, r2.zw)).xywz).z;
	if (floatBitsToUint(r2.y) != uint(0))
	{
		r7.xyz = ((texture(resourceSamplerPair_5_ps, v7.v.xy))).xyz;
		...
		r4.w = ((texture(resourceSamplerPair_4_ps, v7.v.zw))).w;

#version 460 core
// vs_5_0
// Checksum: cf2adb08_c425bef9_f9357420_e33d273b
// Name: character83uvs
...
void main()
{
	...
	r1.xyz = fma(r3.zxy, r2.yzx, -r1.xyz);
	...
	r0.z = uintBitsToFloat(floatBitsToUint(r1.y) & floatBitsToUint(r1.x));
	r0.z = uintBitsToFloat(floatBitsToUint(r1.z) & floatBitsToUint(r0.z));
	r1.xyz = uintBitsToFloat(movc(floatBitsToUint(r0.zzz), uvec3(0x00000000, 0x3f800000, 0x00000000), floatBitsToUint(r2.xyz)));
	r2.xyz = r1.yyy * idx_uniforms3_vs.cb3[5].xyz;
	r1.xyw = fma(r1.xxx, idx_uniforms3_vs.cb3[4].xyz, r2.xyz);
	o4.v.xyz = fma(r1.zzz, idx_uniforms3_vs.cb3[6].xyz, r1.xyw);

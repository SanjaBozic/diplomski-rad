#version 460 core
// ps_5_0
// Checksum: e0f9234d_a5269bdf_197977aa_b34e246f
// Name: generalmmlod0fade_dndetail_sand_inst
...
void main()
{
	...
	r3.x = sqrt(r3.x);
	r3.yzw = ((texture(resourceSamplerPair_2_ps, v1.v.xy)).wxyz).yzw;
	...
	{
		r8.xyz = ((texture(resourceSamplerPair_6_ps, v10.v.xy))).xyz;

#version 460 core
// ps_5_0
// Checksum: ae40bc7b_94beff51_7f835f3f_c7c3c377
// Name: fastter_noplxlod0cidx4
...
void main()
{
	...
	r4.x = dot(r3, vec4(1.00000000f, 1.00000000f, 1.00000000f, 1.00000000f));
	r3 = r3 / r4.xxxx;
	r4.x = r3.y * idx_uniforms1_ps.cb1[7].w;
	r4.x = fma(idx_uniforms1_ps.cb1[6].w, r3.x, r4.x);
	r4.x = fma(idx_uniforms1_ps.cb1[8].w, r3.z, r4.x);
	r4.x = fma(idx_uniforms1_ps.cb1[9].w, r3.w, r4.x);

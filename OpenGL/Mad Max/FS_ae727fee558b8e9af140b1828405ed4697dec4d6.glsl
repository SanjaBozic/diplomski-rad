#version 460 core
// ps_5_0
// Checksum: df6b9015_5613092a_95fbb803_2293334a
// Name: fastter_noplxlod1cidx3cgc
...
void main()
{
	...
	r2.xy = r1.yy * idx_uniforms1_ps.cb1[6].wz;
	...
	r0.zw = ((texture(resourceSamplerPair_4_ps, r3.xyz)).xzyw).zw;
	...
	r4.xy = r2.yy * r4.xy;
	r0.zw = fma(r2.xx, r0.zw, r4.xy);
	r2.x = ((texture(resourceSamplerPair_5_ps, r3.xyz)).wxyz).x;
	r1.z = r1.z * r2.x;
	r1.y = fma(r1.y, r2.w, r1.z);
	r3.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	...
	r0.zw = fma(r2.zz, r2.xy, r0.zw);
	r1.z = ((texture(resourceSamplerPair_5_ps, r3.xyz)).xywz).z;
	r1.y = saturate(fma(r1.w, r1.z, r1.y));

#version 460 core
// ps_5_0
// Checksum: d6153aa5_d9ee0ca7_4576303a_f0d3adb0
// Name: generalmmlod0fade_dndetail_osn_terraincolor_sand_inst
...
void main()
{
	...
	r1.z = ((texture(resourceSamplerPair_6_ps, r7.xy)).xywz).z;
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r7 = (texture(resourceSamplerPair_6_ps, v10.v.xy));
		r3.w = uintBitsToFloat(uint(0x3f800000));
		r5.xyz = r5.xyz * r7.xyz;
		r5.w = ((texture(resourceSamplerPair_6_ps, v10.v.zw))).w;

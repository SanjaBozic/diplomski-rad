#version 460 core
// ps_5_0
// Checksum: 999101d0_3482ef53_38d3913d_3cc4de82
// Name: fastter_lod01cidx4
...
void main()
{
	...
	r4 = r4 / r2.zzzz;
	r2.z = r4.y * idx_uniforms1_ps.cb1[7].w;
	r2.z = fma(idx_uniforms1_ps.cb1[6].w, r4.x, r2.z);
	r2.z = fma(idx_uniforms1_ps.cb1[8].w, r4.z, r2.z);
	r2.z = fma(idx_uniforms1_ps.cb1[9].w, r4.w, r2.z);
	...
	r6.z = dot(r0.xy, r0.xy);
	r6.z = r6.z + float(1.00000000f);
	r7.y = inversesqrt(r6.z);
	r7.xz = r0.xy * r7.yy;
	...
	r6.z = max(-r0.y, float(0.500000000f));
	r6.w = -r0.w + float(1.00000000f);
	r6.w = fma(r6.w, float(3.00000000f), float(1.00000000f));
	r6.z = r6.w * r6.z;
	r6.z = float(8.00000000f) / r6.z;
	r6.z = max(r6.z, float(1.00000000f));
	r6.w = float(1.00000000f) / r6.z;
	r0.y = min(r0.y, float(-0.200000003f));
	r0.y = r0.y * r6.z;
	r9.xy = r10.xy / r0.yy;
	r10 = r4 + vec4(-0.400000006f, -0.400000006f, -0.400000006f, -0.400000006f);
	r10 = saturate(r10 * vec4(6.00000000f, 6.00000000f, 6.00000000f, 6.00000000f));
	r11 = intBitsToFloat(mix ( ivec4(0x00000000),ivec4(0xffffffff),bvec4(lessThan(vec4(0.400000006f, 0.400000006f, 0.400000006f, 0.400000006f), r4))));
	if (floatBitsToUint(r11.x) != uint(0))
	{
		r0.y = r10.x * idx_uniforms1_ps.cb1[6].x;
		r0.y = r0.y * float(0.0799999982f);
		r9.zw = r0.yy * r9.xy;
		r9.zw = r6.zz * r9.zw;
		r12.xy = fma(-r9.zw, vec2(0.500000000f, 0.500000000f), r1.xy);
		r13.z = idx_uniforms1_ps.cb1[6].y;
		r13.xy = r12.xy;
		...
		while (true)
		{
			r12.z = intBitsToFloat(r11.x < r6.z ? int(0xffffffff) : int(0x00000000));
			r12.w = intBitsToFloat(r8.w < r7.w ? int(0xffffffff) : int(0x00000000));
			r12.z = uintBitsToFloat(floatBitsToUint(r12.w) & floatBitsToUint(r12.z));
			if (floatBitsToUint(r12.z) == uint(0))
				break;
			r7.w = -r6.w + r7.w;
			r13.xy = fma(r9.xy, r0.yy, r13.xy);
			r12.z = ((textureLod(resourceSamplerPair_6_ps, r13.xyz, r0.z)).xywz).z;
		...
		r10.x = -r10.x + r0.y;
		r0.y = r0.y * r8.w;
		r0.y = fma(r7.w, r10.x, -r0.y);
		r7.w = -r8.w + r10.x;
		r0.y = r0.y / r7.w;
		r0.y = -r0.y + float(1.00000000f);
		r1.xy = fma(r0.yy, r9.zw, r12.xy);
	}
	if (floatBitsToUint(r11.y) != uint(0))
	{
		r0.y = r10.y * idx_uniforms1_ps.cb1[7].x;
		r0.y = r0.y * float(0.0799999982f);
		r9.zw = r0.yy * r9.xy;
		r9.zw = r6.zz * r9.zw;
		r10.xy = fma(-r9.zw, vec2(0.500000000f, 0.500000000f), r1.xy);
		r12.z = idx_uniforms1_ps.cb1[7].y;
		r12.xy = r10.xy;
		r7.w = uintBitsToFloat(uint(0x3f800000));
		r8.w = uintBitsToFloat(uint(0x00000000));
		...
		while (true)
		{
			r12.w = intBitsToFloat(r11.y < r6.z ? int(0xffffffff) : int(0x00000000));
			r13.x = intBitsToFloat(r8.w < r7.w ? int(0xffffffff) : int(0x00000000));
			r12.w = uintBitsToFloat(floatBitsToUint(r12.w) & floatBitsToUint(r13.x));
			if (floatBitsToUint(r12.w) == uint(0))
				break;
			r7.w = -r6.w + r7.w;
			r12.xy = fma(r9.xy, r0.yy, r12.xy);
			r12.w = ((textureLod(resourceSamplerPair_6_ps, r12.xyz, r0.z))).w;
		...
		r0.y = r0.y / r7.w;
		r0.y = -r0.y + float(1.00000000f);
		r1.xy = fma(r0.yy, r9.zw, r10.xy);
	}
	if (floatBitsToUint(r11.z) != uint(0))
	{
		r0.y = r10.z * idx_uniforms1_ps.cb1[8].x;
		r0.y = r0.y * float(0.0799999982f);
		r9.zw = r0.yy * r9.xy;
		r9.zw = r6.zz * r9.zw;
		r10.xy = fma(-r9.zw, vec2(0.500000000f, 0.500000000f), r1.xy);
		r11.z = idx_uniforms1_ps.cb1[8].y;
		r11.xy = r10.xy;
		r7.w = uintBitsToFloat(uint(0x3f800000));
		r8.w = uintBitsToFloat(uint(0x00000000));
		...
		while (true)
		{
			r12.y = intBitsToFloat(r12.x < r6.z ? int(0xffffffff) : int(0x00000000));
	...
	{
		r0.y = r10.w * idx_uniforms1_ps.cb1[9].x;
		r0.y = r0.y * float(0.0799999982f);
		r9.zw = r0.yy * r9.xy;
		r9.zw = r6.zz * r9.zw;
		r10.xy = fma(-r9.zw, vec2(0.500000000f, 0.500000000f), r1.xy);
		r11.z = idx_uniforms1_ps.cb1[9].y;
		r11.xy = r10.xy;
		r7.w = uintBitsToFloat(uint(0x3f800000));
		r8.w = uintBitsToFloat(uint(0x00000000));
		...
		while (true)
		{
			r11.w = intBitsToFloat(r10.w < r6.z ? int(0xffffffff) : int(0x00000000));
	...
	r11 = (texture(resourceSamplerPair_5_ps, r10.xyz));
	r9 = fma(r4.zzzz, r11, r9);
	r10.w = idx_uniforms1_ps.cb1[9].y;
	r1.zw = ((texture(resourceSamplerPair_4_ps, r10.xyw)).xzyw).zw;
	r1.zw = fma(r1.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r0.yz = fma(r2.ww, r1.zw, r0.yz);
	r2 = (texture(resourceSamplerPair_5_ps, r10.xyw));
	r2 = fma(r4.wwww, r2, r9);

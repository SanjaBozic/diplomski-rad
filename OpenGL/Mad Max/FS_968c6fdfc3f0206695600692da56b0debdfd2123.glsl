#version 460 core
// ps_5_0
// Checksum: fbe6b59f_b6f55a08_d26849cf_ec8f78dd
// Name: generalmmlod0fade_sdndetail_osn_sand
...
void main()
{
	...
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r7.xyz = ((texture(resourceSamplerPair_8_ps, v7.v.xy))).xyz;
		...
		r6 = (texture(resourceSamplerPair_7_ps, v7.v.xy));
		r4.w = uintBitsToFloat(uint(0x3f800000));
		r5.xyz = r5.xyz * r6.xyz;
		r5.w = ((texture(resourceSamplerPair_7_ps, v7.v.zw))).w;

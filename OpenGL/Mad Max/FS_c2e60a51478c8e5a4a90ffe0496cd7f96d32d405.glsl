#version 460 core
// ps_5_0
// Checksum: 5caf6071_1b788553_4993a9c1_1b3b7dd6
// Name: particleeffectadditivepixelshadowsoftnsprjfarcullingvolume
...
void main()
{
	...
	r5.xyz = ((textureLod(resourceSamplerPair_4_ps, r3.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;
	...
	r0.x = ((texture(resourceSamplerPair_6_ps, r0.xy))).x;
	r0.x = v0.z / r0.x;

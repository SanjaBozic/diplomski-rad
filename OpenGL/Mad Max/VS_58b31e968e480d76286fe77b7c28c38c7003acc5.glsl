#version 460 core
// vs_5_0
// Checksum: 65654c77_c5624655_4c8649d6_e75a84d7
...
layout (std140) uniform cb_vs1 { vec4 cb1[22]; } idx_uniforms1_vs;
...
void main()
{
	...
	o4.v.xyz = r0.xzw;
	r0.xyz = r1.yyy * idx_uniforms1_vs.cb1[19].xyz;
	r0.xyz = fma(r1.xxx, idx_uniforms1_vs.cb1[18].xyz, r0.xyz);
	r0.xyz = fma(r1.zzz, idx_uniforms1_vs.cb1[20].xyz, r0.xyz);
	r0.xyz = r0.xyz + idx_uniforms1_vs.cb1[21].xyz;
	o3.v.xyz = r0.xyz * vec3(-1.00000000f, 1.00000000f, 1.00000000f);
	...
	o5.v.xyz = fma(idx_uniforms1_vs.cb1[16].zzz, r0.xzw, r0.yyy);
	...
	o8.v.w = saturate(fma(-r0.w, float(2.00000000f), float(1.00000000f)));
	o7.v.xyz = r0.xyz * r1.xxx;
	r0.x = dot(-idx_uniforms0_vs.cb0[8].xyz, -idx_uniforms0_vs.cb0[8].xyz);
	r0.x = inversesqrt(r0.x);
	o8.v.xyz = r0.xxx * -idx_uniforms0_vs.cb0[8].xyz;
	r0 = v5 + vec4(-0.500000000f, -0.500000000f, -0.500000000f, -0.500000000f);
	r0 = r0 + r0;
	r1.x = dot(r0, r0);
	r1.x = inversesqrt(r1.x);
	o9.v = r0 * r1.xxxx;
	o10.v.xyz = uintBitsToFloat(uvec3(0x3f800000, 0x3f800000, 0x3f800000));
	VertexEpilog();
	return;
}

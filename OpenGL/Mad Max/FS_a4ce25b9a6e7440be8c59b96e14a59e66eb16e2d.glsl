#version 460 core
// ps_5_0
// Checksum: 889dc9ed_f5a7647d_752ae47c_faab7ac3
// Name: fastter_noplxlod1cidx2
...
void main()
{
	...
	r1.xz = r4.xy / r1.xx;
	r2.z = r1.x * idx_uniforms1_ps.cb1[6].z;
	r2.xw = r1.zz * idx_uniforms1_ps.cb1[7].wz;
	r1.w = fma(idx_uniforms1_ps.cb1[6].w, r1.x, r2.x);
	...
	r2 = (texture(resourceSamplerPair_6_ps, r2.xyz));
	r5.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r5.z = idx_uniforms1_ps.cb1[7].y;
	r4.zw = ((texture(resourceSamplerPair_5_ps, r5.xyz)).xzyw).zw;
	r4.zw = fma(r4.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r4.zw = r0.ww * r4.zw;
	r0.zw = fma(r0.zz, r4.xy, r4.zw);
	r4 = (texture(resourceSamplerPair_6_ps, r5.xyz));
	r4 = r1.zzzz * r4;
	r2 = fma(r1.xxxx, r2, r4);

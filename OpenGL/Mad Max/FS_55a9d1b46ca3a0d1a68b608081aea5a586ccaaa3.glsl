#version 460 core
// ps_5_0
// Checksum: 2c65cbca_ffe697a4_5657e02b_ec1f3c9e
// Name: characterhair_indoor_fade
...
void main()
{
	...
	r1.x = idx_uniforms1_ps.cb1[1].w * idx_uniforms1_ps.cb1[1].w;
	r1.x = r1.x * idx_uniforms1_ps.cb1[1].w;
	o0.w = r0.w * r1.x;

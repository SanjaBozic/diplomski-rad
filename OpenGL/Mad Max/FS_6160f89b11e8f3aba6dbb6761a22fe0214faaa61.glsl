#version 460 core
// ps_5_0
// Checksum: 4f602458_22e0e550_31ca2e62_9dc8b275
// Name: deferred_sunlight_ind_clo_clfo
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r8.w = intBitsToFloat(float(0.00000000f) < r2.x ? int(0xffffffff) : int(0x00000000));
		...
		r10.xyz = fma(-v2.v.xyz, r3.www, idx_uniforms1_ps.cb1[18].xyz);
		r3.w = dot(r10.xyz, r10.xyz);
		r3.w = inversesqrt(r3.w);
		r10.xyz = r3.www * r10.xyz;
		r3.w = r7.z * idx_uniforms1_ps.cb1[17].x;
		r7.z = r7.z * r7.w;
		r7.w = dot(r10.xyz, r0.yzw);
		r5.x = fma(r5.x, r7.w, -r5.x);
		r5.x = exp2(r5.x);
		r5.x = min(r5.x, float(1.00000000f));
		r5.x = r5.x * r7.z;
		r5.x = r5.x * idx_uniforms1_ps.cb1[17].y;
		r7.x = r7.x / idx_uniforms1_ps.cb1[19].w;
		r7.x = saturate(-r7.x + float(1.00000000f));
		r3.w = r3.w * r7.x;
		r5.x = r5.x * r7.x;

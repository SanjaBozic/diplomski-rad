#version 460 core
// ps_5_0
// Checksum: 3ef0e220_2835578e_0cb627a7_d9dfb93b
// Name: generalmmlod0_ndetail_osn_terraincolor_sand
...
void main()
{
	...
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r5 = (texture(resourceSamplerPair_5_ps, v7.v.xy));
		r4.w = uintBitsToFloat(uint(0x3f800000));
		r4.xyz = r4.xyz * r5.xyz;
		r5.x = ((texture(resourceSamplerPair_5_ps, v7.v.zw)).wxyz).x;

#version 460 core
// ps_5_0
// Checksum: 97160d83_c393f9b1_a1103413_5e31febc
// Name: generalmmlod0fade_dndetail_osn_terraincolor_inst
...
void main()
{
	...
	r1.xyz = ((texture(resourceSamplerPair_3_ps, r1.xy)).xywz).xyz;
	...
	r1.xzw = r0.yyy * v4.v.xyz;
	r2.xyz = ((texture(resourceSamplerPair_4_ps, v2.v.xy))).xyz;
	r2.xyz = fma(r2.zxy, vec3(2.00000000f, 2.00000000f, 2.00000000f), vec3(-1.00000000f, -1.00000000f, -1.00000000f));
	r3.xyz = r1.zwx * r2.xyz;
	r3.xyz = fma(r2.zxy, r1.wxz, -r3.xyz);
	r3.xyz = r3.xyz * v4.v.www;
	r3.xyz = r1.yyy * r3.xyz;
	r0.xyz = fma(r1.xzw, r0.xxx, r3.xyz);
	...
	r0.xyz = ((texture(resourceSamplerPair_5_ps, v1.v.xy))).xyz;
	o2.y = r0.w * r0.y;

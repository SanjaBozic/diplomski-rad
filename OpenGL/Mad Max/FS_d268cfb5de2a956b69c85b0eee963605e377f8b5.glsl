#version 460 core
// ps_5_0
// Checksum: 4e8155bd_0a5e541d_5573a0a6_b650975e
// Name: particleeffectsoftnsprjfarcullingvolume
...
void main()
{
	...
	r1.w = r0.z * r1.w;
	r2 = r1 * v2.v;
	r0.z = fma(r1.w, float(-0.200000003f), float(1.00000000f));
	...
	r0.xyw = fma(r1.xyz, r0.xxx, r2.xyz);
	r1.xyz = v4.v.xyz + -idx_uniforms0_ps.cb0[5].xyz;
	r2.xyz = r0.zzz * r1.xyz;
	r3.xyz = fma(r1.xyz, r0.zzz, idx_uniforms0_ps.cb0[5].xyz);
	...
	r3.x = saturate(dot(r2.xzw, v8.v.xyz));
	r3.x = log2(r3.x);
	r2.y = r2.y * r3.x;
	r2.y = exp2(r2.y);
	r1.w = r1.w * r2.y;
	r2.y = dot(r4.xwz, v8.v.xyz);
	r3.x = fma(r4.w, float(0.500000000f), float(0.500000000f));
	r3.y = saturate(r2.y);
	r2.y = saturate(r2.y + v8.v.w);
	r4.xyz = r2.yyy * v5.v.xyz;
	r1.w = r1.w * r3.y;
	r1.w = r0.z * r1.w;
	r5.xyz = ((textureLod(resourceSamplerPair_6_ps, r2.xzw, idx_uniforms1_ps.cb1[10].x))).xyz;
	r2.xyz = ((textureLod(resourceSamplerPair_7_ps, r2.xzw, idx_uniforms1_ps.cb1[10].x))).xyz;
	...
	r2.xyz = fma(r1.www, v5.v.xyz, r2.xyz);
	r3.yzw = -idx_uniforms1_ps.cb1[3].xyz + idx_uniforms1_ps.cb1[4].xyz;
	r3.xyz = fma(r3.xxx, r3.yzw, idx_uniforms1_ps.cb1[3].xyz);
	r3.xyz = fma(r3.xyz, idx_uniforms1_ps.cb1[4].www, v6.v.xyz);
	r3.xyz = fma(r4.xyz, r0.zzz, r3.xyz);
	r2.xyz = fma(r0.xyw, r3.xyz, r2.xyz);
	r0.xyw = r0.xyw + vec3(0.00999999978f, 0.00999999978f, 0.00999999978f);

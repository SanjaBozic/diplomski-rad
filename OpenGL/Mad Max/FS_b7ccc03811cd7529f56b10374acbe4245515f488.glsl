#version 460 core
// ps_5_0
// Checksum: f0fd0fb0_3f6b8bfc_7ae55762_b65e0e7b
// Name: deferred_sunlight_clt
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r7.xyz = fma(r7.xyz, r2.www, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r7.xyz = fma(r18.yyy, r7.xyz, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		...
		r2.z = r1.z * r2.z;
		r2.z = r0.w * r2.z;
		r2.w = dot(idx_uniforms1_ps.cb1[18].xyz, r15.xyz);
		r3.w = r2.w + float(0.250000000f);
		r3.w = r3.w * float(0.800000012f);
		r2.w = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r3.w), floatBitsToUint(r2.w))));
		r4.xyw = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[18].xyz);
		r3.w = dot(r4.xyw, r4.xyw);
		r3.w = inversesqrt(r3.w);
		r4.xyw = r3.www * r4.xyw;
		r3.w = r2.w * idx_uniforms1_ps.cb1[17].x;
		r2.w = r1.x * r2.w;
		r4.x = dot(r4.xyw, r15.xyz);
		r4.x = fma(r1.y, r4.x, -r1.y);
		r4.x = exp2(r4.x);
		r4.x = min(r4.x, float(1.00000000f));
		r2.w = r2.w * r4.x;
		r2.w = r2.w * idx_uniforms1_ps.cb1[17].y;
		r4.xyw = r1.www * idx_uniforms1_ps.cb1[25].xyz;
		r4.xyw = fma(idx_uniforms1_ps.cb1[16].xyz, r3.www, r4.xyw);
		r9.xyz = r2.zzz * idx_uniforms1_ps.cb1[26].xyz;
		r9.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r2.www, r9.xyz);
		...
		r1.xyw = fma(r9.xyz, r5.zzz, r1.xyw);
		r1.xyw = r7.xyz * r1.xyw;
		r3.xyz = fma(idx_uniforms0_ps.cb0[2].xyz, r6.xyz, r3.xyz);
		r3.xyz = r4.xyw + r3.xyz;
		r3.xyz = r14.xyz * r3.xyz;
		r0.y = r5.w + r5.w;
		r4.xyw = fma(r0.yyy, r15.xyz, -r19.xyz);
		r2.zw = r4.ww * idx_uniforms1_ps.cb1[33].yw;
		r5.xz = fma(-r4.xx, idx_uniforms1_ps.cb1[33].xz, r2.zw);
		r2.zw = r4.ww * idx_uniforms1_ps.cb1[38].yw;
		r6.xz = fma(-r4.xx, idx_uniforms1_ps.cb1[38].xz, r2.zw);
		r5.y = r4.y;
		r4.xyw = ((textureLod(resourceSamplerPair_7_ps, r5.xyz, r4.z)).xywz).xyw;
		r6.y = r5.y;
		r5.xyz = ((textureLod(resourceSamplerPair_8_ps, r6.xyz, r4.z))).xyz;
		r5.xyz = -r4.xyw + r5.xyz;
		r4.xyz = fma(idx_uniforms1_ps.cb1[0].www, r5.xyz, r4.xyw);
		r4.xyz = r7.xyz * r4.xyz;
		r4.xyz = r4.xyz * idx_uniforms1_ps.cb1[20].zzz;
		...
		r0.z = r0.z * r1.z;
		r2.xzw = r0.yyy * r4.xyz;
		r2.xzw = fma(r3.xyz, r0.zzz, r2.xzw);

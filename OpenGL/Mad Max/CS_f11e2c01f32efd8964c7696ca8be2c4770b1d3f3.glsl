#version 460 core
// cs_5_0
// Checksum: afa72b8a_9474493b_3cad39bb_b1645fa8
// Name: fxaapass2vdebugcs
...
void main()
{
	...
	r0.zw = uintBitsToFloat(floatBitsToUint(r0.xx) >> uvec2(0x00000008, 0x00000014));
	r2.xy = uintBitsToFloat(floatBitsToUint(r0.zw) & uvec2(0x00000fff, 0x00000fff));

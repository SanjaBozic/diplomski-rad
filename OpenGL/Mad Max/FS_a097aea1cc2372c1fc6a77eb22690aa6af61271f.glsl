#version 460 core
// ps_5_0
// Checksum: 85fd2e1a_4b3a9129_c20ea019_ea5500d0
// Name: fastter_noplxlod1cidx4
...
void main()
{
	...
	r1.x = dot(r2, vec4(1.00000000f, 1.00000000f, 1.00000000f, 1.00000000f));
	r2 = r2 / r1.xxxx;
	r1.x = r2.y * idx_uniforms1_ps.cb1[7].w;
	r1.x = fma(idx_uniforms1_ps.cb1[6].w, r2.x, r1.x);
	r1.x = fma(idx_uniforms1_ps.cb1[8].w, r2.z, r1.x);
	r1.x = fma(idx_uniforms1_ps.cb1[9].w, r2.w, r1.x);
	...
	r1.x = r1.x * float(1.50000000f);
	r0.xy = fma(r1.xx, r0.xy, r0.zw);
	r4.x = r2.x * idx_uniforms1_ps.cb1[6].z;
	r4.y = r2.y * idx_uniforms1_ps.cb1[7].z;
	r4.z = r2.z * idx_uniforms1_ps.cb1[8].z;
	r4.w = r2.w * idx_uniforms1_ps.cb1[9].z;
	...
	r0.zw = ((texture(resourceSamplerPair_5_ps, r5.xyz)).xzyw).zw;
	...
	r1.xz = ((texture(resourceSamplerPair_5_ps, r6.xyz)).yxwz).xz;
	r1.xz = fma(r1.zx, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r1.xz = r1.xz * r4.yy;
	r0.zw = fma(r4.xx, r0.zw, r1.xz);
	r6 = (texture(resourceSamplerPair_6_ps, r6.xyz));
	r6 = r2.yyyy * r6;
	r5 = fma(r2.xxxx, r5, r6);
	r6.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r6.z = idx_uniforms1_ps.cb1[8].y;
	r1.xz = ((texture(resourceSamplerPair_5_ps, r6.xyz)).yxwz).xz;
	r1.xz = fma(r1.zx, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r0.zw = fma(r4.zz, r1.xz, r0.zw);
	r6 = (texture(resourceSamplerPair_6_ps, r6.xyz));
	r5 = fma(r2.zzzz, r6, r5);
	r2.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r2.z = idx_uniforms1_ps.cb1[9].y;
	r1.xz = ((texture(resourceSamplerPair_5_ps, r2.xyz)).yxwz).xz;
	r1.xz = fma(r1.zx, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r0.zw = fma(r4.ww, r1.xz, r0.zw);
	r4 = (texture(resourceSamplerPair_6_ps, r2.xyz));
	r2 = fma(r2.wwww, r4, r5);

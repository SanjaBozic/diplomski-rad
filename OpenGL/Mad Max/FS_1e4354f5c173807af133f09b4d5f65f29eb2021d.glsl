#version 460 core
// ps_5_0
// Checksum: 51cb770c_200cdc20_0df06f53_5f88bfd8
// Name: deferred_sunlight_cs_clt_clfo
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r2.x = sqrt(r2.x);
		r2.z = dot(idx_uniforms1_ps.cb1[18].xyz, r15.xyz);
		r5.y = r2.z + float(0.250000000f);
		r5.y = r5.y * float(0.800000012f);
		r2.z = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r5.y), floatBitsToUint(r2.z))));
		r8.xyz = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[18].xyz);
		r4.y = dot(r8.xyz, r8.xyz);
		r4.y = inversesqrt(r4.y);
		r8.xyz = r4.yyy * r8.xyz;
		r4.y = r2.z * idx_uniforms1_ps.cb1[17].x;
		r2.z = r0.w * r2.z;
		r5.y = dot(r8.xyz, r15.xyz);
		r5.y = fma(r4.x, r5.y, -r4.x);
		r5.y = exp2(r5.y);
		r5.y = min(r5.y, float(1.00000000f));
		r2.z = r2.z * r5.y;
		r2.z = r2.z * idx_uniforms1_ps.cb1[17].y;
		r2.x = r2.x / idx_uniforms1_ps.cb1[19].w;
		r2.x = saturate(-r2.x + float(1.00000000f));
		r4.y = r2.x * r4.y;
		r2.x = r2.x * r2.z;
		r8.xyz = r3.www * idx_uniforms1_ps.cb1[25].xyz;
		r8.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r4.yyy, r8.xyz);
		r9.xyz = r4.www * idx_uniforms1_ps.cb1[26].xyz;
		r9.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r2.xxx, r9.xyz);

#version 460 core
// ps_5_0
// Checksum: c29e27f5_c1b48aeb_983f8b65_29d5431f
// Name: particleeffectadditiveerosionprjfarcullingvolume
...
uniform samplerCube resourceSamplerPair_3_ps; // res6, s6
...
void main()
{
	...
	r2.x = ((texture(resourceSamplerPair_3_ps, r1.xzw)).yxzw).x;
	r1.x = ((texture(resourceSamplerPair_4_ps, r1.xzw)).yxzw).x;
	r1.z = -r1.x + r2.x;

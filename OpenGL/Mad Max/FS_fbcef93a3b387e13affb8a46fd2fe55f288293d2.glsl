#version 460 core
// ps_5_0
// Checksum: f10738f7_1ab74873_2a4b8bd0_77732c03
// Name: generalmmlod0fade_ddetail_osn_sand_inst
...
void main()
{
	...
	if (floatBitsToUint(r4.y) != uint(0))
	{
		...
		r7 = (texture(resourceSamplerPair_4_ps, v10.v.xy));
		r5.z = uintBitsToFloat(uint(0x3f800000));
		r6.xyz = r6.xyz * r7.xyz;
		r5.w = ((texture(resourceSamplerPair_4_ps, v10.v.zw))).w;

#version 460 core
// vs_5_0
// Checksum: cf720066_4c03a4e1_600a7372_fa148c44
// Name: generalmm_d1_ed2_vertexanim
...
void main()
{
	...
	r1.xy = r0.ww * idx_uniforms3_vs.cb3[4].xy;
	r0.zw = fma(r0.zz, idx_uniforms3_vs.cb3[3].xy, r1.xy);

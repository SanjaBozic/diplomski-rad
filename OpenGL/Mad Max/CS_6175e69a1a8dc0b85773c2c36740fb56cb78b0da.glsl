#version 460 core
// cs_5_0
// Checksum: 31c60463_f9adcc71_be746745_72f32f8b
// Name: fxaapass2vdebugcs_highresx
...
void main()
{
	...
	r0.zw = uintBitsToFloat(floatBitsToUint(r0.xx) >> uvec2(0x00000008, 0x00000015));
	r2.xy = uintBitsToFloat(floatBitsToUint(r0.zw) & uvec2(0x00001fff, 0x000007ff));
	r0.x = intBitsToFloat(bfi(int(0), floatBitsToInt(r0.x), int(1), int(1)));
	r3.x = intBitsToFloat(floatBitsToInt(r0.x) + floatBitsToInt(r2.x));
	r2.zw = uintBitsToFloat(uvec2(0xffffffff, 0x00000000));
	r3.yz = uintBitsToFloat(uvec2(0x00000000, 0x00000000));
	r4.xy = intBitsToFloat(floatBitsToInt(r2.zy) + floatBitsToInt(r3.xy));

#version 460 core
// vs_5_0
// Checksum: 72b54136_371e619f_e6852e44_fe8999b0
// Name: particleeffectblendvertexshadowsofterosionns
...
void main()
{
	...
	r1.xzw = -v0.xyz + idx_uniforms1_vs.cb1[7].xyz;
	r0.y = dot(r1.xzw, r1.xzw);
	r0.z = sqrt(r0.y);
	r0.y = inversesqrt(r0.y);
	r1.xzw = r0.yyy * r1.xzw;
	...
	r0.w = dot(-r1.xzw, idx_uniforms1_vs.cb1[9].xyz);
	...
	r1.xzw = -v0.xyz + idx_uniforms1_vs.cb1[10].xyz;
	r2.w = dot(r1.xzw, r1.xzw);
	r3.y = inversesqrt(r2.w);
	r2.w = sqrt(r2.w);
	r2.w = r2.w + -idx_uniforms1_vs.cb1[11].w;
	r1.xzw = r1.xzw * r3.yyy;
	r3.y = dot(r1.xzw, r2.xyz);
	r1.x = dot(-r1.xzw, idx_uniforms1_vs.cb1[12].xyz);
	r1.x = saturate(r1.x + idx_uniforms1_vs.cb1[12].w);
	r1.x = r1.x * r1.x;
	r1.z = max(r3.x, r3.y);
	r1.z = saturate(r1.y * r1.z);
	r1.w = idx_uniforms1_vs.cb1[10].w + -idx_uniforms1_vs.cb1[11].w;
	r1.w = max(r1.w, float(9.99999997e-07f));
	...
	r1.xzw = -v0.xyz + idx_uniforms1_vs.cb1[13].xyz;
	r2.w = dot(r1.xzw, r1.xzw);
	r3.y = inversesqrt(r2.w);
	r2.w = sqrt(r2.w);

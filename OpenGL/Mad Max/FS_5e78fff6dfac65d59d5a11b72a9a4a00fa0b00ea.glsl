#version 460 core
// ps_5_0
// Checksum: 334f61e2_08e34f83_02fb0deb_64f7f6fd
// Name: deferred_sunlight_clo_clfo
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		else
		{
			...
			r2.xzw = uintBitsToFloat(uvec3(0x00000000, 0x00000000, 0x00000000));
		}
		...
		r2.xzw = r0.yyy * r2.xzw;
		r2.xzw = fma(r8.xyz, r5.zzz, r2.xzw);
		...
		r8.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[38].xz, r3.zw);
		r5.y = r3.y;
		r3.xyz = ((textureLod(resourceSamplerPair_7_ps, r5.xyz, r5.w))).xyz;
		r8.y = r5.y;
		r4.xyw = ((textureLod(resourceSamplerPair_8_ps, r8.xyz, r5.w)).xywz).xyw;
		...
		r1.xyz = fma(r1.xyw, r0.zzz, r3.xyz);
		r0.yzw = fma(r7.xyz, r0.www, r2.xzw);

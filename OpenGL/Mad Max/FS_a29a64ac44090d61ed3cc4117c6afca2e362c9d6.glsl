#version 460 core
// ps_5_0
// Checksum: 987ac97b_af74ffde_5e9457f0_83f2998d
// Name: deferred_sunlight_ind_clt_clfot
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r8.w = sqrt(r8.w);
		r9.w = dot(idx_uniforms1_ps.cb1[18].xyz, r0.yzw);
		r10.z = intBitsToFloat(float(0.00000000f) < r4.y ? int(0xffffffff) : int(0x00000000));
		r10.w = r9.w + float(0.250000000f);
		r10.w = r10.w * float(0.800000012f);
		r9.w = saturate(uintBitsToFloat(movc(floatBitsToUint(r10.z), floatBitsToUint(r10.w), floatBitsToUint(r9.w))));
		r11.xyz = fma(-v2.v.xyz, r2.xxx, idx_uniforms1_ps.cb1[18].xyz);
		r2.x = dot(r11.xyz, r11.xyz);
		r2.x = inversesqrt(r2.x);
		r11.xyz = r2.xxx * r11.xyz;
		r2.x = r9.w * idx_uniforms1_ps.cb1[17].x;
		r6.w = r6.w * r9.w;
		r9.w = dot(r11.xyz, r0.yzw);
		r3.w = fma(r3.w, r9.w, -r3.w);
		r3.w = exp2(r3.w);
		r3.zw = min(r3.zw, vec2(1.00000000f, 1.00000000f));
		r3.w = r3.w * r6.w;
		r3.w = r3.w * idx_uniforms1_ps.cb1[17].y;
		r6.w = r8.w / idx_uniforms1_ps.cb1[19].w;
		r6.w = saturate(-r6.w + float(1.00000000f));
		r2.x = r2.x * r6.w;
		r3.w = r3.w * r6.w;
		r11.xyz = -r7.xyz + idx_uniforms1_ps.cb1[27].xyz;
		r6.w = dot(r11.xyz, r11.xyz);
		r6.w = sqrt(r6.w);
		r6.w = r6.w / idx_uniforms1_ps.cb1[27].w;
		r6.w = saturate(-r6.w + float(1.00000000f));
		r3.z = r3.z * r6.w;
		r6.w = r6.w * r7.w;
		r7.xzw = r3.zzz * idx_uniforms1_ps.cb1[25].xyz;
		r7.xzw = fma(idx_uniforms1_ps.cb1[16].xyz, r2.xxx, r7.xzw);
		r11.xyz = r6.www * idx_uniforms1_ps.cb1[26].xyz;
		r11.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r3.www, r11.xyz);
		r7.xzw = r10.yyy * r7.xzw;
		r10.yzw = r10.yyy * r11.xyz;
		r7.xzw = fma(r9.xyz, r10.xxx, r7.xzw);
		...
		r11.y = r9.y;
		r7.xzw = ((textureLod(resourceSamplerPair_5_ps, r11.xyz, r4.z)).xwyz).xzw;
		...
		r0.yzw = fma(r10.yzw, r8.xyz, r0.yzw);

#version 460 core
// ps_5_0
// Checksum: 9c0cebf5_f52dfe75_6713a701_70036483
// Name: generalmmlod0fade_sdndetail_terraincolor_sand_inst
...
void main()
{
	...
	r5 = (texture(resourceSamplerPair_4_ps, r3.yz));
	r5.w = fma(idx_uniforms2_ps.cb2[3].x, r5.w, idx_uniforms2_ps.cb2[3].y);
	r6 = (texture(resourceSamplerPair_5_ps, r3.yz));
	...
	r5.xyz = ((texture(resourceSamplerPair_6_ps, r3.yz)).xywz).xyz;
	r3.yzw = ((texture(resourceSamplerPair_7_ps, r3.yz)).zxyw).yzw;
	...
	r2.z = ((texture(resourceSamplerPair_8_ps, r2.zw)).xywz).z;
	if (floatBitsToUint(r2.y) != uint(0))
	{
		r7.xyz = ((texture(resourceSamplerPair_9_ps, v10.v.xy))).xyz;

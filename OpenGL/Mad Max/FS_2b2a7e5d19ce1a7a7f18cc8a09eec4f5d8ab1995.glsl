#version 460 core
// ps_5_0
// Checksum: bc989031_0d79d9ca_4d1476f5_fc9b8060
// Name: ssdecalextramaskcutoffangle
...
void main()
{
	...
	r1.xy = fma(r0.yz, idx_uniforms1_ps.cb1[14].zw, idx_uniforms1_ps.cb1[14].xy);
	r0.yz = fma(r0.yz, idx_uniforms1_ps.cb1[7].xy, idx_uniforms1_ps.cb1[7].zw);
	r1 = (texture(resourceSamplerPair_2_ps, r1.xy));
	r2.x = -idx_uniforms1_ps.cb1[6].w + float(1.00000000f);
	r2.x = r1.y * r2.x;
	r1.w = fma(r1.w, idx_uniforms1_ps.cb1[6].w, r2.x);
	r2 = (texture(resourceSamplerPair_3_ps, r0.yz)).wxyz;
	r2.yzw = r2.yzw * idx_uniforms1_ps.cb1[9].xyz;
	r1.w = r1.w * r2.x;
	r2.x = saturate(idx_uniforms1_ps.cb1[4].w);
	r1.w = r1.w * r2.x;
	r0.w = r0.w * r1.w;
	...
	r1.xyz = ((texture(resourceSamplerPair_4_ps, r0.yz))).xyz;
	r0.xy = ((texture(resourceSamplerPair_5_ps, r0.yz)).yzxw).xy;
	o2.yz = r0.xy;

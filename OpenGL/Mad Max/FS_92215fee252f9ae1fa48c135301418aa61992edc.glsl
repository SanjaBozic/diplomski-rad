#version 460 core
// ps_5_0
// Checksum: f7dda955_278a16d9_70cbc65e_20024cf2
// Name: dirtroadcf
...
void main()
{
	...
	r1 = v2.v.xyxz * idx_uniforms1_ps.cb1[0].xzxz;
	r2.xyz = ((texture(resourceSamplerPair_1_ps, r1.xy))).xyz;
	r1.xyz = ((texture(resourceSamplerPair_1_ps, r1.zw))).xyz;
	...
	r0 = v2.v.xyxz * idx_uniforms1_ps.cb1[1].xzxz;
	r1 = (texture(resourceSamplerPair_2_ps, r0.xy));
	r0 = (texture(resourceSamplerPair_2_ps, r0.zw));
	r1 = -r0 + r1;

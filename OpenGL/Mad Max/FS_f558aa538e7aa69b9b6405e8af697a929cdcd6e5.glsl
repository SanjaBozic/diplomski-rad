#version 460 core
// ps_5_0
// Checksum: 87679ab3_2fa3fd49_f368e0f8_2cf0f80f
// Name: deferred_sunlight_cs_clt_clp_clft
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r6.w = r5.y + float(0.250000000f);
		r6.w = r6.w * float(0.800000012f);
		r4.y = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r6.w), floatBitsToUint(r5.y))));
		r8.xyz = fma(-v2.v.xyz, r0.yyy, r8.xyz);
		r5.y = dot(r8.xyz, r8.xyz);
		r5.y = inversesqrt(r5.y);
		r8.xyz = r5.yyy * r8.xyz;
		r5.y = r4.y * idx_uniforms1_ps.cb1[17].x;
		r4.y = r0.w * r4.y;
		r6.w = dot(r8.xyz, r15.xyz);
		r6.w = fma(r4.x, r6.w, -r4.x);
		r6.w = exp2(r6.w);
		...
		r8.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r5.yyy, r8.xyz);

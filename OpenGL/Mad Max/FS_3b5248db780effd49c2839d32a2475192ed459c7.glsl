#version 460 core
// ps_5_0
// Checksum: 895664a8_0de5a51a_0c24640e_4dc22f2e
// Name: ssdecalextramaskcutoffanglesandcolor
...
void main()
{
	...
	r2.xy = fma(r1.xy, idx_uniforms1_ps.cb1[14].zw, idx_uniforms1_ps.cb1[14].xy);
	r1.xy = fma(r1.xy, idx_uniforms1_ps.cb1[7].xy, idx_uniforms1_ps.cb1[7].zw);
	r2 = (texture(resourceSamplerPair_3_ps, r2.xy));
	r1.w = -idx_uniforms1_ps.cb1[6].w + float(1.00000000f);
	r1.w = r1.w * r2.y;
	r1.w = fma(r2.w, idx_uniforms1_ps.cb1[6].w, r1.w);
	r3 = (texture(resourceSamplerPair_4_ps, r1.xy)).wxyz;
	r3.yzw = r3.yzw * idx_uniforms1_ps.cb1[9].xyz;
	r0.yzw = r0.yzw * r3.yzw;
	r1.w = r1.w * r3.x;
	r2.w = saturate(idx_uniforms1_ps.cb1[4].w);
	r1.w = r1.w * r2.w;
	r1.z = r1.z * r1.w;
	r1.z = r1.z * idx_uniforms1_ps.cb1[9].w;
	r0.x = r0.x * r1.z;
	r3.xyz = saturate(r0.xxx * idx_uniforms1_ps.cb1[10].xyz);
	o0.w = r3.x;
	r2.xyz = fma(r0.yzw, r2.xyz, -r0.yzw);
	o0.xyz = fma(idx_uniforms1_ps.cb1[6].www, r2.xyz, r0.yzw);
	r0.xyz = ((texture(resourceSamplerPair_5_ps, r1.xy))).xyz;
	r1.xy = ((texture(resourceSamplerPair_6_ps, r1.xy)).yzxw).xy;
	o2.yz = r1.xy;

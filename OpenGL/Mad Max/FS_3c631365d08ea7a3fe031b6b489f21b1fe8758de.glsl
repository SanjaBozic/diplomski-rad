#version 460 core
// ps_5_0
// Checksum: 51caa567_d379de08_dd337f50_89f3aba0
// Name: generalmmlod0fade_sdndetail_terraincolor_sand
...
void main()
{
	...
	{
		r7.xyz = ((texture(resourceSamplerPair_9_ps, v7.v.xy))).xyz;
		...
		r5 = (texture(resourceSamplerPair_8_ps, v7.v.xy));
		r3.w = uintBitsToFloat(uint(0x3f800000));
		r3.xyz = r3.xyz * r5.xyz;
		r5.x = ((texture(resourceSamplerPair_8_ps, v7.v.zw)).wxyz).x;

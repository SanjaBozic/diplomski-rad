#version 460 core
// ps_5_0
// Checksum: fe142634_4f1931a2_ab9a1d26_2e392407
// Name: generalmmlod0fade_ndetail_osn_terraincolor_sand
...
void main()
{
	...
	r5.xyz = fma(idx_uniforms1_ps.cb1[2].xyz, r1.yyy, r5.xyz);
	r1.xyz = fma(idx_uniforms1_ps.cb1[4].xyz, r1.xxx, r5.xyz);
	...
	r1.z = ((texture(resourceSamplerPair_5_ps, r6.xy)).xywz).z;
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r7.xyz = ((texture(resourceSamplerPair_6_ps, v7.v.xy))).xyz;

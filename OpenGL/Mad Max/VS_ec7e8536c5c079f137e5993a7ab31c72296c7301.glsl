#version 460 core
// vs_5_0
// Checksum: 97969ca7_599dbd7c_bd5b3084_f7b94ab7
...
void main()
{
	...
	o4.v.xyz = fma(idx_uniforms1_vs.cb1[16].zzz, r0.xzw, r0.yyy);
	...
	o8.v = r0 * r1.xxxx;
	o9.v.xyz = uintBitsToFloat(uvec3(0x3f800000, 0x3f800000, 0x3f800000));
	VertexEpilog();
	return;
}

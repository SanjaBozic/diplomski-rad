#version 460 core
// cs_5_0
// Checksum: f7a61a51_29dd79ab_f3fcdbde_705073f0
// Name: fxaapass2vcs_highresy
...
void main()
{
	...
	r2.xy = uintBitsToFloat(floatBitsToUint(r0.xx) >> uvec2(0x00000008, 0x00000013));
	r2.xy = uintBitsToFloat(floatBitsToUint(r2.xy) & uvec2(0x000007ff, 0x00001fff));

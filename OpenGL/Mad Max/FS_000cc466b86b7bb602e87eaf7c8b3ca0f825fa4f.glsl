#version 460 core
// ps_5_0
// Checksum: 2faed6e0_cf53deab_aca81424_8778aaa0
// Name: generalmmlod0_ndetail_osn_sand
...
void main()
{
	...
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r5 = (texture(resourceSamplerPair_4_ps, v7.v.xy));
		r4.w = uintBitsToFloat(uint(0x3f800000));
		r4.xyz = r4.xyz * r5.xyz;
		r5.x = ((texture(resourceSamplerPair_4_ps, v7.v.zw)).wxyz).x;

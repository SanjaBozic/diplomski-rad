#version 460 core
// ps_5_0
// Checksum: f543e4b1_a9640382_cde0602e_93f4a1af
// Name: generalmmlod0fade_dndetail_osn_terraincolor_sand
...
void main()
{
	...
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r7 = (texture(resourceSamplerPair_6_ps, v7.v.xy));
		r3.w = uintBitsToFloat(uint(0x3f800000));
		r5.xyz = r5.xyz * r7.xyz;
		r5.w = ((texture(resourceSamplerPair_6_ps, v7.v.zw))).w;

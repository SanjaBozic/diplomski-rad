#version 460 core
// vs_5_0
// Checksum: 5b0ca6ff_8557f73c_5f5c501c_ab9d6a79
// Name: character83uvs_em
...
void main()
{
	...
	r0.xy = v5.xy * idx_uniforms1_vs.cb1[0].yz;
	o1.v.xy = r0.xy;
	r2 = fma(v7, vec4(6.28318548f, 6.28318548f, 6.28318548f, 6.28318548f), vec4(-3.14159274f, -3.14159274f, -3.14159274f, -3.14159274f));
	{ vec4 src = r2; r3 = sin(src); r5 = cos(src); }
	r0.z = intBitsToFloat(float(0.00000000f) < r2.w ? int(0xffffffff) : int(0x00000000));
	r0.z = uintBitsToFloat(movc(floatBitsToUint(r0.z), uint(0x3f800000), uint(0xbf800000)));
	r2.w = r5.y;
	...
	r0.w = intBitsToFloat(idx_uniforms1_vs.cb1[0].w == float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
	r1.xy = v6.xy * idx_uniforms1_vs.cb1[1].zw;
	r1.zw = uintBitsToFloat(movc(floatBitsToUint(r0.ww), floatBitsToUint(r0.xy), floatBitsToUint(r1.xy)));
	o3.v.w = r1.z;
	o4.v.w = r1.w;
	r4.xyz = r2.xyz * r3.xyz;
	r2.xyz = fma(r3.zxy, r2.yzx, -r4.xyz);
	...
	r0.z = uintBitsToFloat(floatBitsToUint(r2.y) & floatBitsToUint(r2.x));
	r0.z = uintBitsToFloat(floatBitsToUint(r2.z) & floatBitsToUint(r0.z));
	r2.xyz = uintBitsToFloat(movc(floatBitsToUint(r0.zzz), uvec3(0x00000000, 0x3f800000, 0x00000000), floatBitsToUint(r3.xyz)));
	r3.xyz = r2.yyy * idx_uniforms3_vs.cb3[5].xyz;
	r2.xyw = fma(r2.xxx, idx_uniforms3_vs.cb3[4].xyz, r3.xyz);
	o4.v.xyz = fma(r2.zzz, idx_uniforms3_vs.cb3[6].xyz, r2.xyw);
	o5.v.w = uintBitsToFloat(uint(0x00000000));
	r0.z = intBitsToFloat(idx_uniforms1_vs.cb1[2].z == float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
	r0.xy = uintBitsToFloat(movc(floatBitsToUint(r0.zz), floatBitsToUint(r0.xy), floatBitsToUint(r1.xy)));

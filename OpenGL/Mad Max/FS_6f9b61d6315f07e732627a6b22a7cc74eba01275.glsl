#version 460 core
// ps_5_0
// Checksum: 52d80338_531864bd_7aae28b0_0273dee5
// Name: deferred_sunlight_clp
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r5.w = r5.w * r5.w;
		r5.w = r5.w * r5.w;
		r21.x = r5.w * float(0.800000012f);
		r21.y = min(r21.x, float(0.400000006f));
		r17.xz = uintBitsToFloat(floatBitsToUint(r4.ww) & floatBitsToUint(r21.xy));
		...
		r3.w = saturate(fma(r5.w, float(0.899999976f), float(0.100000001f)));
		...
		r2.w = r2.z + float(8.00000000f);
		r2.w = r2.w * float(0.0398089178f);
		r2.z = fma(r2.z, float(1.44269502f), float(1.44269502f));
		r3.w = dot(r21.xyz, r15.xyz);
		r3.w = fma(r2.z, r3.w, -r2.z);
		r3.w = exp2(r3.w);
		r3.w = min(r3.w, float(1.00000000f));
		r3.w = r2.w * r3.w;
		...
		r4.xyw = fma(r4.xyw, r5.yyy, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r4.xyw = fma(r18.yyy, r4.xyw, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		...
		r3.w = dot(idx_uniforms1_ps.cb1[31].xy, idx_uniforms1_ps.cb1[31].xy);
		r3.w = intBitsToFloat(r3.w != float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
		if (floatBitsToUint(r3.w) != uint(0))
		{
			r2.w = r2.w * r16.w;
			r2.w = r0.w * r2.w;
			r7.xy = r17.zz + vec2(0.300000012f, 1.29999995f);
			r5.y = r13.w * float(128.000000f);
			r5.x = fma(r13.w, float(128.000000f), idx_uniforms1_ps.cb1[28].w);
			r5.xy = r2.yy + -r5.xy;
			r8.xy = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(lessThan(r5.xy, vec2(0.00000000f, 0.00000000f)))));
			r8.xy = uintBitsToFloat(movc(floatBitsToUint(r8.xy), floatBitsToUint(idx_uniforms1_ps.cb1[30].yy), floatBitsToUint(idx_uniforms1_ps.cb1[30].xx)));
			r5.xy = saturate(r5.xy * r8.xy);
			r5.xy = -r5.xy + vec2(1.00000000f, 1.00000000f);
			r3.w = dot(idx_uniforms1_ps.cb1[28].xyz, r15.xyz);
			r7.z = -1.f * r7.x;
			r8.xy = r3.ww + r7.xz;
			r7.w = -r7.x + float(-1.00000000f);
			r7.xy = r8.xy / r7.yw;
			r5.xy = r5.xy * r5.xy;
			r5.xy = saturate(r7.xy * r5.xy);
			r5.xy = r5.xy * idx_uniforms1_ps.cb1[31].xy;
			r3.w = r5.y + r5.x;
			r7.xyz = r3.www * r13.xyz;
		...
		r0.y = r5.w + r5.w;
		r3.xyz = fma(r0.yyy, r15.xyz, -r19.xyz);
		r2.zw = r3.zz * idx_uniforms1_ps.cb1[33].yw;
		r7.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[33].xz, r2.zw);
		r2.zw = r3.zz * idx_uniforms1_ps.cb1[38].yw;
		r8.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[38].xz, r2.zw);
		r7.y = r3.y;
		r3.xyz = ((textureLod(resourceSamplerPair_7_ps, r7.xyz, r4.z))).xyz;
		r8.y = r7.y;
		r7.xyz = ((textureLod(resourceSamplerPair_8_ps, r8.xyz, r4.z))).xyz;
		r7.xyz = -r3.xyz + r7.xyz;
		r3.xyz = fma(idx_uniforms1_ps.cb1[0].www, r7.xyz, r3.xyz);
		r3.xyz = r4.xyw * r3.xyz;
		r3.xyz = r3.xyz * idx_uniforms1_ps.cb1[20].zzz;
		r0.y = saturate(fma(-r16.z, float(2.00000000f), float(1.00000000f)));
		r0.y = r0.y + r0.y;
		r0.y = max(r18.w, r0.y);
		r2.z = fma(-r18.w, float(8.00000000f), float(1.00000000f));
		r2.x = saturate(fma(r2.x, r2.z, float(-1.00000000f)));
		r2.zw = r0.yy + vec2(2.00000000f, 1.00000000f);
		r0.y = fma(r16.w, r2.z, -r2.w);
		r2.x = max(r2.x, r18.y);
		r2.z = -r0.y + r20.y;
		r0.y = saturate(fma(r2.x, r2.z, r0.y));
		r2.x = dot(vec3(0.212500006f, 0.715399981f, 0.0720999986f), idx_uniforms0_ps.cb0[10].zzz);
		r2.x = r2.x * float(3.00000000f);
		r2.z = dot(vec3(0.212500006f, 0.715399981f, 0.0720999986f), idx_uniforms0_ps.cb0[2].xyz);
		r2.z = max(r2.z, float(0.100000001f));
		r2.x = r2.x / r2.z;
		r2.x = max(r2.x, float(0.100000001f));
		r2.x = min(r2.x, float(1.00000000f));
		r2.z = fma(r18.y, r17.y, r16.y);
		r0.z = r0.z * r1.z;
		r0.z = fma(r0.z, float(6.00000000f), r2.x);
		r0.z = min(r0.z, float(1.00000000f));
		r0.z = fma(idx_uniforms1_ps.cb1[31].z, r0.z, float(-1.00000000f));
		r0.z = r0.z * idx_uniforms1_ps.cb1[31].z;
		r0.z = fma(r2.z, r0.z, float(1.00000000f));
		r0.y = r0.y * r0.z;
		r0.y = r2.z * r0.y;
		...
		r1.z = -r18.y + float(1.00000000f);
		r0.z = r0.z * r1.z;
		r2.xzw = r0.yyy * r3.xyz;
		r1.xyz = fma(r1.xyw, r0.zzz, r2.xzw);
		r0.yzw = fma(r6.xyz, r0.www, r5.xyz);

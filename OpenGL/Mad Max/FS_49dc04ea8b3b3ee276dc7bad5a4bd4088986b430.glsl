#version 460 core
// ps_5_0
// Checksum: 1aa5a870_9e67859f_d4f1d0bf_a688bb46
// Name: particleeffectadditivensprjfarcullingvolume
...
void main()
{
	...
	r1.w = r1.w * r4.y;
	r1.w = r0.y * r1.w;
	r4.yzw = ((textureLod(resourceSamplerPair_5_ps, r3.xyz, idx_uniforms1_ps.cb1[10].x)).wxyz).yzw;

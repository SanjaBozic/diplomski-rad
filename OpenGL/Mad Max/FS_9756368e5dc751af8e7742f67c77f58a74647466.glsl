#version 460 core
// ps_5_0
// Checksum: 0e9e0529_e71b0f90_0469d54b_75698ff6
// Name: characterskinned_wmuv2_1bita_fade
...
void main()
{
	...
	r4.xyz = ((texture(resourceSamplerPair_2_ps, r3.xy)).xywz).xyz;
	r3 = (texture(resourceSamplerPair_3_ps, r3.xy));
	r2.xyz = fma(r4.xyz, vec3(2.00000000f, 2.00000000f, 2.00000000f), r2.xyz);
	r2.x = r2.z * r2.x;
	...
	r4 = r2.yzyz * idx_uniforms3_ps.cb3[0].xxww;
	r0.w = saturate(r2.x);
	r2.x = saturate(-1.f * r2.x);
	r2.yz = fma(r4.xy, r0.ww, r0.xy);
	r5 = v1.v.xyxy + vec4(0.333333343f, 0.00000000f, 0.666666687f, 0.00000000f);
	r4.xy = ((texture(resourceSamplerPair_4_ps, r5.xy))).xy;
	r5.xy = ((texture(resourceSamplerPair_4_ps, r5.zw))).xy;
	r5.xy = fma(r5.xy, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r4.xy = fma(r4.xy, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r5.zw = r4.xy * idx_uniforms3_ps.cb3[0].yy;
	r4.xy = r4.xy * idx_uniforms3_ps.cb3[1].xx;
	r2.yz = fma(r5.zw, r0.ww, r2.yz);
	r5.zw = r5.xy * idx_uniforms3_ps.cb3[0].zz;
	r5.xy = r5.xy * idx_uniforms3_ps.cb3[1].yy;
	r2.yz = fma(r5.zw, r0.ww, r2.yz);
	r2.yz = fma(r4.zw, r2.xx, r2.yz);
	r2.yz = fma(r4.xy, r2.xx, r2.yz);
	r0.xy = fma(r5.xy, r2.xx, r2.yz);
	...
	r0.xyw = fma(r4.xyz, r0.xxx, r2.xyz);
	...
	r3 = (texture(resourceSamplerPair_5_ps, r3.xy));
	...
	r0.xyz = ((texture(resourceSamplerPair_7_ps, v1.v.xy))).xyz;

#version 460 core
// ps_5_0
// Checksum: f3aded86_63610abc_d0a4858c_fd868612
// Name: particleeffectadditivenscullingvolume
...
void main()
{
	...
	r4.xyz = fma(r5.xyz, r1.www, r4.xyz);
	r0.xyz = fma(r0.xyz, r4.xyz, r3.xzw);
	o0.w = r0.w;
	...
	o0.xyz = fma(r1.xyz, v4.v.xyz, r0.xyz);
	PixelEpilog();
	return;
}

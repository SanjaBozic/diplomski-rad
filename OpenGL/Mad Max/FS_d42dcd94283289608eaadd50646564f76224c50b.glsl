#version 460 core
// ps_5_0
// Checksum: 064fee37_1a9e5bae_dba596bc_95dfb13b
// Name: particleeffectsofterosionnsprjfar
...
void main()
{
	...
	r1.x = r2.w;
	r1.w = ((texture(resourceSamplerPair_4_ps, r1.xy)).xzwy).w;
	r1.xyz = r2.xyz;
	r0.z = fma(r2.w, float(-0.200000003f), float(1.00000000f));
	r2 = r1 * v2.v;
	...
	r4 = r4 * v9.v.wwww;
	r5 = (texture(resourceSamplerPair_6_ps, v1.v.xy));
	...
	r1.w = inversesqrt(r1.w);
	r3 = r1.wwww * r3;
	r1.w = dot(r0.xwy, r3.xzw);
	r1.w = r1.w + r1.w;
	r4.xyz = fma(r3.xwz, -r1.www, r0.xyw);
	r0.xyw = fma(r3.xyz, vec3(-0.400000006f, -0.400000006f, -0.400000006f), r0.xyw);
	...
	r1.w = r1.w * r3.y;
	r1.w = r0.z * r1.w;
	r3.yzw = ((textureLod(resourceSamplerPair_7_ps, r4.xyz, idx_uniforms1_ps.cb1[10].x)).wxyz).yzw;
	r4.xyz = ((textureLod(resourceSamplerPair_8_ps, r4.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;
	...
	r2.xyz = fma(r5.xyz, r0.zzz, r2.xyz);

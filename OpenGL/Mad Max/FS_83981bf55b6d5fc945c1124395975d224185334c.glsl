#version 460 core
// ps_5_0
// Checksum: 27927b8b_3f76489a_8a91486b_24517d7d
// Name: particleeffectblendsofterosionnsprjfar
...
void main()
{
	...
	r2.x = r0.w;
	r2.y = v1.v.w;
	r0.w = ((texture(resourceSamplerPair_2_ps, r2.xy)).xzwy).w;
	r1.w = v3.v.w;
	r2 = r0 * r1;
	r0.xyz = fma(-r0.xyz, r1.xyz, idx_uniforms0_ps.cb0[13].xyz);
	r1.xy = v0.xy * idx_uniforms1_ps.cb1[2].zw;
	r0.w = ((texture(resourceSamplerPair_3_ps, r1.xy)).yzwx).w;
	r0.w = v0.z / r0.w;

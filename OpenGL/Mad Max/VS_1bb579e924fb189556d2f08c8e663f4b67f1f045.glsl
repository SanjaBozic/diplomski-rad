#version 460 core
// vs_5_0
// Checksum: ea17579c_1a9dc29e_2d492a1a_9d1a6974
// Name: charactersphdecal_fw
...
void main()
{
	...
	{ vec4 src = r2; r5 = sin(src); r7 = cos(src); }
	...
	r2.w = r7.y;
	r2.xy = abs(r5.yw) * r7.xz;
	r7.xy = abs(r5.yw) * r5.xz;
	r2.z = r7.x;
	r5.z = dot(r3.xyz, r2.xzw);
	r8.xyz = r5.zzz * idx_uniforms3_vs.cb3[5].xyz;
	r5.y = dot(r6.xyz, r2.xzw);
	r5.x = dot(r1.xyz, r2.xzw);
	r7.z = r2.y;
	r2.xyz = fma(r5.yyy, idx_uniforms3_vs.cb3[4].xyz, r8.xyz);
	o2.v.xyz = fma(r5.xxx, idx_uniforms3_vs.cb3[6].xyz, r2.xyz);
	r2.x = dot(r3.yxz, r7.yzw);
	r3.xyz = r2.xxx * idx_uniforms3_vs.cb3[5].xyz;
	r2.z = dot(r6.yxz, r7.yzw);
	r2.y = dot(r1.yxz, r7.yzw);

#version 460 core
// ps_5_0
// Checksum: 0c109796_533032ce_6a075cb2_6ded66d4
// Name: particleeffectpixelshadowsoftnsprjfarcullingvolume
...
void main()
{
	...
	r5.xyz = ((textureLod(resourceSamplerPair_4_ps, r2.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;
	r2.xyz = ((textureLod(resourceSamplerPair_5_ps, r2.xyz, idx_uniforms1_ps.cb1[10].x))).xyz;

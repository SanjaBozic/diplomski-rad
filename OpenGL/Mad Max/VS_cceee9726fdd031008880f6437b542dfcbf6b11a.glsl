#version 460 core
// vs_5_0
// Checksum: 0617f6fc_501cd037_5dc12337_d73479a3
// Name: generalmm_d0_ed0_wireaa
...
void main()
{
	...
	r0.yz = v1.xy * idx_uniforms2_vs.cb2[1].xy;
	r0.zw = r0.zz * idx_uniforms3_vs.cb3[1].xy;
	r0.yz = fma(r0.yy, idx_uniforms3_vs.cb3[0].xy, r0.zw);
	r0.yz = r0.yz + idx_uniforms3_vs.cb3[2].xy;
	o1.v.xy = r0.yz;
	o2.v.xy = r0.yz;
	...
	r0.yzw = abs(v2.yyy) * vec3(1.00000000f, 0.00390625000f, 1.52587891e-05f);
	r0.yzw = fract(r0.yzw);
	...
	r0.y = intBitsToFloat(float(0.00000000f) < v2.y ? int(0xffffffff) : int(0x00000000));
	r0.z = intBitsToFloat(v2.y < float(0.00000000f) ? int(0xffffffff) : int(0x00000000));

#version 460 core
// ps_5_0
// Checksum: 4bcae4af_c85eaf01_ad77a68d_a28746f1
// Name: ghostproject
...
void main()
{
	...
	r0.xzw = fma(r0.xzw, r0.yyy, r0.xzw);
	...
	r1.x = r1.x * r1.y;
	r1.x = log2(abs(r1.x));
	r1.x = r1.x * idx_uniforms1_ps.cb1[0].y;
	r1.x = exp2(r1.x);
	o0.w = saturate(fma(r1.x, idx_uniforms1_ps.cb1[0].w, r0.y));
	...
	r2.xyz = r0.yyy * idx_uniforms0_ps.cb0[13].xyz;
	o0.xyz = fma(r0.xzw, r1.yzw, r2.xyz);
	return;
}

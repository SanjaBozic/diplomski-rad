#version 460 core
// ps_5_0
// Checksum: 6f541434_8840b67c_28869a8b_61dd2bd7
// Name: deferred_sunlight_debug_cloudshadow
...
uniform sampler2D resourceSamplerPair_7_ps; // res5, s4

uniform samplerCube resourceSamplerPair_8_ps; // res6, s3

uniform samplerCube resourceSamplerPair_9_ps; // res7, s3
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r21.xyz = uintBitsToFloat(floatBitsToUint(r6.www) & floatBitsToUint(r21.yzw));
		...
		r3.xyz = r2.xyz + -idx_uniforms0_ps.cb0[5].xyz;
		r0.w = dot(r3.xyz, r3.xyz);
		r0.w = sqrt(r0.w);
		r0.w = r0.w * idx_uniforms1_ps.cb1[36].w;
		r1.zw = r2.xz + idx_uniforms1_ps.cb1[15].yz;
		r3.x = r2.y * idx_uniforms0_ps.cb0[1].w;
		r3.y = r2.y * idx_uniforms0_ps.cb0[3].w;
		r1.zw = r1.zw + -r3.xy;
		r1.zw = r1.zw * idx_uniforms1_ps.cb1[15].ww;
		r0.w = ((textureLod(resourceSamplerPair_7_ps, r1.zw, r0.w)).yzwx).w;
		r0.w = saturate(r0.w + idx_uniforms1_ps.cb1[15].x);
		r1.z = r0.w * r0.z;
		r1.w = saturate(fma(r15.y, float(0.500000000f), float(0.500000000f)));
		r2.xzw = idx_uniforms0_ps.cb0[10].xyz + -idx_uniforms0_ps.cb0[11].xyz;
		r2.xzw = fma(r1.www, r2.xzw, idx_uniforms0_ps.cb0[11].xyz);
		r1.w = dot(r15.xyz, -idx_uniforms0_ps.cb0[3].xyz);
		r3.x = r21.z + r1.w;
		r3.y = r21.z + float(1.00000000f);
		r3.x = saturate(r3.x / r3.y);
		r3.y = r3.x + float(-1.00000000f);
		r3.y = fma(r21.y, r3.y, float(1.00000000f));
		r3.x = r3.y * r3.x;
		r3.y = fma(r3.x, r8.w, float(9.99999975e-05f));
		r3.y = log2(r3.y);
		r3.y = r3.y * r6.w;
		r3.y = exp2(r3.y);
		r3.y = r3.x * r3.y;
		r3.y = min(r3.y, float(1.00000000f));
		r3.z = r18.y * float(2.50000000f);
		r3.w = saturate(fma(r18.x, float(0.500000000f), -r1.w));
		r3.y = fma(r3.w, r18.x, r3.y);
		r3.y = min(r3.y, float(1.00000000f));
		...
		r1.w = r0.z * r1.w;
		r7.xyz = r1.www * vec3(0.200000003f, 0.0460000001f, 0.00999999978f);
		r1.w = min(r3.z, float(1.00000000f));
		r7.xyz = r1.www * r7.xyz;
		r7.xyz = r1.xxx * r7.xyz;
		r1.xyw = fma(r6.xyz, r1.yyy, r7.xyz);
		r1.xyw = r0.www * r1.xyw;
		r0.w = r1.z * r3.y;
		r0.w = r3.w * r0.w;
		r1.xyw = uintBitsToFloat(movc(floatBitsToUint(r4.yyy), floatBitsToUint(r1.xyw), floatBitsToUint(r0.www)));
		r6.xyz = r1.xyw * idx_uniforms0_ps.cb0[2].xyz;
		r7.xyz = r2.xzw * idx_uniforms1_ps.cb1[0].zzz;
		...
		r3.w = saturate(fma(r7.w, float(0.899999976f), float(0.100000001f)));
		r3.w = -r3.w + float(1.00100005f);
		r3.w = min(r3.w, float(1.00000000f));
		r4.x = r3.w * r3.w;
		r4.x = r4.x * r4.x;
		r3.w = r3.w * r4.x;
		r0.w = fma(r3.z, r3.w, r0.w);
		r0.w = min(r0.w, float(1.00000000f));
		r3.z = r4.w + float(8.00000000f);
		r3.z = r3.z * float(0.0398089178f);
		r3.w = fma(r4.w, float(1.44269502f), float(1.44269502f));
		r4.x = dot(r22.xyz, r15.xyz);
		r4.x = fma(r3.w, r4.x, -r3.w);
		r4.x = exp2(r4.x);
		r4.x = min(r4.x, float(1.00000000f));
		r4.x = r3.z * r4.x;
		...
		r8.xyz = fma(r8.xyz, r4.yyy, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r8.xyz = fma(r19.yyy, r8.xyz, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		...
		r4.y = dot(idx_uniforms1_ps.cb1[31].xy, idx_uniforms1_ps.cb1[31].xy);
		r4.y = intBitsToFloat(r4.y != float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
		if (floatBitsToUint(r4.y) != uint(0))
		{
			r3.z = r3.z * r16.w;
			r3.z = r0.w * r3.z;
			...
			r4.yw = r2.yy + -r5.xy;
			r5.xy = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(lessThan(r4.yw, vec2(0.00000000f, 0.00000000f)))));
			r5.xy = uintBitsToFloat(movc(floatBitsToUint(r5.xy), floatBitsToUint(idx_uniforms1_ps.cb1[30].yy), floatBitsToUint(idx_uniforms1_ps.cb1[30].xx)));
			r4.yw = saturate(r4.yw * r5.xy);
			r4.yw = -r4.yw + vec2(1.00000000f, 1.00000000f);
			r5.x = dot(idx_uniforms1_ps.cb1[28].xyz, r15.xyz);
			r10.z = -1.f * r10.x;
			r5.xy = r5.xx + r10.xz;
			r10.w = -r10.x + float(-1.00000000f);
			r5.xy = r5.xy / r10.yw;
			r4.yw = r4.yw * r4.yw;
			r4.yw = saturate(r5.xy * r4.yw);
			r4.yw = r4.yw * idx_uniforms1_ps.cb1[31].xy;
			r4.y = r4.w + r4.y;
			r10.xyz = r4.yyy * r13.xyz;
		...
		r1.xyw = fma(idx_uniforms0_ps.cb0[2].xyz, r1.xyw, r7.xyz);
		r1.xyw = fma(r12.xyz, r0.yyy, r1.xyw);
		r1.xyw = r14.xyz * r1.xyw;
		r0.y = r7.w + r7.w;
		r10.xyz = fma(r0.yyy, r15.xyz, -r19.xzw);
		r3.zw = r10.zz * idx_uniforms1_ps.cb1[33].yw;
		r11.xz = fma(-r10.xx, idx_uniforms1_ps.cb1[33].xz, r3.zw);
		r3.zw = r10.zz * idx_uniforms1_ps.cb1[38].yw;
		r13.xz = fma(-r10.xx, idx_uniforms1_ps.cb1[38].xz, r3.zw);
		r11.y = r10.y;
		r10.xyz = ((textureLod(resourceSamplerPair_8_ps, r11.xyz, r5.w))).xyz;
		r13.y = r11.y;
		r11.xyz = ((textureLod(resourceSamplerPair_9_ps, r13.xyz, r5.w))).xyz;
		...
		r0.y = r0.y + r0.y;
		r0.y = max(r18.z, r0.y);
		r3.z = fma(-r18.z, float(8.00000000f), float(1.00000000f));
		r3.z = saturate(fma(r4.z, r3.z, float(-1.00000000f)));
		r4.yz = r0.yy + vec2(2.00000000f, 1.00000000f);
		r0.y = fma(r16.w, r4.y, -r4.z);
		r3.z = max(r3.z, r19.y);
		r3.w = -r0.y + r20.y;
		r0.y = saturate(fma(r3.z, r3.w, r0.y));
		r3.z = dot(vec3(0.212500006f, 0.715399981f, 0.0720999986f), idx_uniforms0_ps.cb0[10].zzz);
		r3.z = r3.z * float(3.00000000f);
		r3.w = dot(vec3(0.212500006f, 0.715399981f, 0.0720999986f), idx_uniforms0_ps.cb0[2].xyz);
		r3.w = max(r3.w, float(0.100000001f));
		r3.z = r3.z / r3.w;
		r3.z = max(r3.z, float(0.100000001f));
		r3.z = min(r3.z, float(1.00000000f));
		r3.w = fma(r19.y, r17.y, r16.y);
		r4.y = r1.z * r3.x;
		r3.z = fma(r4.y, float(6.00000000f), r3.z);
		r3.z = min(r3.z, float(1.00000000f));
		r3.z = fma(idx_uniforms1_ps.cb1[31].z, r3.z, float(-1.00000000f));
		r3.z = r3.z * idx_uniforms1_ps.cb1[31].z;
		r3.z = fma(r3.w, r3.z, float(1.00000000f));
		r0.y = r0.y * r3.z;
		r0.y = r3.w * r0.y;
		r3.z = max(r20.z, float(0.0799999982f));
		r3.z = min(r3.z, float(1.00000000f));
		r3.z = min(r0.w, r3.z);
		r0.y = saturate(r0.y * r3.z);
		r3.z = -r0.y + float(1.00000000f);
		r3.w = -r19.y + float(1.00000000f);
		r3.z = r3.w * r3.z;
		r4.yzw = r0.yyy * r11.xyz;
		r1.xyw = fma(r1.xyw, r3.zzz, r4.yzw);
		r5.xyz = fma(r5.xyz, r8.xyz, r9.xyz);
		r1.xyw = r1.xyw + r5.xyz;
		r3.z = saturate(r0.x * idx_uniforms0_ps.cb0[16].w);
		r2.y = fma(r2.y, idx_uniforms0_ps.cb0[16].z, -idx_uniforms0_ps.cb0[16].x);
		r2.y = min(r2.y, idx_uniforms0_ps.cb0[16].y);
		r2.y = -r2.y + float(1.00000000f);
		r2.y = fma(r3.z, r2.y, -idx_uniforms0_ps.cb0[14].w);
		r0.x = fma(r0.x, idx_uniforms0_ps.cb0[15].w, r2.y);
		r2.y = dot(idx_uniforms1_ps.cb1[37].xyz, r19.xzw);
		r2.y = r2.y + float(0.500000000f);
		...
		r3.z = r2.y * r2.y;
		r2.y = r2.y * r3.z;
		r11.xyz = fma(r2.yyy, idx_uniforms0_ps.cb0[14].xyz, idx_uniforms0_ps.cb0[15].xyz);
		r11.xyz = r0.xxx * r11.xyz;
		r1.xyw = fma(r1.xyw, r5.yzw, r11.xyz);
		{ float src = idx_uniforms1_ps.cb1[13].x; r0.x = sin(src); r5.x = cos(src); }
		r3.zw = vec2(0.500000000f, 0.500000000f) / idx_uniforms0_ps.cb0[8].zw;
		r3.zw = -r3.zw + v0.xy;
		r5.y = r0.x;
		r0.x = dot(r3.zw, r5.xy);
		...
		{
			r5 = intBitsToFloat(mix ( ivec4(0x00000000),ivec4(0xffffffff),bvec4(equal(idx_uniforms1_ps.cb1[13].zzzz, vec4(0.00000000f, 1.00000000f, 2.00000000f, 3.00000000f)))));
			r11.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.xxx), floatBitsToUint(r14.xyz), floatBitsToUint(r1.xyw)));
			r13.xyz = fma(r15.xyz, vec3(0.500000000f, 0.500000000f, 0.500000000f), vec3(0.500000000f, 0.500000000f, 0.500000000f));
			r11.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.yyy), floatBitsToUint(r13.xyz), floatBitsToUint(r11.xyz)));
			r5.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.zzz), floatBitsToUint(r16.xxx), floatBitsToUint(r11.xyz)));
			r5.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.www), floatBitsToUint(r16.yyy), floatBitsToUint(r5.xyz)));
			r11 = intBitsToFloat(mix ( ivec4(0x00000000),ivec4(0xffffffff),bvec4(equal(idx_uniforms1_ps.cb1[13].zzzz, vec4(4.00000000f, 5.00000000f, 6.00000000f, 7.00000000f)))));
			r5.xyz = uintBitsToFloat(movc(floatBitsToUint(r11.xxx), floatBitsToUint(r16.zzz), floatBitsToUint(r5.xyz)));
			r5.xyz = uintBitsToFloat(movc(floatBitsToUint(r11.yyy), floatBitsToUint(r16.www), floatBitsToUint(r5.xyz)));
			r5.xyz = uintBitsToFloat(movc(floatBitsToUint(r11.zzz), floatBitsToUint(r12.xyz), floatBitsToUint(r5.xyz)));
			r3.yzw = uintBitsToFloat(movc(floatBitsToUint(r11.www), floatBitsToUint(r3.yyy), floatBitsToUint(r5.xyz)));
			r5 = intBitsToFloat(mix ( ivec4(0x00000000),ivec4(0xffffffff),bvec4(equal(idx_uniforms1_ps.cb1[13].zzzz, vec4(8.00000000f, 9.00000000f, 10.0000000f, 11.0000000f)))));
			r3.yzw = uintBitsToFloat(movc(floatBitsToUint(r5.xxx), floatBitsToUint(r6.xyz), floatBitsToUint(r3.yzw)));
			r6.xyz = r14.xyz * r6.xyz;
			r3.yzw = uintBitsToFloat(movc(floatBitsToUint(r5.yyy), floatBitsToUint(r6.xyz), floatBitsToUint(r3.yzw)));
			r0.x = r16.w * r3.x;
			r0.x = r1.z * r0.x;
			r0.x = r4.x * r0.x;
			r0.x = r0.w * r0.x;
			r3.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.zzz), floatBitsToUint(r0.xxx), floatBitsToUint(r3.yzw)));
			r8.xyz = saturate(r8.xyz);
			r3.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.www), floatBitsToUint(r8.xyz), floatBitsToUint(r3.xyz)));
			r5 = intBitsToFloat(mix ( ivec4(0x00000000),ivec4(0xffffffff),bvec4(equal(idx_uniforms1_ps.cb1[13].zzzz, vec4(12.0000000f, 13.0000000f, 14.0000000f, 15.0000000f)))));
			r3.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.xxx), floatBitsToUint(r9.xyz), floatBitsToUint(r3.xyz)));
			r3.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.yyy), floatBitsToUint(r0.zzz), floatBitsToUint(r3.xyz)));
			r3.xyz = uintBitsToFloat(movc(floatBitsToUint(r5.zzz), floatBitsToUint(r1.zzz), floatBitsToUint(r3.xyz)));
			r0.xzw = uintBitsToFloat(movc(floatBitsToUint(r5.www), floatBitsToUint(r0.www), floatBitsToUint(r3.xyz)));
			...
			r0.xzw = uintBitsToFloat(movc(floatBitsToUint(r3.xxx), floatBitsToUint(r10.xyz), floatBitsToUint(r0.xzw)));
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r3.yyy), floatBitsToUint(r0.yyy), floatBitsToUint(r0.xzw)));
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r3.zzz), floatBitsToUint(r4.yzw), floatBitsToUint(r0.xyz)));
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r3.www), floatBitsToUint(r2.xzw), floatBitsToUint(r0.xyz)));
			r2 = intBitsToFloat(mix ( ivec4(0x00000000),ivec4(0xffffffff),bvec4(equal(idx_uniforms1_ps.cb1[13].zzzz, vec4(20.0000000f, 21.0000000f, 22.0000000f, 23.0000000f)))));
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r2.xxx), floatBitsToUint(r7.xyz), floatBitsToUint(r0.xyz)));
			r3.xyz = r14.xyz * r7.xyz;
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r2.yyy), floatBitsToUint(r3.xyz), floatBitsToUint(r0.xyz)));
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r2.zzz), floatBitsToUint(r21.xxx), floatBitsToUint(r0.xyz)));
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r2.www), floatBitsToUint(r18.zzz), floatBitsToUint(r0.xyz)));
			r2.xy = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(equal(idx_uniforms1_ps.cb1[13].zz, vec2(24.0000000f, 25.0000000f)))));
			r0.xyz = uintBitsToFloat(movc(floatBitsToUint(r2.xxx), floatBitsToUint(r18.xxx), floatBitsToUint(r0.xyz)));
			r14.xyz = uintBitsToFloat(movc(floatBitsToUint(r2.yyy), floatBitsToUint(r17.xxx), floatBitsToUint(r0.xyz)));
		}
		else
		{
			r14.xyz = r1.xyw;

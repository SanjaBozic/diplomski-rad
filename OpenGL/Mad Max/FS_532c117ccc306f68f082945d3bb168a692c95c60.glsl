#version 460 core
// ps_5_0
// Checksum: 5e9a51c9_6abff7be_ffe3ab56_18a5a481
// Name: particleeffectadditivepixelshadowsofterosionnsprjfarcullingvolume
...
void main()
{
	...
	r5.x = saturate(r2.w + v9.v.w);
	r5.y = saturate(dot(r1.xyz, v9.v.xyz));
	r5.zw = r1.ww * idx_uniforms1_ps.cb1[2].yx;
	r5.z = r3.w * r5.z;
	r5.y = log2(r5.y);
	r5.y = r5.y * r5.w;
	r5.y = exp2(r5.y);
	...
	r1.xyz = fma(r3.xyz, r4.xyz, r1.xyz);
	r0.xyz = r0.xyz * r2.xxx;
	o0.xyz = fma(r0.xyz, v6.v.xyz, r1.xyz);

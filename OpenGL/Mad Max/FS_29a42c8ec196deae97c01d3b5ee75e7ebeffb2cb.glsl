#version 460 core
// ps_5_0
// Checksum: 6eadc4f7_3a6fcbf8_9f228991_4af03967
// Name: deferred_sunlight_clt_clft
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r4.xyw = -r2.xyz + idx_uniforms1_ps.cb1[27].xyz;
		...
		r4.xyw = fma(idx_uniforms1_ps.cb1[16].xyz, r5.yyy, r4.xyw);

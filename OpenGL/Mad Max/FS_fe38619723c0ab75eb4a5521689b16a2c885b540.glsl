#version 460 core
// ps_5_0
// Checksum: cf1cc113_77be066b_54411111_94d27f60
// Name: dirtroadmaskblend
...
void main()
{
	...
	r1 = v2.v.xyxy * idx_uniforms1_ps.cb1[0].xzyw;
	r2.xyz = ((texture(resourceSamplerPair_1_ps, r1.zw))).xyz;
	r1.xyz = ((texture(resourceSamplerPair_2_ps, r1.xy))).xyz;
	...
	r1 = (texture(resourceSamplerPair_4_ps, r0.zw));

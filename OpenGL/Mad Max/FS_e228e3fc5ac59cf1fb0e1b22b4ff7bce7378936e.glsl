#version 460 core
// ps_5_0
// Checksum: 0f499257_115e6d2d_aada4c10_e6156a2a
// Name: fastter_noplxlod12cidx2
...
void main()
{
	...
	r2.xy = r4.xy / r0.ww;
	r4.z = r2.x * idx_uniforms1_ps.cb1[6].z;
	r4.xw = r2.yy * idx_uniforms1_ps.cb1[7].wz;
	r0.w = fma(idx_uniforms1_ps.cb1[6].w, r2.x, r4.x);
	...
	r1.xy = r4.zw * vec2(8.00000000f, 8.00000000f);
	r4.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r4.z = idx_uniforms1_ps.cb1[6].y;
	r2.zw = ((texture(resourceSamplerPair_5_ps, r4.xyz)).xzyw).zw;
	...
	r1.yw = r1.yy * r6.xy;
	r1.xy = fma(r1.xx, r2.zw, r1.yw);
	r5 = (texture(resourceSamplerPair_6_ps, r5.xyz));
	r5 = r2.yyyy * r5;
	r2 = fma(r2.xxxx, r4, r5);
	r1.xy = r0.zz * r1.xy;

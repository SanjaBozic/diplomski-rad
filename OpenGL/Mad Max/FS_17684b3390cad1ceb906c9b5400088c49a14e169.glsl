#version 460 core
// ps_5_0
// Checksum: 3a47ae36_e24162a9_5cfabc1d_a9a9684f
// Name: generalmmlod0_ddetail_osn_sand
...
void main()
{
	...
	if (floatBitsToUint(r1.w) != uint(0))
	{
		...
		r6 = (texture(resourceSamplerPair_4_ps, v7.v.xy));
		r5.w = uintBitsToFloat(uint(0x3f800000));
		r5.xyz = r5.xyz * r6.xyz;
		r6.x = ((texture(resourceSamplerPair_4_ps, v7.v.zw)).wxyz).x;

#version 460 core
// ps_5_0
// Checksum: c4e56f0a_deeee895_0dee1bd3_9bcd9a53
// Name: deferred_sunlight_cs_clo
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r3.x = r17.z + r1.w;
		r3.y = r17.z + float(1.00000000f);
		r3.x = saturate(r3.x / r3.y);
		r3.y = r3.x + float(-1.00000000f);
		r3.y = fma(r17.x, r3.y, float(1.00000000f));
		r3.x = r3.y * r3.x;
		...
		r0.z = min(r3.z, float(1.00000000f));
		...
		r2.xzw = r2.xzw * idx_uniforms1_ps.cb1[0].zzz;
		...
		r3.y = saturate(fma(r7.w, float(0.899999976f), float(0.100000001f)));
		r3.y = -r3.y + float(1.00100005f);
		r3.y = min(r3.y, float(1.00000000f));
		r3.z = r3.y * r3.y;
		r3.z = r3.z * r3.z;
		r3.y = r3.z * r3.y;
		r0.z = fma(r0.w, r3.y, r0.z);
		r0.z = min(r0.z, float(1.00000000f));
		r0.w = r4.w + float(8.00000000f);
		r0.w = r0.w * float(0.0398089178f);
		r3.y = fma(r4.w, float(1.44269502f), float(1.44269502f));
		r3.z = dot(r21.xyz, r15.xyz);
		r3.z = fma(r3.y, r3.z, -r3.y);
		r3.z = exp2(r3.z);
		...
		r6.xyz = fma(r6.xyz, r3.www, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		...
		r0.w = r0.w * r16.w;
		r0.w = r0.z * r0.w;
		r3.z = dot(idx_uniforms1_ps.cb1[18].xyz, r15.xyz);
		r3.w = r3.z + float(0.250000000f);
		r3.w = r3.w * float(0.800000012f);
		r3.z = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r3.w), floatBitsToUint(r3.z))));
		r4.xyw = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[18].xyz);
		r3.w = dot(r4.xyw, r4.xyw);
		r3.w = inversesqrt(r3.w);
		r4.xyw = r3.www * r4.xyw;
		r3.w = r3.z * idx_uniforms1_ps.cb1[17].x;
		r3.z = r0.w * r3.z;
		r4.x = dot(r4.xyw, r15.xyz);
		r4.x = fma(r3.y, r4.x, -r3.y);
		r4.x = exp2(r4.x);
		r4.x = min(r4.x, float(1.00000000f));
		r3.z = r3.z * r4.x;
		r3.z = r3.z * idx_uniforms1_ps.cb1[17].y;
		r4.xyw = r3.www * idx_uniforms1_ps.cb1[16].xyz;
		r8.xyz = r3.zzz * idx_uniforms1_ps.cb1[16].xyz;
		r2.xzw = r5.xxx * r2.xzw;
		r3.z = dot(idx_uniforms1_ps.cb1[31].xy, idx_uniforms1_ps.cb1[31].xy);
		r3.z = intBitsToFloat(r3.z != float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
		if (floatBitsToUint(r3.z) != uint(0))
		{
			...
			r3.zw = r2.yy + -r5.xy;
			r5.xy = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(lessThan(r3.zw, vec2(0.00000000f, 0.00000000f)))));
			...
			r3.zw = saturate(r3.zw * r5.xy);
			r3.zw = -r3.zw + vec2(1.00000000f, 1.00000000f);
			...
			r5.xy = r5.xy / r9.yw;
			r3.zw = r3.zw * r3.zw;
			r3.zw = saturate(r5.xy * r3.zw);
			r3.zw = r3.zw * idx_uniforms1_ps.cb1[31].xy;
			r3.z = r3.w + r3.z;
			r9.xyz = r3.zzz * r13.xyz;
			...
			r0.y = fma(r3.y, r0.y, -r3.y);
			r0.y = exp2(r0.y);
			r0.y = min(r0.y, float(1.00000000f));
			r3.yzw = r0.yyy * r9.xyz;
		}
		else
		{
		...
		r3.yzw = fma(r8.xyz, r5.zzz, r3.yzw);
		r3.yzw = r6.xyz * r3.yzw;
		r1.xyw = fma(idx_uniforms0_ps.cb0[2].xyz, r1.xyw, r2.xzw);
		r1.xyw = r4.xyw + r1.xyw;
		r1.xyw = r14.xyz * r1.xyw;
		r0.y = r7.w + r7.w;
		r2.xzw = fma(r0.yyy, r15.xyz, -r19.xzw);
		r0.yw = r2.ww * idx_uniforms1_ps.cb1[33].yw;
		r5.xz = fma(-r2.xx, idx_uniforms1_ps.cb1[33].xz, r0.yw);
		r0.yw = r2.ww * idx_uniforms1_ps.cb1[38].yw;
		r8.xz = fma(-r2.xx, idx_uniforms1_ps.cb1[38].xz, r0.yw);
		r5.y = r2.z;
		r2.xzw = ((textureLod(resourceSamplerPair_8_ps, r5.xyz, r5.w)).xwyz).xzw;
		r8.y = r5.y;
		r4.xyw = ((textureLod(resourceSamplerPair_9_ps, r8.xyz, r5.w)).xywz).xyw;
		r4.xyw = -r2.xzw + r4.xyw;
		r2.xzw = fma(idx_uniforms1_ps.cb1[0].www, r4.xyw, r2.xzw);
		r2.xzw = r6.xyz * r2.xzw;
		r2.xzw = r2.xzw * idx_uniforms1_ps.cb1[20].zzz;
		...
		r0.w = max(r0.w, r19.y);
		r4.x = -r0.y + r20.y;
		r0.y = saturate(fma(r0.w, r4.x, r0.y));
		...
		r0.w = fma(r4.x, r0.w, float(1.00000000f));
		r0.y = r0.y * r0.w;
		r0.y = r4.x * r0.y;
		...
		r0.yzw = fma(r7.xyz, r0.zzz, r3.yzw);

#version 460 core
// ps_5_0
// Checksum: a0d2f1ce_4423564b_4286afed_4cf1e3e7
// Name: generalmmlod0fade_em_osn_terraincolor_sand_inst
...
void main()
{
	...
	r1.xyz = fma(idx_uniforms2_ps.cb2[0].yyy, r1.xyz, idx_uniforms2_ps.cb2[0].www);
	r0.xyz = r0.xyz * r1.xyz;
	r1.xyz = ((texture(resourceSamplerPair_2_ps, v2.v.zw))).xyz;

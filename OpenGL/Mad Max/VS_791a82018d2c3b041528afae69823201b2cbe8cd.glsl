#version 460 core
// vs_5_0
// Checksum: 72f84b11_8cd5eb0d_94ec44c2_54a58108
// Name: generalmm_d1_ed2_wireaa_inst
...
void main()
{
	...
	r1.yzw = v3.xxx * vec3(1.00000000f, 0.00390625000f, 1.52587891e-05f);
	r1.yzw = fract(r1.yzw);
	...
	r0.xyz = fma(r2.zzz, v6.xyz, r0.xyz);
	r0.xyz = fma(r2.yyy, v5.xyz, r0.xyz);
	...
	o3.v.xyz = fma(r1.www, v6.xyz, r0.xyz);
	...
	r1.xyz = fma(r0.xxx, v4.xyz, r1.xyz);
	o4.v.xyz = fma(r0.zzz, v6.xyz, r1.xyz);
	...
	r1 = fract(r1);
	o6.v.w = r0.w * r1.w;
	r0.xyz = fma(v7.xyz, idx_uniforms1_vs.cb1[8].www, vec3(-1.00000000f, -1.00000000f, -1.00000000f));

#version 460 core
// vs_5_0
// Checksum: 690400a7_92988de7_7c16371f_e54f0530
// Name: character3uvs_em
...
void main()
{
	...
	r0.xy = v3.xy * idx_uniforms1_vs.cb1[0].yz;
	o1.v.xy = r0.xy;
	r2 = fma(v5, vec4(6.28318548f, 6.28318548f, 6.28318548f, 6.28318548f), vec4(-3.14159274f, -3.14159274f, -3.14159274f, -3.14159274f));

#version 460 core
// ps_5_0
// Checksum: 30a4af4d_d2598923_1db1d423_3799d7b2
// Name: fastter_noplxlod12cidx3
...
void main()
{
	...
	r4.xy = r2.xx * idx_uniforms1_ps.cb1[6].wz;
	r0.w = fma(idx_uniforms1_ps.cb1[7].w, r2.y, r4.x);
	...
	r4.z = r2.y * idx_uniforms1_ps.cb1[7].z;
	r4.w = r2.z * idx_uniforms1_ps.cb1[8].z;
	r1.xyw = r4.yzw * vec3(8.00000000f, 8.00000000f, 8.00000000f);
	r4.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r4.z = idx_uniforms1_ps.cb1[6].y;
	r5.xy = ((texture(resourceSamplerPair_5_ps, r4.xyz)).ywxz).xy;

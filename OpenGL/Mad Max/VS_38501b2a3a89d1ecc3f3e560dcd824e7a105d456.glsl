#version 460 core
// vs_5_0
// Checksum: 7e11742c_52dad41f_9871243b_887930fd
// Name: particleeffectvertexshadowsofterosion
...
void main()
{
	...
	r1.xyz = ((textureLod(resourceSamplerPair_0_vs, r1.xy, float(0.00000000f)))).xyz;
	...
	r4.xyz = fma(idx_uniforms0_vs.cb0[5].xyz, r0.xxx, -r3.xyz);
	...
	r1.w = r0.x * abs(r0.y);
	r3.xyz = fma(r1.www, r4.xyz, r3.xyz);
	r1.w = dot(r3.xyz, r3.xyz);
	r1.w = inversesqrt(r1.w);
	r3.xyz = r1.www * r3.xyz;
	r1.w = dot(r3.xyz, -idx_uniforms0_vs.cb0[8].xyz);
	r0.x = saturate(fma(abs(r0.y), r0.x, r1.w));
	r0.x = max(r0.z, r0.x);
	r0.y = r0.z + float(1.00000000f);
	r0.y = float(1.00000000f) / r0.y;
	r0.x = r0.y * r0.x;
	r3.xyz = r0.xxx * idx_uniforms2_vs.cb2[2].xyz;
	r0.x = v3.x * float(8.00000000f);
	r3.xyz = r0.xxx * r3.xyz;
	r4.xyz = r1.xyz * r3.xyz;
	r0.x = dot(r4.xyz, vec3(0.212500006f, 0.715399981f, 0.0720999986f));
	r1.xyz = fma(r3.xyz, r1.xyz, -r0.xxx);
	o4.v.xyz = fma(idx_uniforms1_vs.cb1[16].zzz, r1.xyz, r0.xxx);
	r0.x = idx_uniforms1_vs.cb1[7].w + -idx_uniforms1_vs.cb1[8].w;
	r0.x = max(r0.x, float(9.99999997e-07f));
	r1.x = v6.w * float(-16.0000000f);
	r1.xyz = fma(v6.xyz, r1.xxx, v0.xyz);
	r3.xyz = -r1.xyz + idx_uniforms1_vs.cb1[7].xyz;
	r1.w = dot(r3.xyz, r3.xyz);
	r2.w = sqrt(r1.w);
	r1.w = inversesqrt(r1.w);
	r3.xyz = r1.www * r3.xyz;
	...
	r0.w = fma(-r2.y, r0.w, float(0.100000001f));
	r0.w = r0.w + r0.w;
	r1.w = dot(r2.xzw, r2.xzw);
	r1.w = inversesqrt(r1.w);
	r2.xyz = r1.www * r2.xzw;
	r1.w = dot(r3.xyz, r2.xyz);
	r2.w = dot(-r3.xyz, idx_uniforms1_vs.cb1[9].xyz);
	r2.w = saturate(r2.w + idx_uniforms1_vs.cb1[9].w);
	r2.w = r2.w * r2.w;
	r1.w = max(r0.z, r1.w);
	r1.w = r0.y * r1.w;

#version 460 core
// ps_5_0
// Checksum: a383d7e4_0198a263_6ee52bd4_dced7478
// Name: carpaintmm_damaget_fade
...
void main()
{
	...
	r0.xyz = ((texture(resourceSamplerPair_2_ps, r0.xy)).xzyw).xyz;

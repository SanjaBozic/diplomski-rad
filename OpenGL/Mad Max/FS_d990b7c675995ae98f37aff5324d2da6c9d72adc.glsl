#version 460 core
// ps_5_0
// Checksum: 1e853b30_6b58a14f_8a81963c_21a71cad
// Name: fastter_noplxlod01cidx4cgc
...
void main()
{
	...
	r3 = r3 / r0.wwww;
	r0.w = r3.y * idx_uniforms1_ps.cb1[7].w;
	r0.w = fma(idx_uniforms1_ps.cb1[6].w, r3.x, r0.w);
	r0.w = fma(idx_uniforms1_ps.cb1[8].w, r3.z, r0.w);
	r0.w = fma(idx_uniforms1_ps.cb1[9].w, r3.w, r0.w);
	...
	r4.x = ((texture(resourceSamplerPair_4_ps, r4.xyz)).wxyz).x;
	r0.w = fma(r3.z, r4.x, r0.w);
	r4.xy = v2.v.xz * vec2(0.0273437500f, 0.0273437500f);
	r4.z = idx_uniforms1_ps.cb1[9].y;
	r5.zw = ((texture(resourceSamplerPair_3_ps, r4.xyz)).xzyw).zw;
	r5.zw = fma(r5.wz, vec2(2.00000000f, 2.00000000f), vec2(-1.00000000f, -1.00000000f));
	r5.xy = fma(r2.ww, r5.zw, r5.xy);
	r4.x = ((texture(resourceSamplerPair_4_ps, r4.xyz)).wxyz).x;
	r0.w = fma(r3.w, r4.x, r0.w);
	r0.xy = r0.xy * vec2(4.26337051f, 4.26337051f);
	r4.x = dot(r0.xy, r0.xy);

#version 460 core
// ps_5_0
// Checksum: 98880289_ee056703_84579768_0b0960a4
// Name: deferred_sunlight_ind_clt
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r4.w = fma(r0.x, v2.v.y, idx_uniforms0_ps.cb0[4].y);
		r7.xyz = fma(-v2.v.xyz, r2.xxx, -idx_uniforms0_ps.cb0[3].xyz);
		r7.w = dot(r7.xyz, r7.xyz);
		r7.w = inversesqrt(r7.w);
		r7.xyz = r7.www * r7.xyz;
		r7.w = dot(r5.xzw, r0.yzw);
		r8.x = saturate(r7.w);
		r8.y = saturate(fma(r0.z, float(0.500000000f), float(0.500000000f)));
		r9.xyz = idx_uniforms0_ps.cb0[10].xyz + -idx_uniforms0_ps.cb0[11].xyz;
		r8.yzw = fma(r8.yyy, r9.xyz, idx_uniforms0_ps.cb0[11].xyz);
		r9.x = dot(r0.yzw, -idx_uniforms0_ps.cb0[3].xyz);
		r9.y = r6.w + r9.x;
		r6.w = r6.w + float(1.00000000f);
		r6.w = saturate(r9.y / r6.w);
		r9.y = r6.w + float(-1.00000000f);
		r6.x = fma(r6.x, r9.y, float(1.00000000f));
		r6.x = r6.x * r6.w;
		r6.w = fma(r6.x, r8.x, float(9.99999975e-05f));
		r6.w = log2(r6.w);
		r3.z = r3.z * r6.w;
		r3.z = exp2(r3.z);
		r3.z = r6.x * r3.z;
		r3.z = min(r3.z, float(1.00000000f));
		r6.w = saturate(fma(r4.x, float(0.500000000f), -r9.x));
		r3.z = fma(r6.w, r4.x, r3.z);
		r9.xy = fma(r2.ww, idx_uniforms1_ps.cb1[35].xz, idx_uniforms1_ps.cb1[36].xz);
		r8.xyz = r8.yzw * idx_uniforms1_ps.cb1[0].zzz;
		...
		r8.w = saturate(fma(r7.w, float(0.899999976f), float(0.100000001f)));
		r8.w = -r8.w + float(1.00100005f);
		r8.w = min(r8.w, float(1.00000000f));
		r9.z = r8.w * r8.w;
		r9.z = r9.z * r9.z;
		r8.w = r8.w * r9.z;
		r4.x = fma(r6.w, r8.w, r4.x);
		...
		r7.x = fma(r3.w, r7.x, -r3.w);
		r7.x = exp2(r7.x);
		r7.x = min(r7.x, float(1.00000000f));
		r7.x = r6.w * r7.x;
		r10.xyz = r1.xyz + vec3(0.00999999978f, 0.00999999978f, 0.00999999978f);
		r7.y = dot(r10.xyz, r10.xyz);
		r7.y = inversesqrt(r7.y);
		r10.xyz = fma(r10.xyz, r7.yyy, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r10.xyz = fma(r5.yyy, r10.xyz, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		r6.w = r2.w * r6.w;
		r6.w = r4.x * r6.w;
		r7.x = r6.x * r7.x;
		r7.x = r4.x * r7.x;
		r7.y = dot(idx_uniforms1_ps.cb1[18].xyz, r0.yzw);
		r7.z = intBitsToFloat(float(0.00000000f) < r4.y ? int(0xffffffff) : int(0x00000000));
		r8.w = r7.y + float(0.250000000f);
		r8.w = r8.w * float(0.800000012f);
		r7.y = saturate(uintBitsToFloat(movc(floatBitsToUint(r7.z), floatBitsToUint(r8.w), floatBitsToUint(r7.y))));
		r11.xyz = fma(-v2.v.xyz, r2.xxx, idx_uniforms1_ps.cb1[18].xyz);
		r2.x = dot(r11.xyz, r11.xyz);
		r2.x = inversesqrt(r2.x);
		r11.xyz = r2.xxx * r11.xyz;
		r2.x = r7.y * idx_uniforms1_ps.cb1[17].x;
		r6.w = r6.w * r7.y;
		r7.y = dot(r11.xyz, r0.yzw);
		r3.w = fma(r3.w, r7.y, -r3.w);
		r3.w = exp2(r3.w);
		...
		r7.xyz = r7.xxx * idx_uniforms1_ps.cb1[26].xyz;
		r7.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r3.www, r7.xyz);
		r11.xyz = r9.yyy * r11.xyz;
		r7.xyz = r9.yyy * r7.xyz;
		r8.xyz = fma(r8.xyz, r9.xxx, r11.xyz);
		...
		r9.xz = fma(-r0.yy, idx_uniforms1_ps.cb1[38].xz, r3.zw);
		r8.y = r0.z;
		r0.yzw = ((textureLod(resourceSamplerPair_4_ps, r8.xyz, r4.z)).wxyz).yzw;
		r9.y = r8.y;
		r8.xyz = ((textureLod(resourceSamplerPair_5_ps, r9.xyz, r4.z))).xyz;
		r8.xyz = -r0.yzw + r8.xyz;
		r0.yzw = fma(idx_uniforms1_ps.cb1[0].www, r8.xyz, r0.yzw);
		...
		r0.yzw = fma(r7.xyz, r10.xyz, r0.yzw);
		r1.x = saturate(r0.x * idx_uniforms0_ps.cb0[16].w);
		r1.y = fma(r4.w, idx_uniforms0_ps.cb0[16].z, -idx_uniforms0_ps.cb0[16].x);

#version 460 core
// ps_5_0
// Checksum: 97a2fe82_4e4588ed_ffff073e_43b54346
// Name: deferred_sunlight_cs_clt_clfot
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r3.xyz = fma(r1.www, r3.xyz, idx_uniforms0_ps.cb0[11].xyz);
		r1.w = dot(r15.xyz, -idx_uniforms0_ps.cb0[3].xyz);
		r2.w = r17.z + r1.w;
		r3.w = r17.z + float(1.00000000f);
		r2.w = saturate(r2.w / r3.w);
		r3.w = r2.w + float(-1.00000000f);
		r3.w = fma(r17.x, r3.w, float(1.00000000f));
		r2.w = r2.w * r3.w;
		r3.w = fma(r2.w, r8.w, float(9.99999975e-05f));
		r3.w = log2(r3.w);
		r3.w = r3.w * r6.w;
		r3.w = exp2(r3.w);
		r3.w = r2.w * r3.w;
		r3.w = min(r3.w, float(1.00000000f));
		r4.x = r18.y * float(2.50000000f);
		r5.x = saturate(fma(r18.x, float(0.500000000f), -r1.w));
		r3.w = fma(r5.x, r18.x, r3.w);
		r3.w = min(r3.w, float(1.00000000f));
		r5.xyz = fma(r16.www, idx_uniforms1_ps.cb1[35].xyz, idx_uniforms1_ps.cb1[36].xyz);
		r5.y = saturate(r5.y + idx_uniforms1_ps.cb1[35].w);
		r5.y = r5.y + -idx_uniforms1_ps.cb1[35].w;
		r6.x = -idx_uniforms1_ps.cb1[35].w + float(1.00000000f);
		r5.y = r5.y / r6.x;
		...
		r1.y = r0.z * r1.y;
		r6.x = r1.y * float(5.00000000f);
		r6.x = min(r6.x, float(1.00000000f));
		r6.xyz = fma(r6.xxx, vec3(0.100000001f, 0.790000021f, 0.939999998f), vec3(0.899999976f, 0.209999993f, 0.0599999987f));
		r6.xyz = r5.yyy * r6.xyz;
		r1.w = -r1.w + float(0.150000006f);
		r1.w = saturate(r1.w + r1.w);
		r0.z = r0.z * r1.w;
		r7.xyz = r0.zzz * vec3(0.200000003f, 0.0460000001f, 0.00999999978f);
		r0.z = min(r4.x, float(1.00000000f));
		...
		r0.z = r1.z * r3.w;
		r0.z = r5.y * r0.z;
		r1.xyw = uintBitsToFloat(movc(floatBitsToUint(r4.yyy), floatBitsToUint(r1.xyw), floatBitsToUint(r0.zzz)));
		r3.xyz = r3.xyz * idx_uniforms1_ps.cb1[0].zzz;
		r0.z = saturate(fma(r16.z, float(2.00000000f), float(-1.00000000f)));
		r0.z = fma(r0.z, float(0.649999976f), float(0.0500000007f));
		r0.w = -r0.z + float(1.00000000f);
		r4.x = saturate(fma(r7.w, float(0.899999976f), float(0.100000001f)));
		r4.x = -r4.x + float(1.00100005f);
		r4.x = min(r4.x, float(1.00000000f));
		r5.y = r4.x * r4.x;
		r5.y = r5.y * r5.y;
		r4.x = r4.x * r5.y;
		r0.z = fma(r0.w, r4.x, r0.z);
		r0.z = min(r0.z, float(1.00000000f));
		r0.w = r4.w + float(8.00000000f);
		r0.w = r0.w * float(0.0398089178f);
		r4.x = fma(r4.w, float(1.44269502f), float(1.44269502f));
		r4.w = dot(r21.xyz, r15.xyz);
		r4.w = fma(r4.x, r4.w, -r4.x);
		r4.w = exp2(r4.w);
		r4.w = min(r4.w, float(1.00000000f));
		r4.w = r0.w * r4.w;
		r6.xyz = r14.xyz + vec3(0.00999999978f, 0.00999999978f, 0.00999999978f);
		r5.y = dot(r6.xyz, r6.xyz);
		r5.y = inversesqrt(r5.y);
		r6.xyz = fma(r6.xyz, r5.yyy, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r6.xyz = fma(r19.yyy, r6.xyz, vec3(1.00000000f, 1.00000000f, 1.00000000f));
		r7.xyz = r6.xyz * idx_uniforms0_ps.cb0[1].xyz;
		r7.xyz = r2.www * r7.xyz;
		r7.xyz = r16.www * r7.xyz;
		...
		r4.w = r2.w * r4.w;
		r4.w = r0.z * r4.w;
		r8.xyz = -r2.xyz + idx_uniforms1_ps.cb1[19].xyz;
		r5.y = dot(r8.xyz, r8.xyz);
		r5.y = sqrt(r5.y);
		r6.w = dot(idx_uniforms1_ps.cb1[18].xyz, r15.xyz);
		r8.x = r6.w + float(0.250000000f);
		r8.x = r8.x * float(0.800000012f);
		r4.y = saturate(uintBitsToFloat(movc(floatBitsToUint(r4.y), floatBitsToUint(r8.x), floatBitsToUint(r6.w))));
		r8.xyz = fma(-v2.v.xyz, r0.yyy, idx_uniforms1_ps.cb1[18].xyz);
		r6.w = dot(r8.xyz, r8.xyz);
		r6.w = inversesqrt(r6.w);
		r8.xyz = r6.www * r8.xyz;
		r6.w = r4.y * idx_uniforms1_ps.cb1[17].x;
		r4.y = r0.w * r4.y;
		r8.x = dot(r8.xyz, r15.xyz);
		r8.x = fma(r4.x, r8.x, -r4.x);
		r8.x = exp2(r8.x);
		r8.x = min(r8.x, float(1.00000000f));
		r4.y = r4.y * r8.x;
		r4.y = r4.y * idx_uniforms1_ps.cb1[17].y;
		r5.y = r5.y / idx_uniforms1_ps.cb1[19].w;
		r5.y = saturate(-r5.y + float(1.00000000f));
		r6.w = r5.y * r6.w;
		r4.y = r4.y * r5.y;
		r8.xyz = -r2.xyz + idx_uniforms1_ps.cb1[27].xyz;
		...
		r2.z = r2.x * r3.w;
		r2.x = r2.x * r4.w;
		r8.xyz = r2.zzz * idx_uniforms1_ps.cb1[25].xyz;
		r8.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r6.www, r8.xyz);
		r9.xyz = r2.xxx * idx_uniforms1_ps.cb1[26].xyz;
		r9.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r4.yyy, r9.xyz);
		r3.xyz = r5.xxx * r3.xyz;
		r2.x = dot(idx_uniforms1_ps.cb1[31].xy, idx_uniforms1_ps.cb1[31].xy);
		r2.x = intBitsToFloat(r2.x != float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
		if (floatBitsToUint(r2.x) != uint(0))
		{
			r10.xy = r17.zz + vec2(0.300000012f, 1.29999995f);
			r5.y = r13.w * float(128.000000f);
			r5.x = fma(r13.w, float(128.000000f), idx_uniforms1_ps.cb1[28].w);
			r2.xz = r2.yy + -r5.xy;
			r4.yw = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(lessThan(r2.xz, vec2(0.00000000f, 0.00000000f)))));
			r4.yw = uintBitsToFloat(movc(floatBitsToUint(r4.yw), floatBitsToUint(idx_uniforms1_ps.cb1[30].yy), floatBitsToUint(idx_uniforms1_ps.cb1[30].xx)));
			r2.xz = saturate(r2.xz * r4.yw);
			r2.xz = -r2.xz + vec2(1.00000000f, 1.00000000f);
			r3.w = dot(idx_uniforms1_ps.cb1[28].xyz, r15.xyz);
			r10.z = -1.f * r10.x;
			r4.yw = r3.ww + r10.xz;
			...
			r2.xz = r2.xz * idx_uniforms1_ps.cb1[31].xy;
			r2.x = r2.z + r2.x;
			r10.xyz = r2.xxx * r13.xyz;
			...
			r0.y = fma(r4.x, r0.y, -r4.x);
			r0.y = exp2(r0.y);
			r0.y = min(r0.y, float(1.00000000f));
			r4.xyw = r0.yyy * r10.xyz;
		}
		else
		{
			r12.xyz = uintBitsToFloat(uvec3(0x00000000, 0x00000000, 0x00000000));
			r4.xyw = uintBitsToFloat(uvec3(0x00000000, 0x00000000, 0x00000000));
		}
		r0.y = -r5.z + float(1.00000000f);
		r0.y = fma(r17.z, r0.y, r5.z);
		r10.xyz = r0.yyy * r12.xyz;
		r8.xyz = fma(r8.xyz, r5.zzz, r10.xyz);
		r4.xyw = r0.yyy * r4.xyw;
		r4.xyw = fma(r9.xyz, r5.zzz, r4.xyw);
		r4.xyw = r6.xyz * r4.xyw;
		r1.xyw = fma(idx_uniforms0_ps.cb0[2].xyz, r1.xyw, r3.xyz);
		r1.xyw = r8.xyz + r1.xyw;
		r1.xyw = r14.xyz * r1.xyw;
		r0.y = r7.w + r7.w;
		r3.xyz = fma(r0.yyy, r15.xyz, -r19.xzw);
		r0.yw = r3.zz * idx_uniforms1_ps.cb1[33].yw;
		r5.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[33].xz, r0.yw);
		r0.yw = r3.zz * idx_uniforms1_ps.cb1[38].yw;
		r8.xz = fma(-r3.xx, idx_uniforms1_ps.cb1[38].xz, r0.yw);
		r5.y = r3.y;
		r3.xyz = ((textureLod(resourceSamplerPair_8_ps, r5.xyz, r5.w))).xyz;
		r8.y = r5.y;
		r5.xyz = ((textureLod(resourceSamplerPair_9_ps, r8.xyz, r5.w))).xyz;
		r5.xyz = -r3.xyz + r5.xyz;
		r3.xyz = fma(idx_uniforms1_ps.cb1[0].www, r5.xyz, r3.xyz);
		r3.xyz = r6.xyz * r3.xyz;
		r3.xyz = r3.xyz * idx_uniforms1_ps.cb1[20].zzz;
		r0.y = saturate(fma(-r16.z, float(2.00000000f), float(1.00000000f)));
		r0.y = r0.y + r0.y;
		r0.y = max(r18.z, r0.y);
		r0.w = fma(-r18.z, float(8.00000000f), float(1.00000000f));
		r0.w = saturate(fma(r4.z, r0.w, float(-1.00000000f)));
		r2.xz = r0.yy + vec2(2.00000000f, 1.00000000f);
		r0.y = fma(r16.w, r2.x, -r2.z);
		r0.w = max(r0.w, r19.y);
		r2.x = -r0.y + r20.y;
		r0.y = saturate(fma(r0.w, r2.x, r0.y));
		r0.w = dot(vec3(0.212500006f, 0.715399981f, 0.0720999986f), idx_uniforms0_ps.cb0[10].zzz);
		r0.w = r0.w * float(3.00000000f);
		r2.x = dot(vec3(0.212500006f, 0.715399981f, 0.0720999986f), idx_uniforms0_ps.cb0[2].xyz);
		r2.x = max(r2.x, float(0.100000001f));
		r0.w = r0.w / r2.x;
		r0.w = max(r0.w, float(0.100000001f));
		r0.w = min(r0.w, float(1.00000000f));
		r2.x = fma(r19.y, r17.y, r16.y);
		r1.z = r1.z * r2.w;
		r0.w = fma(r1.z, float(6.00000000f), r0.w);
		r0.w = min(r0.w, float(1.00000000f));
		r0.w = fma(idx_uniforms1_ps.cb1[31].z, r0.w, float(-1.00000000f));
		r0.w = r0.w * idx_uniforms1_ps.cb1[31].z;
		r0.w = fma(r2.x, r0.w, float(1.00000000f));
		r0.y = r0.y * r0.w;
		r0.y = r2.x * r0.y;
		r0.w = max(r20.z, float(0.0799999982f));
		r0.w = min(r0.w, float(1.00000000f));
		r0.w = min(r0.w, r0.z);
		r0.y = saturate(r0.y * r0.w);
		r0.w = -r0.y + float(1.00000000f);
		r1.z = -r19.y + float(1.00000000f);
		r0.w = r0.w * r1.z;
		r2.xzw = r0.yyy * r3.xyz;
		r1.xyz = fma(r1.xyw, r0.www, r2.xzw);
		r0.yzw = fma(r7.xyz, r0.zzz, r4.xyw);

#version 460 core
// vs_5_0
// Checksum: aa21790e_7eda6dfe_c28ee5d2_753746ef
// Name: generalmm_d1_ed2_vertexanim_inst
...
{
	Initialise();
	r0.xyz = v3.zzz * vec3(1.00000000f, 0.0156250000f, 0.000244140625f);
	r0.xyz = fract(r0.xyz);
	...
	r2.xyz = v3.xxx * vec3(1.00000000f, 0.00390625000f, 1.52587891e-05f);
	r2.xyz = fract(r2.xyz);
	...
	r4.xyz = fma(r0.zzz, v6.xyz, r1.xyz);
	r1.xyz = fma(r3.zzz, v6.xyz, r1.xyz);
	r1.xyz = fma(r3.yyy, v5.xyz, r1.xyz);
	r1.xyz = fma(r3.xxx, v4.xyz, r1.xyz);
	r0.yzw = fma(r0.yyy, v5.xyz, r4.xyz);
	r0.xyz = fma(r0.xxx, v4.xyz, r0.yzw);
	...
	r3.xy = r0.ww * idx_uniforms3_vs.cb3[4].xy;
	r0.zw = fma(r0.zz, idx_uniforms3_vs.cb3[3].xy, r3.xy);
	o1.v.xy = r0.zw + idx_uniforms3_vs.cb3[5].xy;
	...
	r0.xy = v2.xy * idx_uniforms2_vs.cb2[0].yz;
	r0.yz = r0.yy * idx_uniforms3_vs.cb3[7].xy;
	r0.xy = fma(r0.xx, idx_uniforms3_vs.cb3[6].xy, r0.yz);
	o2.v.zw = r0.xy + idx_uniforms3_vs.cb3[8].xy;
	r0.xyz = r2.yyy * v5.xyz;
	r0.xyz = fma(r2.xxx, v4.xyz, r0.xyz);
	o3.v.xyz = fma(r2.zzz, v6.xyz, r0.xyz);
	r0.xyz = abs(v3.yyy) * vec3(1.00000000f, 0.00390625000f, 1.52587891e-05f);
	r0.xyz = fract(r0.xyz);
	r0.xyz = fma(r0.xyz, vec3(2.00000000f, 2.00000000f, 2.00000000f), vec3(-1.00000000f, -1.00000000f, -1.00000000f));
	r0.w = dot(r0.xyz, r0.xyz);
	r0.w = inversesqrt(r0.w);
	r0.xyz = r0.www * r0.xyz;
	r2.xyz = r0.yyy * v5.xyz;
	r0.xyw = fma(r0.xxx, v4.xyz, r2.xyz);
	o4.v.xyz = fma(r0.zzz, v6.xyz, r0.xyw);
	r0.x = intBitsToFloat(float(0.00000000f) < v3.y ? int(0xffffffff) : int(0x00000000));
	r0.y = intBitsToFloat(v3.y < float(0.00000000f) ? int(0xffffffff) : int(0x00000000));

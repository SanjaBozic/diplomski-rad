#version 460 core
// ps_5_0
// Checksum: 68288f6f_453a9b77_747ad5af_0a5986de
// Name: particleeffectadditivepixelshadowsofterosionprjfar
...
void main()
{
	...
	r1.x = r1.y * r1.x;
	r1.xyz = fma(v6.v.xyz, r1.xxx, v7.v.xyz);
	r1.xyz = r1.xyz * v2.v.xyz;
	r2.x = r0.w;
	r2.y = v1.v.w;

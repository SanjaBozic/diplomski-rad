#version 460 core
// vs_5_0
// Checksum: 6733ab55_7d2d8110_285ba128_93d6054e
// Name: particleeffectblendpixelshadowsoftns
...
void main()
{
	...
	r4.yzw = -r1.xyz + idx_uniforms1_vs.cb1[7].xyz;
	r0.z = dot(r4.yzw, r4.yzw);
	r1.w = sqrt(r0.z);
	r0.z = inversesqrt(r0.z);
	r4.yzw = r0.zzz * r4.yzw;
	...
	r1.w = dot(-r4.yzw, idx_uniforms1_vs.cb1[9].xyz);
	...
	r0.x = r0.w * r0.x;
	r0.x = r1.w * r0.x;
	r4.yzw = r0.xxx * idx_uniforms1_vs.cb1[8].xyz;
	r0.x = idx_uniforms1_vs.cb1[4].w + -idx_uniforms1_vs.cb1[5].w;
	r0.x = max(r0.x, float(9.99999997e-07f));
	r5.xyz = -r1.xyz + idx_uniforms1_vs.cb1[4].xyz;
	...
	r1.w = dot(-r5.xyz, idx_uniforms1_vs.cb1[6].xyz);
	...
	r0.x = r0.w * r0.x;
	r0.x = r1.w * r0.x;
	r4.yzw = fma(r0.xxx, idx_uniforms1_vs.cb1[5].xyz, r4.yzw);
	r5.xyz = -r1.xyz + idx_uniforms1_vs.cb1[10].xyz;
	...
	r5.xyz = r0.www * r5.xyz;
	r0.w = dot(r5.xyz, r3.xyz);
	r1.w = dot(-r5.xyz, idx_uniforms1_vs.cb1[12].xyz);
	...
	r0.x = r0.w * r0.x;
	r0.x = r1.w * r0.x;
	r4.yzw = fma(r0.xxx, idx_uniforms1_vs.cb1[11].xyz, r4.yzw);
	...
	r0.x = r0.y * r0.x;
	r0.x = r1.x * r0.x;
	r0.xyw = fma(r0.xxx, idx_uniforms1_vs.cb1[14].xyz, r4.yzw);

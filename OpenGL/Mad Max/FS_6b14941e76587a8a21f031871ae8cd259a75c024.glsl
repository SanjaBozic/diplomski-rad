#version 460 core
// ps_5_0
// Checksum: 58f26b95_941bb567_18193b13_609bb1ec
// Name: deferred_sunlight_cs_clt
...
void main()
{
	...
	if (floatBitsToUint(r0.y) != uint(0))
	{
		...
		r3.z = saturate(fma(r7.w, float(0.899999976f), float(0.100000001f)));
		r3.z = -r3.z + float(1.00100005f);
		r3.z = min(r3.z, float(1.00000000f));
		r3.w = r3.z * r3.z;
		r3.w = r3.w * r3.w;
		r3.z = r3.w * r3.z;
		r0.z = fma(r0.w, r3.z, r0.z);
		r0.z = min(r0.z, float(1.00000000f));
		r0.w = r4.w + float(8.00000000f);
		r0.w = r0.w * float(0.0398089178f);
		r3.z = fma(r4.w, float(1.44269502f), float(1.44269502f));
		r3.w = dot(r21.xyz, r15.xyz);
		r3.w = fma(r3.z, r3.w, -r3.z);
		r3.w = exp2(r3.w);
		...
		r6.xyz = fma(r6.xyz, r4.xxx, vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		...
		r4.w = fma(r3.z, r4.w, -r3.z);
		r4.w = exp2(r4.w);
		r4.w = min(r4.w, float(1.00000000f));
		r4.x = r4.w * r4.x;
		r4.x = r4.x * idx_uniforms1_ps.cb1[17].y;
		r8.xyz = r3.yyy * idx_uniforms1_ps.cb1[25].xyz;
		r8.xyz = fma(idx_uniforms1_ps.cb1[16].xyz, r4.yyy, r8.xyz);
		r9.xyz = r3.www * idx_uniforms1_ps.cb1[26].xyz;
		r4.xyw = fma(idx_uniforms1_ps.cb1[16].xyz, r4.xxx, r9.xyz);
		r2.xzw = r5.xxx * r2.xzw;
		r3.y = dot(idx_uniforms1_ps.cb1[31].xy, idx_uniforms1_ps.cb1[31].xy);
		r3.y = intBitsToFloat(r3.y != float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
		if (floatBitsToUint(r3.y) != uint(0))
		{
			...
			r3.yw = r2.yy + -r5.xy;
			r5.xy = intBitsToFloat(mix ( ivec2(0x00000000),ivec2(0xffffffff),bvec2(lessThan(r3.yw, vec2(0.00000000f, 0.00000000f)))));
			...
			r3.yw = -r3.yw + vec2(1.00000000f, 1.00000000f);
			...
			r3.yw = r3.yw * idx_uniforms1_ps.cb1[31].xy;
			r3.y = r3.w + r3.y;
			r9.xyz = r3.yyy * r13.xyz;
		...
		r8.xyz = fma(r8.xyz, r5.zzz, r9.xyz);
		r3.yzw = r0.yyy * r3.yzw;
		r3.yzw = fma(r4.xyw, r5.zzz, r3.yzw);

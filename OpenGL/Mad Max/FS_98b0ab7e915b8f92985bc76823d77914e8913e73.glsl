#version 460 core
// ps_5_0
// Checksum: 6d5ff6bb_f7f496d0_6ffa592a_c967aa66
// Name: generalmmlod0fade_ddetail_osn_sand
...
void main()
{
	...
	r2.w = fma(idx_uniforms2_ps.cb2[3].x, r3.w, idx_uniforms2_ps.cb2[3].y);
	r0.xyz = r0.xyz * r3.xyz;
	r0.xyz = r0.xyz * vec3(4.69999981f, 4.69999981f, 4.69999981f);
	r3.y = r2.w * r2.y;
	r4.xyz = r1.zzz * idx_uniforms1_ps.cb1[3].xyz;
	r4.xyz = fma(idx_uniforms1_ps.cb1[2].xyz, r1.yyy, r4.xyz);
	r4.xyz = fma(idx_uniforms1_ps.cb1[4].xyz, r1.xxx, r4.xyz);
	r2.w = dot(r4.xyz, r4.xyz);
	r2.w = inversesqrt(r2.w);
	r4.xzw = r2.www * r4.xyz;
	r5.x = saturate(r4.w * idx_uniforms1_ps.cb1[5].z);
	r2.w = fma(r4.y, r2.w, r5.x);
	r4.y = intBitsToFloat(r2.w >= float(0.00000000f) ? int(0xffffffff) : int(0x00000000));
	r5.xy = idx_uniforms1_ps.cb1[5].ww * vec2(0.00200000009f, 0.0399999991f);
	r5.xy = fma(v7.v.zw, vec2(1.10000002f, 0.300000012f), r5.xy);
	r5.x = ((texture(resourceSamplerPair_4_ps, r5.xy)).wxyz).x;
	if (floatBitsToUint(r4.y) != uint(0))
	{
		r4.y = uintBitsToFloat(movc(idx_FrontFacing, uint(0x3f800000), uint(0xbf800000)));
		r5.yzw = r4.yyy * v3.v.xyz;
		r4.y = dot(r5.yzw, r5.yzw);
		r4.y = inversesqrt(r4.y);
		r5.yzw = r4.yyy * r5.yzw;
		r6.xyz = ((texture(resourceSamplerPair_5_ps, v7.v.xy))).xyz;
		r6.xyz = fma(r6.xyz, vec3(2.00000000f, 2.00000000f, 2.00000000f), vec3(-1.00000000f, -1.00000000f, -1.00000000f));
		r4.y = dot(v4.v.xyz, v4.v.xyz);
		r4.y = inversesqrt(r4.y);
		r7.xyz = r4.yyy * v4.v.xyz;
		...
		r1.xyz = fma(r5.yzw, r6.zzz, r1.xyz);
		r4.y = dot(r1.xyz, r1.xyz);
		r4.y = inversesqrt(r4.y);
		r6 = (texture(resourceSamplerPair_6_ps, v1.v.zw));
		r5.y = min(r6.w, idx_uniforms1_ps.cb1[5].x);
		r5.y = saturate(r5.y * idx_uniforms1_ps.cb1[5].y);
		r7 = (texture(resourceSamplerPair_4_ps, v7.v.xy));
		r5.z = uintBitsToFloat(uint(0x3f800000));
		r6.xyz = r6.xyz * r7.xyz;
		r5.w = ((texture(resourceSamplerPair_4_ps, v7.v.zw))).w;
		r5.z = fma(r7.w, r5.z, float(0.750000000f));
		r6.w = r5.z * r5.w;
		r7.x = r5.y * float(0.699999988f);
		r5.z = fma(-r5.w, r5.z, float(0.100000001f));
		r5.z = fma(r7.x, r5.z, r6.w);
		r5.x = -r5.x + float(1.00000000f);
		r5.x = saturate(fma(-r5.x, idx_uniforms1_ps.cb1[6].x, r5.z));
		r5.x = r5.x * r5.y;
		r5.y = intBitsToFloat(float(0.00000000f) < idx_uniforms2_ps.cb2[1].w ? int(0xffffffff) : int(0x00000000));
		r5.z = r5.x * float(5.00000000f);
		r3.xw = r2.xz;
		r5.w = -r3.x + float(1.00000000f);
		r5.z = saturate(fma(r5.z, r5.w, r5.x));
		r5.x = uintBitsToFloat(movc(floatBitsToUint(r5.y), floatBitsToUint(r5.x), floatBitsToUint(r5.z)));
		r5.z = r5.x * float(3.00000000f);
		r5.x = fma(r5.x, float(-0.300000012f), float(0.800000012f));
		r5.y = uintBitsToFloat(movc(floatBitsToUint(r5.y), uint(0x3f800000), floatBitsToUint(r2.x)));
		r5.z = min(r5.z, float(1.00000000f));
		r5.w = fma(-r5.x, r5.y, float(1.00000000f));
		r5.z = r5.z / r5.w;
		r2.w = fma(-r5.x, r5.y, r2.w);
		r2.w = saturate(r5.z * r2.w);
		r5.xyz = fma(r6.xyz, vec3(4.69999981f, 4.69999981f, 4.69999981f), -r0.xyz);
		r0.xyz = fma(r2.www, r5.xyz, r0.xyz);
		r5.x = r3.x;
		r5.yz = uintBitsToFloat(uvec2(0x3c23d70a, 0x3f000000));
		r5.xyz = -r3.xyw + r5.xyz;
		r2.xyz = fma(r2.www, r5.xyz, r3.xyw);
		r1.xyz = fma(r1.xyz, r4.yyy, -r4.xzw);
		r1.xyz = fma(r2.www, r1.xyz, r4.xzw);
		r2.w = dot(r1.xyz, r1.xyz);
		r2.w = inversesqrt(r2.w);
		r4.xzw = r1.xyz * r2.www;
		r3.yz = r2.yz;
	}
	else
	{

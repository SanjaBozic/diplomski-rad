#version 460 core
// ps_5_0
// Checksum: 21a827e1_4d75716e_02cf777b_b11ff2e6
// Name: generalmmlod0fade_sdndetail_osn_terraincolor_sand
...
void main()
{
	...
	if (floatBitsToUint(r1.y) != uint(0))
	{
		...
		r6 = (texture(resourceSamplerPair_8_ps, v7.v.xy));
		r4.w = uintBitsToFloat(uint(0x3f800000));
		r5.xyz = r5.xyz * r6.xyz;
		r5.w = ((texture(resourceSamplerPair_8_ps, v7.v.zw))).w;

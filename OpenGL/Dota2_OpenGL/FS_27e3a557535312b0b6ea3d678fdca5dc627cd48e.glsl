...
void main()
{
	vec2 H_87r3s3 = PS_INPUT_gl_m_vTexCoords.xz / PS_INPUT_gl_m_vAnimationBlendValues.ww;
	vec2 H_c8xubj = vec2(H_87r3s3.x, PS_INPUT_gl_m_vTexCoords.y);
	vec4 vecSourceTexel = texture(g_tBaseTexture, H_c8xubj);
	vec2 H_zkm4q41 = vec2(H_87r3s3.y, PS_INPUT_gl_m_vTexCoords.w);
	vec4 vecSourceTexel1 = texture(g_tBaseTexture, H_zkm4q41);

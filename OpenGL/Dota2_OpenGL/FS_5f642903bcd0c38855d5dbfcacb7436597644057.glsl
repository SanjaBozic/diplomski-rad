...
void main()
{
	...
	vec3 H_ig6wap1 = H_20dm1p + H_pbzmqm1;
	...
	vec3 H_xu1zkw1 = H_ig6wap1 * vLighting;
	...
	vec3 H_t5n0wf1 = H_0v3pae1 + H_xu1zkw1;
	...
	vec4 H_j61wj6 = vec4(H_t5n0wf1.x, H_t5n0wf1.y, H_t5n0wf1.z, misc3a6);
	PS_OUTPUT_gl_vDiffuse = H_j61wj6;

...
layout( binding = 12 ) uniform sampler2DShadow g_tShadowDepthTexture;
...
layout( binding = 8 ) uniform sampler2D g_tNormal0;
layout( binding = 9 ) uniform sampler2D g_tNormal1;
layout( binding = 10 ) uniform sampler2D g_tNormal2;
layout( binding = 11 ) uniform sampler2D g_tNormal3;
...
void main()
{
	...
	vec3 H_pt0gbk1 = H_f7jpm41 + H_y9edl61;
	...
	vec3 H_l6nx7v = H_pt0gbk1 * vLighting;
	...
	vec3 H_vsdlu2 = H_l6nx7v + H_reysx41;
	...
	vec4 H_xa7fk3 = vec4(H_vsdlu2.x, H_vsdlu2.y, H_vsdlu2.z, misc3aa);
	PS_OUTPUT_gl_vDiffuse = H_xa7fk3;

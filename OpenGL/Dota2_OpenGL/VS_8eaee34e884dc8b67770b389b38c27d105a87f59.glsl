...
void main()
{
	...
	float H_bx9b13 = VS_INPUT_gl_vPositionSs.z * C_2d0;
	float H_g182wj = H_bx9b13 + C_a1d0;
	vec4 H_36u9dn = vec4(VS_INPUT_gl_vPositionSs.x, H_9tbkhr1, H_g182wj, C_1d0);
	gl_Position = H_36u9dn;
}

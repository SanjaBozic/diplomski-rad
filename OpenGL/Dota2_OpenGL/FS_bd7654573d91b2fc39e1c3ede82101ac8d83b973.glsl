...
void main()
{
	...
	vec3 H_l19rhh = H_p2p5k7 + H_pbzmqm1;
	...
	vec3 H_45ix29 = H_l19rhh * vLighting;
	...
	vec3 H_dq5pfh = H_45ix29 + H_9xzwmj1;
	float H_dcw1e4 = PS_INPUT_gl_flClipPlaneDist + C_8d0;
	float param2 = H_dcw1e4 * g_flInvFogRange;
	float misc3a5 = clamp(param2, C_0d0, C_1d0);
	vec4 H_p61azu = vec4(H_dq5pfh.x, H_dq5pfh.y, H_dq5pfh.z, misc3a5);
	PS_OUTPUT_gl_vDiffuse = H_p61azu;

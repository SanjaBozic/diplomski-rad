...
layout( binding = 9 ) uniform sampler2DShadow g_tShadowDepthTexture;
...
void main()
{
	...
	vec3 H_o0f9vb1 = H_8gsj1f + H_p2p5k7;
	...
	vec3 H_95ujun1 = H_o0f9vb1 * vLighting;
	...
	vec3 H_b7ikc4 = H_95ujun1 + H_9xzwmj1;
	...
	vec4 H_xzpw251 = vec4(H_b7ikc4.x, H_b7ikc4.y, H_b7ikc4.z, misc3a5);
	PS_OUTPUT_gl_vDiffuse = H_xzpw251;

...
layout(location=3) in vec4 PS_INPUT_gl_vNormalWs;
...
void main()
{
	...
	float misc3a2 = clamp(PS_INPUT_gl_vNormalWs.w, C_0d0, C_1d0);
	vec3 misc3a3 = mix(misc3a1, g_vFogColor, misc3a2);
	vec3 H_us4rmb = H_tfomrc * misc3a3;
	float H_4rx1xx1 = H_9v8ms6 * g_vecBlendControl.w;
	vec4 H_4mqctu1 = vec4(H_us4rmb.x, H_us4rmb.y, H_us4rmb.z, H_4rx1xx1);
	PS_OUTPUT_gl_m_vColor = H_4mqctu1;
}

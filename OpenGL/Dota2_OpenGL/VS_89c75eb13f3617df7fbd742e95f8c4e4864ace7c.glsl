...
void main()
{
	...
	float dotres = dot(H_bjyqbe1, vMatObjectToWorldRowf);
	float dotres1 = dot(H_bjyqbe1, vMatObjectToWorldRowg);
	float dotres2 = dot(H_bjyqbe1, vMatObjectToWorldRowh);
	...
	float dotres6 = dot(H_2f7gnb, vMatObjectToWorldRowf);
	float dotres7 = dot(H_2f7gnb, vMatObjectToWorldRowg);
	float dotres8 = dot(H_2f7gnb, vMatObjectToWorldRowh);
	...
	float H_g2t1wj = dot(g_vDetailTexCoordXform.xy, VS_INPUT_gl_vTexCoord);
	float H_cq0kss = dot(g_vDetailTexCoordXform.zw, VS_INPUT_gl_vTexCoord);
	vec2 H_iks8jb1 = vec2(H_g2t1wj, H_cq0kss);
	vec2 H_b73ksq1 = H_iks8jb1 + g_vDetailTexCoordOffset;
	vec4 H_m2qowl = vec4(H_sk3tid1.x, H_sk3tid1.y, H_b73ksq1.x, H_b73ksq1.y);
	...
	PS_INPUT_gl_vBaseTexCoord_vDetailTexCoord = H_m2qowl;

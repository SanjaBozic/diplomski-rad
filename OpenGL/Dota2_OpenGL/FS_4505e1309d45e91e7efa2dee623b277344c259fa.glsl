...
void main()
{
	...
	vec4 txt = texture(g_tParallaxMask, PS_INPUT_gl_vBaseTexCoord0_vBaseTexCoord1.xy);
	vec2 H_uawwq71 = vec2(g_flParallaxStrength0);
	vec2 H_5kzfth = vec2(vVectorTs, vVectorTs1);
	vec2 H_oq1yjm = H_5kzfth * txt.xx;
	vec2 vParallaxVector = H_oq1yjm * H_uawwq71;
	...
	vec2 H_t62ueh1 = H_di5dis + PS_INPUT_gl_vBaseTexCoord0_vBaseTexCoord1.xy;
	...
	vec4 vDiffuse = texture(g_tColor0, H_t62ueh1);
	...
	vec4 vTintMasks = texture(g_tTintMasks, H_t62ueh1);
	...
	vec4 vSpecular = texture(g_tSpecular0, H_t62ueh1);
	...
	vec4 vNormalTexel = texture(g_tNormal0, H_t62ueh1);

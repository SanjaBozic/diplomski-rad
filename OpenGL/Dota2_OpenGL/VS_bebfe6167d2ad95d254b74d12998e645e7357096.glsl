...
void main()
{
	...
	float flTotalAnimFrames = vecSequenceControlData.y * C_4095d94;
	float H_sarz2g1 = C_1d0 / flTotalAnimFrames;
	float H_gc6kim = H_sarz2g1 * g_vSheetDataIndex.y;
	float H_uoa6k91 = C_0d5 * H_gc6kim;
	float H_yvsxya = H_uoa6k91 * VS_INPUT_gl_m_vSequenceAndTimeData.z;
	float flSequenceIndexingTime = H_yvsxya * g_vecSequenceAddressingControls.x;

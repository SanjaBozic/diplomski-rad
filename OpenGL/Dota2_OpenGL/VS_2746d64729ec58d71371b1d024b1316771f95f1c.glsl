...
layout(std140) uniform PerLayerConstantBuffer_t {
 ...
 uniform TransformConstantBuffer_t {
...
layout(location=3) in vec4 VS_INPUT_gl_vTangentUOs_flTangentVSign;
layout(location=4) in vec2 VS_INPUT_gl_vTransformTextureUV;
out gl_PerVertex {
	vec4 gl_Position;
	float gl_ClipDistance[1];
} ;
layout(location=0) out vec2 PS_INPUT_gl_vTextureCoords;

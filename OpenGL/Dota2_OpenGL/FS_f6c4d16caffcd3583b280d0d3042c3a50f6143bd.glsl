...
void main()
{
	...
	vec4 txt = texture(g_tParallaxMask, param.member7.xy);
	vec2 H_nfhxzf = vec2(g_flParallaxStrength1);
	vec2 H_4e5oel1 = H_bbbprz * txt.yy;
	vec2 vParallaxVector = H_4e5oel1 * H_nfhxzf;
	float vParallaxVector1 = dot(g_vTexCoordTransform1U, vParallaxVector);
	float vParallaxVector2 = dot(g_vTexCoordTransform1V, vParallaxVector);
	vec2 H_di5dis = vec2(vParallaxVector1, vParallaxVector2);
	vec2 H_cqvl07 = H_di5dis + param.member7.xy;
	vec4 H_nra5xi1 = param.member7;
	H_nra5xi1.xy = H_cqvl07.xy;
	param.member7 = H_nra5xi1;
	vec4 txt1 = texture(g_tParallaxMask, param.member7.zw);
	vec2 H_izx887 = H_8840r1 * txt1.yy;
	vec2 vParallaxVector3 = H_izx887 * H_nfhxzf;
	float vParallaxVector4 = dot(g_vTexCoordTransform1U, vParallaxVector3);
	float vParallaxVector5 = dot(g_vTexCoordTransform1V, vParallaxVector3);
	vec2 H_jlvna1 = vec2(vParallaxVector4, vParallaxVector5);
	vec2 H_2d89gy = H_jlvna1 + param.member7.zw;
	vec4 H_8u5cm1 = vec4(H_cqvl07.x, H_cqvl07.y, H_2d89gy.x, H_2d89gy.y);
	param.member7 = H_8u5cm1;
	vec4 txt2 = texture(g_tParallaxMask, param.member9.zw);
	vec2 H_o0a1fq = H_n77hcv1 * txt2.yy;
	vec2 vParallaxVector6 = H_nfhxzf * H_o0a1fq;
	float vParallaxVector7 = dot(g_vTexCoordTransform1U, vParallaxVector6);
	float vParallaxVector8 = dot(g_vTexCoordTransform1V, vParallaxVector6);
	vec2 H_9v4f601 = vec2(vParallaxVector7, vParallaxVector8);
	vec2 H_ahst4e1 = H_9v4f601 + param.member9.zw;
	...
	vec4 vDiffuse0_X = texture(g_tColor0, param.member6.xy);
	vec4 vDiffuse1_X = texture(g_tColor1, H_cqvl07);
	vec4 vDiffuse2_X = texture(g_tColor2, param.member8.xy);
	vec4 vDiffuse3_X = texture(g_tColor3, H_56v5wc);
	vec4 vDiffuse0_Y = texture(g_tColor0, param.member6.zw);
	vec4 vDiffuse1_Y = texture(g_tColor1, H_2d89gy);
	...
	vec4 vDiffuse0_Z = texture(g_tColor0, param.member9.xy);
	vec4 vDiffuse1_Z = texture(g_tColor1, H_ahst4e1);
	...
	vec4 vTintMasks_X = texture(g_tTintMasks, param.member6.xy);
	vec4 vTintMasks_X1 = texture(g_tTintMasks, H_cqvl07);
	...
	vec4 vTintMasks_Y = texture(g_tTintMasks, param.member6.zw);
	vec4 vTintMasks_Y1 = texture(g_tTintMasks, H_2d89gy);
	...
	vec4 vTintMasks_Z = texture(g_tTintMasks, param.member9.xy);
	vec4 vTintMasks_Z1 = texture(g_tTintMasks, H_ahst4e1);
	...
	vec4 vSpecular0_X = texture(g_tSpecular0, param.member6.xy);
	vec4 vSpecular1_X = texture(g_tSpecular1, H_cqvl07);
	vec4 vSpecular2_X = texture(g_tSpecular2, param.member8.xy);
	vec4 vSpecular3_X = texture(g_tSpecular3, H_56v5wc);
	vec4 vSpecular0_Y = texture(g_tSpecular0, param.member6.zw);
	vec4 vSpecular1_Y = texture(g_tSpecular1, H_2d89gy);
	...
	vec4 vSpecular0_Z = texture(g_tSpecular0, param.member9.xy);
	vec4 vSpecular1_Z = texture(g_tSpecular1, H_ahst4e1);
	...
	vec4 vNormalTexel0_X = texture(g_tNormal0, param.member6.xy);
	vec4 vNormalTexel1_X = texture(g_tNormal1, H_cqvl07);
	...
	vec4 vNormalTexel0_Z = texture(g_tNormal0, param.member9.xy);
	vec4 vNormalTexel1_Z = texture(g_tNormal1, H_ahst4e1);

...
void main()
{
	...
	vec3 H_mypsk9 = H_dzlz43 + H_p2p5k7;
	...
	vec3 H_vba5dd = H_mypsk9 * vLighting;
	...
	vec3 H_wup0el = H_9xzwmj1 + H_vba5dd;
	...
	vec4 H_o66zqr = vec4(H_wup0el.x, H_wup0el.y, H_wup0el.z, misc3a5);
	PS_OUTPUT_gl_vDiffuse = H_o66zqr;

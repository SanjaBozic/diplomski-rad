...
void main()
{
	...
	vec2 vUvTmp = H_36xs5j1 + vScreenUv;
	...
	vec2 vUvTmp2 = H_s1nzhm1 + vScreenUv;
	...
	vec2 vUvTmp4 = H_aogyom + vScreenUv;
	...
	vec2 vUvTmp6 = H_tp6on41 + vScreenUv;
	...
	vec2 vUvTmp8 = H_t4ozrr + vScreenUv;

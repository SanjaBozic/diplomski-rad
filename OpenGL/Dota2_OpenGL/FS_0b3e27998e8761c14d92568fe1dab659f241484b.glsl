...
void main()
{
	...
	vec3 H_3qpgtk = H_20dm1p + H_9qw7i8;
	...
	vec3 H_843fcg = H_3qpgtk * vLighting;
	...
	vec3 H_je64se = H_0v3pae1 + H_843fcg;
	...
	vec4 H_ht5b09 = vec4(H_je64se.x, H_je64se.y, H_je64se.z, misc3a6);
	PS_OUTPUT_gl_vDiffuse = H_ht5b09;

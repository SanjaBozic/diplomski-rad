...
void main()
{
	...
	vec3 H_v43h39 = H_eqbz9z * H_y2kh7y1;
	...
	float vGray = dot(H_v43h39, C_shpsoq1);
	...
	vec3 H_q7x2uy1 = H_tnu4ev * H_v43h39;
	vec3 vFullFowColor = H_q7x2uy1 + vGray3;
	vec3 misc3a4 = mix(vFullFowColor, H_v43h39, fowResult.x);
	...
	float H_bppwpc = H_bxozn2 * flTranslucency1;
	vec4 H_gnomzn1 = vec4(select.x, select.y, select.z, H_bppwpc);
	PS_OUTPUT_gl_vDiffuse = H_gnomzn1;
}

...
void main()
{
	...
	float H_uwk34m1 = g_vInvTextureDim.x * C_a3d09622;
	vec2 H_36xs5j1 = vec2(H_uwk34m1, C_0d0);
	vec2 vUvTmp = H_36xs5j1 + PS_INPUT_gl_vTexCoord;
	...
	float H_4ufv5b1 = g_vInvTextureDim.x * C_a1d27688;
	vec2 H_s1nzhm1 = vec2(H_4ufv5b1, C_0d0);
	vec2 vUvTmp2 = H_s1nzhm1 + PS_INPUT_gl_vTexCoord;
	...
	float H_n2atiq1 = g_vInvTextureDim.x * C_1d27688;
	vec2 H_tp6on41 = vec2(H_n2atiq1, C_0d0);
	vec2 vUvTmp6 = H_tp6on41 + PS_INPUT_gl_vTexCoord;
	...
	float H_p6tvbc1 = g_vInvTextureDim.x * C_3d09622;
	vec2 H_t4ozrr = vec2(H_p6tvbc1, C_0d0);
	vec2 vUvTmp8 = H_t4ozrr + PS_INPUT_gl_vTexCoord;

...
layout( binding = 0 ) uniform sampler2D g_tGBufferAlbedo;
...
void main()
{
	vec4 H_5ru9qv1 = textureLod(g_tGBufferAlbedo, PS_INPUT_gl_vTexCoord, C_0d0);
	PS_OUTPUT_gl_vColor = H_5ru9qv1;
}

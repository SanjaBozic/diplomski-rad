...
void main()
{
	...
	float vGray = dot(H_249ifc, C_shpsoq1);
	...
	vec3 H_inpo33 = H_249ifc * H_tnu4ev;
	vec3 vFullFowColor = H_inpo33 + vGray3;
	vec3 misc3a5 = mix(vFullFowColor, H_249ifc, fowResult.x);

...
uniform samplerCube g_tCubeMap;
uniform sampler2D g_tCubeMapSeparateMask;
...
void main()
{
	...
	vec3 H_n0cpgt = mix(vAlbedo, g_vBloomColor, H_bob7ex);
	vec4 H_d1kn0r = vec4(H_n0cpgt.x, H_n0cpgt.y, H_n0cpgt.z, C_1d0);
	PS_OUTPUT_gl_vDiffuse = H_d1kn0r;

...
void main()
{
	...
	float flLuminance = dot(H_7tk0431, C_kfumqy1);
	vec3 H_t1lelu1 = vec3(flLuminance);
	vec3 vecSourceTexel1 = mix(H_7tk0431, H_t1lelu1, g_flDesatAmount);
	...
	vec3 H_z7p6ti1 = H_tfomrc * vecSourceTexel2.xyz;
	float H_4rx1xx1 = H_9v8ms6 * g_vecBlendControl.w;
	vec4 H_6am9ba = vec4(H_z7p6ti1.x, H_z7p6ti1.y, H_z7p6ti1.z, H_4rx1xx1);
	PS_OUTPUT_gl_m_vColor = H_6am9ba;
}

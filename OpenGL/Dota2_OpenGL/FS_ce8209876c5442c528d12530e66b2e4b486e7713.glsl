...
void main()
{
	...
	vec4 vecSourceTexel = texture(g_tBaseTextureNoSRGB, H_mmaacl);
	...
	vec4 H_stob9d = vec4(H_3w9id71.x, H_3w9id71.y, H_3w9id71.z, vecSourceTexel1);
	vec4 select = H_ekgkwb1 ? H_stob9d : H_s911ye1;
	...
	vec3 vModulationColor = mix(H_1s3obw, vecSourceTexel4.xyz, PS_INPUT_gl_m_vTintColor.xyz);

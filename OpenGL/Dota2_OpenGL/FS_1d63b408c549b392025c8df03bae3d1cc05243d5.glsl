...
void main()
{
	...
	vec3 H_n498r3 = H_20dm1p + H_dzlz43;
	...
	vec3 H_45v0ta = H_n498r3 * vLighting;
	...
	vec3 H_afn6d7 = H_0v3pae1 + H_45v0ta;
	...
	vec4 H_kcpxev1 = vec4(H_afn6d7.x, H_afn6d7.y, H_afn6d7.z, misc3a6);
	PS_OUTPUT_gl_vDiffuse = H_kcpxev1;
